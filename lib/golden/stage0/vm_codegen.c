          ...
          if ((v.tag == 4)) {
            ...
            if ((v.tag == 5)) {
              ...
              if ((v.tag == 6)) {
                ...
                if ((base_v.tag == 5)) {
                  int x = base_v.p0;
                  int _sv0t16 = lookup_slot(env_names, env_bases, env_widths, x);
                  int si = _sv0t16;
                  if ((si < 0)) {
                    int _sv0t17 = (0 - 1);
                    return _sv0t17;
                  ...
                  int _sv0t18 = slot_base(env_bases, si);
                  int base = _sv0t18;
                  int _sv0t19 = slot_width(env_widths, si);
                  int width = _sv0t19;
                  if ((width <= 0)) {
                    int _sv0t20 = (0 - 1);
                    return _sv0t20;
