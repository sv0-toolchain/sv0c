...
static int TY_SLICE(void);
static int TY_SLICEMUT(void);
...
static int env_scope_restore(int env_names, int mark);
...
static int struct_field_status(int sdef_names, int sdef_field_offsets, int sdef_field_counts, int sdef_fnames_flat, const char* source, int starts, int ends, const char* tname, const char* fname);
static const char* param_struct_name_of(int obj_tok, int param_name_toks, int param_tyname_toks, const char* source, int starts, int ends);
static int scan_param_tyname_toks(int fn_param_ty_root, int pbase, int param_count, int pty_tt, int pty_td1, int pty_td3, int pp, int out);
static int field_access_check_node(int fnode, int bet, int bed1, int bed2, int bpp, int param_name_toks, int param_tyname_toks, int sdef_names, int sdef_field_offsets, int sdef_field_counts, int sdef_fnames_flat, const char* source, int starts, int ends, int diag_sink);
...
static int chk_vecf_tag_at(int tok_tags, int i);
static int chk_vecf_text_is(const char* source, int starts, int ends, int t, const char* want);
static int chk_vecf_same_text(const char* source, int starts, int ends, int a, int b);
static int chk_vecf_type_kind(int tok_tags, const char* source, int starts, int ends, int p);
static int chk_vecf_lookup(int names, int kinds, const char* source, int starts, int ends, int name_tok);
static int chk_vecf_collect_struct(int tok_tags, const char* source, int starts, int ends, int i, int fnames, int fkinds);
static int chk_vecf_params_open(int tok_tags, int i);
static int chk_vecf_close_paren(int tok_tags, int open);
static int chk_vecf_fn_end(int tok_tags, int i);
static int chk_vecf_collect_params(int tok_tags, const char* source, int starts, int ends, int i, int names, int kinds);
static int chk_vecf_collect_lets(int tok_tags, const char* source, int starts, int ends, int lo, int hi, int rnames, int rkinds, int names, int kinds);
static int chk_vecf_param_kinds(int tok_tags, const char* source, int starts, int ends, int i, int out);
static int chk_vecf_fn_param_kind(int pfn_names, int pfn_off, int pfn_cnt, int pkinds, const char* source, int starts, int ends, int name_tok, int argi);
static int chk_vecf_word_type(const char* source, int starts, int ends, int t);
static int chk_vecf_evidence_at(int tok_tags, const char* source, int starts, int ends, int lo, int p, int fnames, int fkinds, int pfn_names, int pfn_off, int pfn_cnt, int pkinds, int retkind, int out);
static int chk_vecf_field_evidence(int fnames, int fkinds, const char* source, int starts, int ends, int field_tok, int out);
static int chk_vecf_resolve_fresh(int tok_tags, const char* source, int starts, int ends, int lo, int body_lo, int hi, int names, int kinds, int fnames, int fkinds, int pfn_names, int pfn_off, int pfn_cnt, int pkinds, int retkind);
static int chk_vecf_accessor_kind(const char* source, int starts, int ends, int t);
static int chk_vecf_site_map(int tok_tags, const char* source, int starts, int ends);
static int tok_text_eq(const char* source, int starts, int ends, int t, const char* want);
static int tok_is_float_type_name(const char* source, int starts, int ends, int t);
...
static int test_resolve_field_ty_tag_ptr(void);
static int test_ast_ty_to_ty_payload_ptr(void);
static int test_slice_ctor_base_node_excludes_ptr_cast(void);
static int synth_ptr_cast_fixture(int unop_tag, int ptr_cast_kind);
static int test_synth_expr_ptr_cast_const_from_shared_ref(void);
static int test_synth_expr_ptr_cast_const_from_mut_ref(void);
...
static int test_synth_expr_unsafe_block_transparent(void);
...
static int test_chk_vecf_case_param_f64(void);
static int test_chk_vecf_case_let_f64(void);
static int test_chk_vecf_case_ambiguous(void);
static int test_chk_vecf_case_typed_on_int(void);
static int test_chk_vecf_case_struct_field(void);
static int test_chk_vecf_case_fn_return(void);
static int test_chk_vecf_case_word_vec(void);
static int test_chk_vecf_case_two_fns(void);
static int test_chk_vecf_lookup_kinds(void);
static int test_chk_vecf_case2_fresh_float(void);
static int test_chk_vecf_case2_fresh_int(void);
static int test_chk_vecf_case2_fresh_conflict(void);
static int test_chk_vecf_case2_fresh_annot_read(void);
static int test_chk_vecf_case2_fresh_set_lit(void);
static int test_chk_vecf_case2_fresh_arg(void);
static int test_chk_vecf_case2_fresh_arg_second(void);
static int test_chk_vecf_case2_fresh_arg_int_vec(void);
static int test_chk_vecf_case2_fresh_return(void);
static int test_chk_vecf_case2_fresh_field(void);
static int test_chk_vecf_case2_fresh_untyped(void);
...
static int ast_type_name_to_tag(const char* name) {
  ...
  int _sv0t11 = sv0_string_eq(name, "byte");
  if (_sv0t11) {
    return 1;
  } else {
  }
  int _sv0t12 = sv0_string_eq(name, "i16");
  if (_sv0t12) {
    return 0;
  } else {
  }
  int _sv0t13 = sv0_string_eq(name, "u16");
  if (_sv0t13) {
    return 1;
  } else {
  }
  int _sv0t14 = sv0_string_eq(name, "isize");
  if (_sv0t14) {
    return 8;
  } else {
  }
  int _sv0t15 = sv0_string_eq(name, "usize");
  if (_sv0t15) {
    return 9;
  } else {
  }
  int _sv0t16 = sv0_string_eq(name, "f32");
  if (_sv0t16) {
    return 10;
  } else {
  }
  int _sv0t17 = sv0_string_eq(name, "f64");
  if (_sv0t17) {
    return 10;
  } else {
  }
  int _sv0t18 = sv0_string_eq(name, "str");
  if (_sv0t18) {
    return 5;
  } else {
  }
  ...
  int _sv0t20 = sv0_string_eq(name, "String");
  if (_sv0t20) {
    return 5;
  } else {
  }
...
static int int_width_from_name(const char* name) {
  ...
  int _sv0t5 = sv0_string_eq(name, "i32");
  if (_sv0t5) {
    return 32;
  } else {
  }
  ...
  int _sv0t9 = sv0_string_eq(name, "i128");
  if (_sv0t9) {
    return 128;
  } else {
  }
  int _sv0t10 = sv0_string_eq(name, "u128");
  if (_sv0t10) {
    return 128;
  } else {
  }
...
static int ast_ty_to_types_tag(const char* name) {
  ...
  int _sv0t14 = sv0_string_eq(name, "byte");
  if (_sv0t14) {
    return 8;
  } else {
  }
  int _sv0t15 = sv0_string_eq(name, "u16");
  if (_sv0t15) {
    return 8;
  } else {
  }
  int _sv0t16 = sv0_string_eq(name, "u32");
  if (_sv0t16) {
    return 8;
  } else {
  }
  int _sv0t17 = sv0_string_eq(name, "u64");
  if (_sv0t17) {
    return 8;
  } else {
  }
  int _sv0t18 = sv0_string_eq(name, "u128");
  if (_sv0t18) {
    return 8;
  } else {
  }
  int _sv0t19 = sv0_string_eq(name, "f32");
  if (_sv0t19) {
    return 9;
  } else {
  }
  int _sv0t20 = sv0_string_eq(name, "f64");
  if (_sv0t20) {
    return 9;
  } else {
  }
...
static int env_scope_restore(int env_names, int mark) {
  ...
  while ((j >= mark)) {
    int _sv0t1 = (0 - 1);
    sv0_vec_set(env_names, j, _sv0t1);
    j = (j - 1);
  }
  return 0;
}
...
static int extern_fn_signature_eq(int fn_ret_types, int fn_param_counts, int fn_param_offsets, int fn_param_types_flat, int a, int b) {
  int _sv0t0 = fn_table_ret_type(fn_ret_types, a);
  int _sv0t1 = fn_table_ret_type(fn_ret_types, b);
  if ((_sv0t0 != _sv0t1)) {
    return 0;
  } else {
  }
  int _sv0t2 = fn_table_param_count(fn_param_counts, a);
  int pca = _sv0t2;
  int _sv0t3 = fn_table_param_count(fn_param_counts, b);
  int pcb = _sv0t3;
  if ((pca != pcb)) {
    return 0;
  } else {
  ...
  int k = 0;
  while ((k < pca)) {
    int _sv0t4 = fn_table_param_type(fn_param_offsets, fn_param_types_flat, a, k);
    int ta = _sv0t4;
    int _sv0t5 = fn_table_param_type(fn_param_offsets, fn_param_types_flat, b, k);
    int tb = _sv0t5;
    if ((ta != tb)) {
      return 0;
    } else {
...
static int extern_fn_manifest_conflict(int fn_names, int fn_param_counts, int fn_ret_types, int fn_param_offsets, int fn_param_types_flat, int fn_is_extern, const char* source, int starts, int ends) {
  ...
  int i = 0;
  while ((i < n)) {
    int _sv0t1 = sv0_vec_get(fn_is_extern, i);
    if ((_sv0t1 == 1)) {
      int _sv0t2 = sv0_vec_get(fn_names, i);
      int ipos = _sv0t2;
      int _sv0t3 = sv0_vec_get(starts, ipos);
      int is2 = _sv0t3;
      int _sv0t4 = sv0_vec_get(ends, ipos);
      int ie = _sv0t4;
      int _sv0t5 = (ie - is2);
      const char* _sv0t6 = sv0_string_substr(source, is2, _sv0t5);
      const char* iname;
      iname = _sv0t6;
      int j = (i + 1);
      while ((j < n)) {
        int _sv0t7 = sv0_vec_get(fn_is_extern, j);
        if ((_sv0t7 == 1)) {
          int _sv0t8 = sv0_vec_get(fn_names, j);
          int jpos = _sv0t8;
          int _sv0t9 = sv0_vec_get(starts, jpos);
          int js = _sv0t9;
          int _sv0t10 = sv0_vec_get(ends, jpos);
          int je = _sv0t10;
          int _sv0t11 = (je - js);
          const char* _sv0t12 = sv0_string_substr(source, js, _sv0t11);
          const char* jname;
          jname = _sv0t12;
          int _sv0t13 = sv0_string_eq(iname, jname);
          if (_sv0t13) {
            int _sv0t14 = extern_fn_signature_eq(fn_ret_types, fn_param_counts, fn_param_offsets, fn_param_types_flat, i, j);
            if ((_sv0t14 != 1)) {
              return j;
            } else {
            }
...
static int resolve_field_ty_tag(int ty_tags, int ty_d1, int ty_d2, int ty_d3, int pp, const char* source, int starts, int ends, int struct_names, int enum_names, int type_params, int tp_limit, int idx) {
  ...
  if ((tag == 9)) {
    int _sv0t7 = TY_PTRMUT();
    return _sv0t7;
  } else {
  }
  if ((tag == 0)) {
    int _sv0t8 = sv0_vec_get(ty_d2, idx);
    int seg_count = _sv0t8;
    if ((seg_count == 1)) {
      int _sv0t9 = sv0_vec_get(ty_d1, idx);
      int pps = _sv0t9;
      int _sv0t10 = sv0_vec_get(pp, pps);
      int tok = _sv0t10;
      int _sv0t11 = sv0_vec_get(starts, tok);
      int s = _sv0t11;
      int _sv0t12 = sv0_vec_get(ends, tok);
      int e = _sv0t12;
      int _sv0t13 = (e - s);
      const char* _sv0t14 = sv0_string_substr(source, s, _sv0t13);
      const char* name;
      name = _sv0t14;
      int _sv0t15 = ast_ty_to_types_tag(name);
      int prim = _sv0t15;
      if ((prim >= 0)) {
        return prim;
      } else {
      ...
      int ni = 0;
      while (1) {
        int _sv0t16 = sv0_vec_len(struct_names);
        int _sv0t19 = (ni < _sv0t16);
        if ((!_sv0t19)) {
          break;
        } else {
        }
        int _sv0t17 = sv0_vec_get(struct_names, ni);
        if ((_sv0t17 == tok)) {
          int _sv0t18 = TY_STRUCT();
          return _sv0t18;
        } else {
        }
        ni = (ni + 1);
      ...
      int ei = 0;
      while (1) {
        int _sv0t20 = sv0_vec_len(enum_names);
        int _sv0t23 = (ei < _sv0t20);
        if ((!_sv0t23)) {
          break;
        } else {
        }
        int _sv0t21 = sv0_vec_get(enum_names, ei);
        if ((_sv0t21 == tok)) {
          int _sv0t22 = TY_ENUM();
          return _sv0t22;
        } else {
      ...
      int _sv0t24 = type_param_lookup(type_params, tp_limit, tok);
      int tp = _sv0t24;
      if ((tp >= 0)) {
        int _sv0t25 = TY_VAR();
        return _sv0t25;
...
static int ast_ty_to_ty_payload(int ty_tags, int ty_d1, int ty_d2, int ty_d3, int pp, const char* source, int starts, int ends, int struct_names, int enum_names, int type_params, int tp_limit, int idx, int out_payload) {
  ...
  if ((tag == 0)) {
    ...
    if ((seg_count == 1)) {
      ...
      const char* name;
      name = _sv0t14;
      int _sv0t15 = ast_type_name_to_tag(name);
      int prim = _sv0t15;
      if ((prim >= 0)) {
        int _sv0t16 = int_width_from_name(name);
        int w = _sv0t16;
        if ((w > 0)) {
      ...
      int ni = 0;
      while (1) {
        int _sv0t17 = sv0_vec_len(struct_names);
        int _sv0t20 = (ni < _sv0t17);
        if ((!_sv0t20)) {
          break;
        } else {
        }
        int _sv0t18 = sv0_vec_get(struct_names, ni);
        if ((_sv0t18 == tok)) {
          sv0_vec_push(out_payload, tok);
          int _sv0t19 = TY_STRUCT();
          return _sv0t19;
        } else {
        }
        ni = (ni + 1);
      ...
      int ei = 0;
      while (1) {
        int _sv0t21 = sv0_vec_len(enum_names);
        int _sv0t24 = (ei < _sv0t21);
        if ((!_sv0t24)) {
          break;
        } else {
        }
        int _sv0t22 = sv0_vec_get(enum_names, ei);
        if ((_sv0t22 == tok)) {
          sv0_vec_push(out_payload, tok);
          int _sv0t23 = TY_ENUM();
          return _sv0t23;
      ...
      int _sv0t25 = type_param_lookup(type_params, tp_limit, tok);
      int tp = _sv0t25;
      if ((tp >= 0)) {
...
static int pty_root_to_type_tag(int pty_tt, int pty_td1, int pty_td2, int pty_td3, int pp, int root, const char* source, int starts, int ends, int struct_names, int enum_names, int type_params, int tp_limit) {
  ...
  int _sv0t3 = sv0_vec_get(pty_tt, root);
  int tag = _sv0t3;
  if ((tag == 6)) {
    int _sv0t4 = TY_UNIT();
    return _sv0t4;
...
static int ty_mismatch_primitive(int got, int want) {
  ...
  int _sv0t4 = ty_is_intlike(got);
  if (_sv0t4) {
    int _sv0t5 = ty_is_intlike(want);
    if (_sv0t5) {
      return 0;
    } else {
    }
  ...
  int _sv0t6 = ty_is_primitive(got);
  if ((!_sv0t6)) {
    return 0;
  } else {
  }
  int _sv0t7 = ty_is_primitive(want);
  if ((!_sv0t7)) {
    return 0;
  } else {
  }
...
static int check_fn_body(int bet, int bed1, int bed2, int bed3, int bed4, int bpp, const char* source, int starts, int ends, int mod_env_names, int mod_env_types, int mod_env_muts, int param_name_pos, int param_type_tags, int param_muts, int param_count, int ret_ty, int body_root_idx, int edef_names, int edef_variant_offsets, int edef_variant_counts, int edef_vnames_flat, int edef_vshapes_flat, int fn_names, int fn_ret_types, int diag_sink) {
  ...
  int _sv0t16 = sv0_vec_get(bet, body_root);
  if ((_sv0t16 == 9)) {
    int _sv0t17 = sv0_vec_get(bed1, body_root);
    int rstmts_first = _sv0t17;
    int _sv0t18 = sv0_vec_get(bed2, body_root);
    int rstmts_count = _sv0t18;
    int _sv0t19 = sv0_vec_get(bed4, body_root);
    int rsidecar = _sv0t19;
    int rsi = 0;
    while ((rsi < rstmts_count)) {
      int _sv0t20 = block_stmt_index(bpp, rstmts_first, rsidecar, rsi);
      int st = _sv0t20;
      int rnode = (0 - 1);
      int _sv0t21 = sv0_vec_get(bet, st);
      int stag = _sv0t21;
      if ((stag == 15)) {
        rnode = st;
      } else {
      ...
      if ((stag == 28)) {
        int _sv0t22 = sv0_vec_get(bed1, st);
        int inner = _sv0t22;
        if ((inner >= 0)) {
          int _sv0t23 = sv0_vec_get(bet, inner);
          if ((_sv0t23 == 15)) {
            rnode = inner;
          } else {
          }
      ...
      if ((rnode >= 0)) {
        int _sv0t24 = sv0_vec_get(bed1, rnode);
        int rval = _sv0t24;
        if ((rval >= 0)) {
          int _sv0t25 = sv0_vec_get(bet, rval);
          if ((_sv0t25 == 0)) {
            int _sv0t26 = synth_expr(bet, bed1, bed2, bed3, bed4, bpp, source, starts, ends, env_n, env_t, env_m, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, 0, rval);
            int rvty = _sv0t26;
            if ((rvty >= 0)) {
              int _sv0t27 = ty_mismatch_primitive(rvty, ret_ty);
              if (_sv0t27) {
                sv0_vec_push(diag_sink, 400);
                int _sv0t28 = expr_span_tok(bet, bed1, bpp, rval);
                sv0_vec_push(diag_sink, _sv0t28);
              } else {
              }
            } else {
            }
...
static int struct_field_status(int sdef_names, int sdef_field_offsets, int sdef_field_counts, int sdef_fnames_flat, const char* source, int starts, int ends, const char* tname, const char* fname) {
  ...
  int s = 0;
  while ((s < ns)) {
    int _sv0t1 = sv0_vec_get(sdef_names, s);
    int ntok = _sv0t1;
    int _sv0t2 = sv0_vec_get(starts, ntok);
    int nsx = _sv0t2;
    int _sv0t3 = sv0_vec_get(ends, ntok);
    int nex = _sv0t3;
    int _sv0t4 = (nex - nsx);
    const char* _sv0t5 = sv0_string_substr(source, nsx, _sv0t4);
    const char* sn;
    sn = _sv0t5;
    int _sv0t6 = sv0_string_eq(sn, tname);
    if (_sv0t6) {
      int _sv0t7 = sv0_vec_get(sdef_field_offsets, s);
      int off = _sv0t7;
      int _sv0t8 = sv0_vec_get(sdef_field_counts, s);
      int cnt = _sv0t8;
      int j = 0;
      while ((j < cnt)) {
        int _sv0t9 = (off + j);
        int _sv0t10 = sv0_vec_get(sdef_fnames_flat, _sv0t9);
        int ftok = _sv0t10;
        int _sv0t11 = sv0_vec_get(starts, ftok);
        int fsx = _sv0t11;
        int _sv0t12 = sv0_vec_get(ends, ftok);
        int fex = _sv0t12;
        int _sv0t13 = (fex - fsx);
        const char* _sv0t14 = sv0_string_substr(source, fsx, _sv0t13);
        const char* fnm;
        fnm = _sv0t14;
        int _sv0t15 = sv0_string_eq(fnm, fname);
        if (_sv0t15) {
          return 1;
        } else {
        }
...
static const char* param_struct_name_of(int obj_tok, int param_name_toks, int param_tyname_toks, const char* source, int starts, int ends) {
  int _sv0t0 = sv0_vec_get(starts, obj_tok);
  int os = _sv0t0;
  int _sv0t1 = sv0_vec_get(ends, obj_tok);
  int oe = _sv0t1;
  if ((oe <= os)) {
    return "";
  } else {
  ...
  int _sv0t2 = (oe - os);
  const char* _sv0t3 = sv0_string_substr(source, os, _sv0t2);
  const char* oname;
  oname = _sv0t3;
  int _sv0t4 = sv0_vec_len(param_name_toks);
  int np = _sv0t4;
  int i = 0;
  while ((i < np)) {
    int _sv0t5 = sv0_vec_get(param_name_toks, i);
    int ptok = _sv0t5;
    int _sv0t6 = sv0_vec_get(starts, ptok);
    int ps = _sv0t6;
    int _sv0t7 = sv0_vec_get(ends, ptok);
    int pe = _sv0t7;
    int _sv0t8 = (pe - ps);
    const char* _sv0t9 = sv0_string_substr(source, ps, _sv0t8);
    const char* pnm;
    pnm = _sv0t9;
    int _sv0t10 = sv0_string_eq(pnm, oname);
    if (_sv0t10) {
      int _sv0t11 = sv0_vec_get(param_tyname_toks, i);
      int tytok = _sv0t11;
      if ((tytok < 0)) {
        return "";
      } else {
      }
      int _sv0t12 = sv0_vec_get(starts, tytok);
      int ts = _sv0t12;
      int _sv0t13 = sv0_vec_get(ends, tytok);
      int te = _sv0t13;
      if ((te <= ts)) {
        return "";
      } else {
      ...
      int _sv0t14 = (te - ts);
      const char* _sv0t15 = sv0_string_substr(source, ts, _sv0t14);
      return _sv0t15;
    } else {
    }
    i = (i + 1);
  ...
  while ((j < param_count)) {
    ...
    if ((root >= 0)) {
      ...
      if ((root < _sv0t2)) {
        int _sv0t3 = sv0_vec_get(pty_tt, root);
        if ((_sv0t3 == 0)) {
          int _sv0t4 = sv0_vec_get(pty_td3, root);
          if ((_sv0t4 == 0)) {
            int _sv0t5 = sv0_vec_get(pty_td1, root);
            int pps = _sv0t5;
            if ((pps >= 0)) {
              int _sv0t6 = sv0_vec_len(pp);
              if ((pps < _sv0t6)) {
...
static int field_access_check_node(int fnode, int bet, int bed1, int bed2, int bpp, int param_name_toks, int param_tyname_toks, int sdef_names, int sdef_field_offsets, int sdef_field_counts, int sdef_fnames_flat, const char* source, int starts, int ends, int diag_sink) {
  ...
  int _sv0t1 = sv0_vec_get(bet, fnode);
  if ((_sv0t1 != 6)) {
    return 0;
  } else {
  }
  int _sv0t2 = sv0_vec_get(bed1, fnode);
  int obj = _sv0t2;
  if ((obj < 0)) {
    return 0;
  } else {
  }
  int _sv0t3 = sv0_vec_get(bet, obj);
  if ((_sv0t3 != 1)) {
    return 0;
  } else {
  }
  int _sv0t4 = sv0_vec_get(bed2, obj);
  if ((_sv0t4 != 1)) {
    return 0;
  } else {
  }
  int _sv0t5 = sv0_vec_get(bed1, obj);
  int obj_pps = _sv0t5;
  if ((obj_pps < 0)) {
    return 0;
  } else {
  }
  int _sv0t6 = sv0_vec_len(bpp);
  if ((obj_pps >= _sv0t6)) {
    return 0;
  } else {
  }
  int _sv0t7 = sv0_vec_get(bpp, obj_pps);
  int obj_tok = _sv0t7;
  const char* _sv0t8 = param_struct_name_of(obj_tok, param_name_toks, param_tyname_toks, source, starts, ends);
  const char* tname;
  tname = _sv0t8;
  int _sv0t9 = sv0_string_len(tname);
  if ((_sv0t9 == 0)) {
    return 0;
  } else {
  }
  int _sv0t10 = sv0_vec_get(bed2, fnode);
  int field_tok = _sv0t10;
  if ((field_tok < 0)) {
    return 0;
  } else {
  }
  int _sv0t11 = sv0_vec_get(starts, field_tok);
  int fs = _sv0t11;
  int _sv0t12 = sv0_vec_get(ends, field_tok);
  int fe = _sv0t12;
  if ((fe <= fs)) {
    return 0;
  } else {
  ...
  int _sv0t13 = (fe - fs);
  const char* _sv0t14 = sv0_string_substr(source, fs, _sv0t13);
  const char* fname;
  fname = _sv0t14;
  int _sv0t15 = struct_field_status(sdef_names, sdef_field_offsets, sdef_field_counts, sdef_fnames_flat, source, starts, ends, tname, fname);
  int status = _sv0t15;
  if ((status == 0)) {
    sv0_vec_push(diag_sink, 429);
    sv0_vec_push(diag_sink, field_tok);
  } else {
  }
  return 0;
}
...
static int name_in_tok_list(int toks, const char* nm, const char* source, int starts, int ends) {
  int _sv0t0 = sv0_vec_len(toks);
  int n = _sv0t0;
  int i = 0;
  while ((i < n)) {
    int _sv0t1 = sv0_vec_get(toks, i);
    int t = _sv0t1;
    if ((t >= 0)) {
      ...
      if ((t < _sv0t2)) {
        ...
        int s = _sv0t3;
        int _sv0t4 = sv0_vec_get(ends, t);
        int e = _sv0t4;
        if ((e > s)) {
          int _sv0t5 = (e - s);
          const char* _sv0t6 = sv0_string_substr(source, s, _sv0t5);
          int _sv0t7 = sv0_string_eq(_sv0t6, nm);
          if (_sv0t7) {
            return 1;
          } else {
          }
...
static int type_name_is_known(const char* name, int struct_names, int enum_names, int type_params, int tp_limit, const char* source, int starts, int ends) {
  ...
  int _sv0t1 = sv0_string_eq(name, "Vec");
  if (_sv0t1) {
    return 1;
  } else {
  }
  int _sv0t2 = sv0_string_eq(name, "Box");
  if (_sv0t2) {
    return 1;
  } else {
  }
  int _sv0t3 = sv0_string_eq(name, "Option");
  if (_sv0t3) {
    return 1;
  } else {
  }
  int _sv0t4 = sv0_string_eq(name, "Result");
  if (_sv0t4) {
    return 1;
  } else {
  }
  int _sv0t5 = sv0_string_eq(name, "Self");
  if (_sv0t5) {
    return 1;
  } else {
  }
  int _sv0t6 = type_param_lookup_str(type_params, tp_limit, source, starts, ends, name);
  if ((_sv0t6 >= 0)) {
    return 1;
  } else {
  }
  int _sv0t7 = name_in_tok_list(struct_names, name, source, starts, ends);
  if (_sv0t7) {
    return 1;
  } else {
  }
  int _sv0t8 = name_in_tok_list(enum_names, name, source, starts, ends);
  if (_sv0t8) {
    return 1;
  } else {
  }
...
static int check_body_let_unknown_type(int bet, int bed1, int bed2, int bed4, int bpp, int body_root, int struct_names, int enum_names, int type_params, int tp_limit, int tok_tags, const char* source, int starts, int ends, int diag_sink) {
  ...
  int si = 0;
  while ((si < scount)) {
    int _sv0t5 = block_stmt_index(bpp, sfirst, sidecar, si);
    int st = _sv0t5;
    int _sv0t6 = sv0_vec_get(bet, st);
    if ((_sv0t6 == 27)) {
...
static int check_body_field_access(int bet, int bed1, int bed2, int bed3, int bed4, int bpp, int body_root, int param_name_toks, int param_tyname_toks, int sdef_names, int sdef_field_offsets, int sdef_field_counts, int sdef_fnames_flat, const char* source, int starts, int ends, int diag_sink) {
  ...
  int sidecar = _sv0t4;
  int _sv0t5 = sv0_vec_new();
  int name_toks = _sv0t5;
  int _sv0t6 = sv0_vec_new();
  int tyname_toks = _sv0t6;
  int pk = 0;
  while (1) {
    int _sv0t7 = sv0_vec_len(param_name_toks);
    int _sv0t10 = (pk < _sv0t7);
    if ((!_sv0t10)) {
      break;
    } else {
    }
    int _sv0t8 = sv0_vec_get(param_name_toks, pk);
    sv0_vec_push(name_toks, _sv0t8);
    int _sv0t9 = sv0_vec_get(param_tyname_toks, pk);
    sv0_vec_push(tyname_toks, _sv0t9);
    pk = (pk + 1);
  }
  int lp = 0;
  while ((lp < scount)) {
    int _sv0t11 = block_stmt_index(bpp, sfirst, sidecar, lp);
    int lst = _sv0t11;
    int _sv0t12 = sv0_vec_get(bet, lst);
    if ((_sv0t12 == 27)) {
      int _sv0t13 = sv0_vec_get(bed1, lst);
      int lname = _sv0t13;
      int _sv0t14 = sv0_vec_get(bed2, lst);
      int lannot = _sv0t14;
      if ((lname >= 0)) {
        if ((lannot >= 0)) {
          sv0_vec_push(name_toks, lname);
          sv0_vec_push(tyname_toks, lannot);
        } else {
        }
      } else {
      }
  ...
  int si = 0;
  while ((si < scount)) {
    int _sv0t15 = block_stmt_index(bpp, sfirst, sidecar, si);
    int st = _sv0t15;
    int _sv0t16 = sv0_vec_get(bet, st);
    int stag = _sv0t16;
    int fnode = (0 - 1);
    if ((stag == 15)) {
      int _sv0t17 = sv0_vec_get(bed1, st);
      fnode = _sv0t17;
    } else {
    }
    if ((stag == 28)) {
      int _sv0t18 = sv0_vec_get(bed1, st);
      int inner = _sv0t18;
      if ((inner >= 0)) {
        int _sv0t19 = sv0_vec_get(bet, inner);
        if ((_sv0t19 == 15)) {
          int _sv0t20 = sv0_vec_get(bed1, inner);
          fnode = _sv0t20;
        } else {
        }
      } else {
    ...
    if ((stag == 27)) {
      int _sv0t21 = sv0_vec_get(bed3, st);
      fnode = _sv0t21;
    } else {
    }
    int _sv0t22 = field_access_check_node(fnode, bet, bed1, bed2, bpp, name_toks, tyname_toks, sdef_names, sdef_field_offsets, sdef_field_counts, sdef_fnames_flat, source, starts, ends, diag_sink);
    int _r = _sv0t22;
    si = (si + 1);
  }
  return 0;
...
static int find_multi_element_tuple(int bet, int bed2) {
  ...
  int i = 0;
  while ((i < n)) {
    int _sv0t1 = sv0_vec_get(bet, i);
    if ((_sv0t1 == 25)) {
      int _sv0t2 = sv0_vec_get(bed2, i);
      if ((_sv0t2 > 1)) {
        return i;
      } else {
      }
...
static int chk_vecf_type_kind(int tok_tags, const char* source, int starts, int ends, int p) {
  int q = p;
  int _sv0t0 = chk_vecf_tag_at(tok_tags, q);
  if ((_sv0t0 == 27)) {
    q = (q + 1);
  } else {
  }
  int _sv0t1 = chk_vecf_tag_at(tok_tags, q);
  if ((_sv0t1 == 77)) {
    q = (q + 1);
  } else {
  }
  int _sv0t2 = chk_vecf_tag_at(tok_tags, q);
  if ((_sv0t2 != 5)) {
    return 2;
  } else {
  }
  int _sv0t3 = chk_vecf_text_is(source, starts, ends, q, "Vec");
  if ((_sv0t3 != 1)) {
    return 2;
  } else {
  }
  int _sv0t4 = (q + 1);
  int _sv0t5 = chk_vecf_tag_at(tok_tags, _sv0t4);
  if ((_sv0t5 != 38)) {
    return 2;
  } else {
  }
  int _sv0t6 = (q + 2);
  int _sv0t7 = chk_vecf_tag_at(tok_tags, _sv0t6);
  if ((_sv0t7 == 5)) {
    int _sv0t8 = (q + 2);
    int _sv0t9 = chk_vecf_text_is(source, starts, ends, _sv0t8, "f64");
    if (_sv0t9) {
      int _sv0t10 = (q + 3);
      int _sv0t11 = chk_vecf_tag_at(tok_tags, _sv0t10);
      int close = _sv0t11;
      if ((close == 39)) {
        return 1;
      } else {
...
static int chk_vecf_lookup(int names, int kinds, const char* source, int starts, int ends, int name_tok) {
  ...
  while ((i < n)) {
    int _sv0t1 = sv0_vec_get(names, i);
    int _sv0t2 = chk_vecf_same_text(source, starts, ends, _sv0t1, name_tok);
    if (_sv0t2) {
      ...
      if (at_start) {
        if ((t == 5)) {
          ...
          if ((_sv0t5 == 14)) {
            ...
            int _sv0t6 = (p + 2);
            int _sv0t7 = chk_vecf_type_kind(tok_tags, source, starts, ends, _sv0t6);
...
static int chk_vecf_params_open(int tok_tags, int i) {
  int p = (i + 2);
  int _sv0t0 = chk_vecf_tag_at(tok_tags, p);
  if ((_sv0t0 == 38)) {
    int d = 0;
    while (1) {
      int _sv0t1 = sv0_vec_len(tok_tags);
  ...
  int _sv0t4 = chk_vecf_tag_at(tok_tags, p);
  if ((_sv0t4 != 6)) {
    int _sv0t5 = (0 - 1);
    return _sv0t5;
  } else {
...
static int chk_vecf_fn_end(int tok_tags, int i) {
  int _sv0t0 = sv0_vec_len(tok_tags);
  int n = _sv0t0;
  int _sv0t1 = chk_vecf_params_open(tok_tags, i);
  int open = _sv0t1;
  if ((open < 0)) {
    int _sv0t2 = (i + 1);
    return _sv0t2;
  ...
  int _sv0t3 = chk_vecf_close_paren(tok_tags, open);
  int close = _sv0t3;
  if ((close < 0)) {
    return n;
  } else {
  ...
  while ((p < n)) {
    ...
    if ((t == 6)) {
      int _sv0t8 = chk_vecf_close_paren(tok_tags, p);
      int c2 = _sv0t8;
      if ((c2 < 0)) {
        return n;
      } else {
...
static int chk_vecf_collect_params(int tok_tags, const char* source, int starts, int ends, int i, int names, int kinds) {
  int _sv0t0 = chk_vecf_params_open(tok_tags, i);
  int open = _sv0t0;
  if ((open < 0)) {
    return 0;
  } else {
  }
  int _sv0t1 = chk_vecf_close_paren(tok_tags, open);
  int close = _sv0t1;
  if ((close < 0)) {
    return 0;
  } else {
    ...
    if ((pd == 1)) {
      ...
      if (at_start) {
        if ((t == 5)) {
          at_start = 0;
          int _sv0t3 = (p + 1);
          int _sv0t4 = chk_vecf_tag_at(tok_tags, _sv0t3);
          if ((_sv0t4 == 14)) {
            sv0_vec_push(names, p);
            int _sv0t5 = (p + 2);
            int _sv0t6 = chk_vecf_type_kind(tok_tags, source, starts, ends, _sv0t5);
...
static int chk_vecf_collect_lets(int tok_tags, const char* source, int starts, int ends, int lo, int hi, int rnames, int rkinds, int names, int kinds) {
  ...
  while ((i < hi)) {
    ...
    if ((_sv0t0 == 71)) {
      int p = (i + 1);
      int _sv0t1 = chk_vecf_tag_at(tok_tags, p);
      if ((_sv0t1 == 77)) {
        p = (p + 1);
      } else {
      }
      int _sv0t2 = chk_vecf_tag_at(tok_tags, p);
      if ((_sv0t2 == 5)) {
        int kind = 2;
        int _sv0t3 = (p + 1);
        int _sv0t4 = chk_vecf_tag_at(tok_tags, _sv0t3);
        ...
        if ((nt == 35)) {
          int _sv0t7 = (p + 2);
          int _sv0t8 = chk_vecf_tag_at(tok_tags, _sv0t7);
          if ((_sv0t8 == 5)) {
            int _sv0t9 = (p + 3);
            int _sv0t10 = chk_vecf_tag_at(tok_tags, _sv0t9);
            if ((_sv0t10 == 6)) {
              int _sv0t11 = (p + 2);
              int _sv0t12 = chk_vecf_lookup(rnames, rkinds, source, starts, ends, _sv0t11);
              if ((_sv0t12 == 1)) {
                kind = 1;
              } else {
              }
              int _sv0t13 = (p + 2);
              int _sv0t14 = chk_vecf_text_is(source, starts, ends, _sv0t13, "vec_new");
              if (_sv0t14) {
                kind = 4;
              } else {
              }
...
static int chk_vecf_word_type(const char* source, int starts, int ends, int t) {
  int _sv0t0 = chk_vecf_text_is(source, starts, ends, t, "i32");
  if (_sv0t0) {
    return 1;
  } else {
  }
  int _sv0t1 = chk_vecf_text_is(source, starts, ends, t, "i64");
  if (_sv0t1) {
    return 1;
  } else {
  }
  int _sv0t2 = chk_vecf_text_is(source, starts, ends, t, "u64");
  if (_sv0t2) {
    return 1;
  } else {
  }
  int _sv0t3 = chk_vecf_text_is(source, starts, ends, t, "u32");
  if (_sv0t3) {
    return 1;
  } else {
  }
  int _sv0t4 = chk_vecf_text_is(source, starts, ends, t, "u8");
  if (_sv0t4) {
    return 1;
  } else {
  }
  int _sv0t5 = chk_vecf_text_is(source, starts, ends, t, "i8");
  if (_sv0t5) {
    return 1;
  } else {
  }
  int _sv0t6 = chk_vecf_text_is(source, starts, ends, t, "u16");
  if (_sv0t6) {
    return 1;
  } else {
  }
  int _sv0t7 = chk_vecf_text_is(source, starts, ends, t, "i16");
  if (_sv0t7) {
    return 1;
  } else {
  }
  int _sv0t8 = chk_vecf_text_is(source, starts, ends, t, "isize");
  if (_sv0t8) {
    return 1;
  } else {
  }
  int _sv0t9 = chk_vecf_text_is(source, starts, ends, t, "usize");
  if (_sv0t9) {
    return 1;
  } else {
  }
  int _sv0t10 = chk_vecf_text_is(source, starts, ends, t, "bool");
  if (_sv0t10) {
    return 1;
  } else {
  }
...
static int chk_vecf_evidence_at(int tok_tags, const char* source, int starts, int ends, int lo, int p, int fnames, int fkinds, int pfn_names, int pfn_off, int pfn_cnt, int pkinds, int retkind, int out) {
  int _sv0t0 = (p - 1);
  int _sv0t1 = chk_vecf_tag_at(tok_tags, _sv0t0);
  int prev = _sv0t1;
  int _sv0t2 = (p + 1);
  int _sv0t3 = chk_vecf_tag_at(tok_tags, _sv0t2);
  int next = _sv0t3;
  if ((prev == 6)) {
    int _sv0t4 = (p - 2);
    int _sv0t5 = chk_vecf_tag_at(tok_tags, _sv0t4);
    if ((_sv0t5 == 5)) {
      if ((next == 12)) {
        int callee = (p - 2);
        int elem = (0 - 1);
        int _sv0t6 = chk_vecf_text_is(source, starts, ends, callee, "vec_push");
        if (_sv0t6) {
          elem = (p + 2);
        } else {
        }
        int _sv0t7 = chk_vecf_text_is(source, starts, ends, callee, "vec_set");
        if (_sv0t7) {
          int q = (p + 2);
          int d = 0;
          while (1) {
        ...
        if ((elem >= 0)) {
          int _sv0t11 = chk_vecf_tag_at(tok_tags, elem);
          int et = _sv0t11;
          if ((et == 1)) {
        ...
        int _sv0t16 = chk_vecf_text_is(source, starts, ends, callee, "vec_get");
        if (_sv0t16) {
          int _sv0t17 = (p - 3);
          int _sv0t18 = chk_vecf_tag_at(tok_tags, _sv0t17);
          if ((_sv0t18 == 35)) {
            int _sv0t19 = (p - 5);
            int _sv0t20 = chk_vecf_tag_at(tok_tags, _sv0t19);
            if ((_sv0t20 == 14)) {
              int _sv0t21 = (p - 4);
              int _sv0t22 = chk_vecf_text_is(source, starts, ends, _sv0t21, "f64");
              if (_sv0t22) {
              ...
              int _sv0t25 = (p - 4);
              int _sv0t26 = chk_vecf_word_type(source, starts, ends, _sv0t25);
              if (_sv0t26) {
  ...
  if (argpos) {
    if (endpos) {
      ...
      if ((open >= 1)) {
        int _sv0t30 = (open - 1);
        int _sv0t31 = chk_vecf_tag_at(tok_tags, _sv0t30);
        if ((_sv0t31 == 5)) {
          int _sv0t32 = (open - 1);
          int _sv0t33 = chk_vecf_accessor_kind(source, starts, ends, _sv0t32);
          if ((_sv0t33 == 0)) {
            int _sv0t34 = (open - 1);
            int _sv0t35 = chk_vecf_fn_param_kind(pfn_names, pfn_off, pfn_cnt, pkinds, source, starts, ends, _sv0t34, commas);
            int pk = _sv0t35;
            if ((pk == 1)) {
  ...
  if ((prev == 14)) {
    ...
    if ((_sv0t45 == 5)) {
      ...
      if ((before == 8)) {
        if (endpos) {
          int _sv0t48 = (p - 2);
          int _sv0t49 = chk_vecf_field_evidence(fnames, fkinds, source, starts, ends, _sv0t48, out);
        } else {
        }
      } else {
      }
      if ((before == 12)) {
        if (endpos) {
          int _sv0t50 = (p - 2);
          int _sv0t51 = chk_vecf_field_evidence(fnames, fkinds, source, starts, ends, _sv0t50, out);
        } else {
        }
      } else {
      }
      if ((before == 9)) {
        if (endpos) {
          int _sv0t52 = (p - 2);
          int _sv0t53 = chk_vecf_field_evidence(fnames, fkinds, source, starts, ends, _sv0t52, out);
        } else {
        }
      } else {
      }
...
static int chk_vecf_field_evidence(int fnames, int fkinds, const char* source, int starts, int ends, int field_tok, int out) {
  int _sv0t0 = chk_vecf_lookup(fnames, fkinds, source, starts, ends, field_tok);
  int code = _sv0t0;
  if ((code == 1)) {
      ...
      while ((p < hi)) {
        ...
        if ((_sv0t3 == 5)) {
          ...
          if ((p != _sv0t4)) {
            ...
            int _sv0t6 = chk_vecf_same_text(source, starts, ends, _sv0t5, p);
            if (_sv0t6) {
              int _sv0t7 = chk_vecf_evidence_at(tok_tags, source, starts, ends, lo, p, fnames, fkinds, pfn_names, pfn_off, pfn_cnt, pkinds, retkind, out);
              int _e = _sv0t7;
            } else {
            }
          } else {
...
static int chk_vecf_accessor_kind(const char* source, int starts, int ends, int t) {
  ...
  int _sv0t4 = chk_vecf_text_is(source, starts, ends, t, "vec_push");
  if (_sv0t4) {
    return 1;
  } else {
  }
  int _sv0t5 = chk_vecf_text_is(source, starts, ends, t, "vec_get");
  if (_sv0t5) {
    return 1;
  } else {
  }
  int _sv0t6 = chk_vecf_text_is(source, starts, ends, t, "vec_set");
  if (_sv0t6) {
    return 1;
  } else {
  }
  int _sv0t7 = chk_vecf_text_is(source, starts, ends, t, "vec_push_f64");
  if (_sv0t7) {
    return 2;
  } else {
  }
  int _sv0t8 = chk_vecf_text_is(source, starts, ends, t, "vec_get_f64");
  if (_sv0t8) {
    return 2;
  } else {
  }
  int _sv0t9 = chk_vecf_text_is(source, starts, ends, t, "vec_set_f64");
  if (_sv0t9) {
    return 2;
  } else {
  }
...
static int chk_vecf_site_map(int tok_tags, const char* source, int starts, int ends) {
  ...
  while ((i < n)) {
    ...
    int t = _sv0t12;
    if ((t == 89)) {
      int _sv0t13 = chk_vecf_collect_struct(tok_tags, source, starts, ends, i, fnames, fkinds);
      i = _sv0t13;
    } else {
      if ((t == 65)) {
        int _sv0t14 = (i + 1);
        int _sv0t15 = chk_vecf_tag_at(tok_tags, _sv0t14);
        if ((_sv0t15 == 5)) {
          int _sv0t16 = chk_vecf_params_open(tok_tags, i);
          int open = _sv0t16;
          if ((open >= 0)) {
            int _sv0t17 = chk_vecf_close_paren(tok_tags, open);
            int close = _sv0t17;
            if ((close >= 0)) {
              int _sv0t18 = sv0_vec_len(pkinds);
              int before_n = _sv0t18;
              int _sv0t19 = chk_vecf_param_kinds(tok_tags, source, starts, ends, i, pkinds);
              int _pk = _sv0t19;
              int _sv0t20 = (i + 1);
              ...
              int _sv0t23 = (close + 1);
              int _sv0t24 = chk_vecf_tag_at(tok_tags, _sv0t23);
              if ((_sv0t24 == 19)) {
                int _sv0t25 = (i + 1);
                sv0_vec_push(rnames, _sv0t25);
                int _sv0t26 = (close + 2);
                int _sv0t27 = chk_vecf_type_kind(tok_tags, source, starts, ends, _sv0t26);
  ...
  while ((i < n)) {
    ...
    if ((ft == 65)) {
      int _sv0t29 = (i + 1);
      int _sv0t30 = chk_vecf_tag_at(tok_tags, _sv0t29);
      if ((_sv0t30 == 5)) {
        int _sv0t31 = chk_vecf_fn_end(tok_tags, i);
        int hi = _sv0t31;
        int _sv0t32 = sv0_vec_new();
        int names = _sv0t32;
        int _sv0t33 = sv0_vec_new();
        int kinds = _sv0t33;
        int _sv0t34 = chk_vecf_collect_params(tok_tags, source, starts, ends, i, names, kinds);
        int _p = _sv0t34;
        int _sv0t35 = chk_vecf_collect_lets(tok_tags, source, starts, ends, i, hi, rnames, rkinds, names, kinds);
        int _l = _sv0t35;
        int _sv0t36 = chk_vecf_params_open(tok_tags, i);
        int fopen = _sv0t36;
        int body_lo = i;
        int retkind = 2;
        if ((fopen >= 0)) {
          int _sv0t37 = chk_vecf_close_paren(tok_tags, fopen);
          int fclose = _sv0t37;
          if ((fclose >= 0)) {
            body_lo = (fclose + 1);
            int _sv0t38 = (fclose + 1);
            int _sv0t39 = chk_vecf_tag_at(tok_tags, _sv0t38);
            if ((_sv0t39 == 19)) {
              int _sv0t40 = (fclose + 2);
              int _sv0t41 = chk_vecf_type_kind(tok_tags, source, starts, ends, _sv0t40);
              retkind = _sv0t41;
            } else {
            }
          } else {
        ...
        int _sv0t42 = chk_vecf_resolve_fresh(tok_tags, source, starts, ends, i, body_lo, hi, names, kinds, fnames, fkinds, pfn_names, pfn_off, pfn_cnt, pkinds, retkind);
        int _r = _sv0t42;
        int s = i;
        while ((s < hi)) {
          ...
          if ((_sv0t43 == 5)) {
            ...
            int _sv0t45 = chk_vecf_tag_at(tok_tags, _sv0t44);
            if ((_sv0t45 == 6)) {
              int _sv0t46 = chk_vecf_accessor_kind(source, starts, ends, s);
              int ak = _sv0t46;
              if ((ak != 0)) {
                int a0 = (s + 2);
                int code = 0;
                int _sv0t47 = chk_vecf_tag_at(tok_tags, a0);
                if ((_sv0t47 == 5)) {
                  int _sv0t48 = (a0 + 1);
                  int _sv0t49 = chk_vecf_tag_at(tok_tags, _sv0t48);
                  int nx = _sv0t49;
                  if ((nx == 12)) {
                    int _sv0t50 = chk_vecf_lookup(names, kinds, source, starts, ends, a0);
                    code = _sv0t50;
                  } else {
                  }
                  if ((nx == 7)) {
                    int _sv0t51 = chk_vecf_lookup(names, kinds, source, starts, ends, a0);
                    code = _sv0t51;
                  } else {
                  }
                  if ((nx == 16)) {
                    ...
                    if ((_sv0t53 == 5)) {
                      ...
                      if ((nx2 == 12)) {
                        int _sv0t56 = (a0 + 2);
                        int _sv0t57 = chk_vecf_lookup(fnames, fkinds, source, starts, ends, _sv0t56);
                        code = _sv0t57;
                      } else {
                      }
                      if ((nx2 == 7)) {
                        int _sv0t58 = (a0 + 2);
                        int _sv0t59 = chk_vecf_lookup(fnames, fkinds, source, starts, ends, _sv0t58);
                        code = _sv0t59;
                      } else {
                      }
                    } else {
...
static int tok_text_eq(const char* source, int starts, int ends, int t, const char* want) {
  ...
  int _sv0t1 = sv0_vec_get(starts, t);
  int s0 = _sv0t1;
  int _sv0t2 = sv0_vec_get(ends, t);
  int e0 = _sv0t2;
  if ((e0 <= s0)) {
  ...
  int _sv0t3 = (e0 - s0);
  const char* _sv0t4 = sv0_string_substr(source, s0, _sv0t3);
  int _sv0t5 = sv0_string_eq(_sv0t4, want);
  return _sv0t5;
}

static int tok_is_float_type_name(const char* source, int starts, int ends, int t) {
  int _sv0t0 = tok_text_eq(source, starts, ends, t, "f64");
  if (_sv0t0) {
    return 1;
  } else {
  }
  int _sv0t1 = tok_text_eq(source, starts, ends, t, "f32");
  return _sv0t1;
}
...
static int check_vec_float_element(int et, int ed1, int ed2, int ed3, int ed4, int pp, const char* source, int starts, int ends, int env_names, int env_types, int env_muts, int edef_names, int edef_variant_offsets, int edef_variant_counts, int edef_vnames_flat, int edef_vshapes_flat, int fn_names, int fn_ret_types, int ret_ty, int loop_depth, int idx, int vecf_sites, int diag_sink) {
  ...
  int _sv0t1 = sv0_vec_get(et, callee);
  if ((_sv0t1 != 1)) {
    return 0;
  } else {
  }
  int _sv0t2 = sv0_vec_get(ed2, callee);
  if ((_sv0t2 != 1)) {
    return 0;
  } else {
  }
  int _sv0t3 = sv0_vec_get(ed1, callee);
  int _sv0t4 = sv0_vec_get(pp, _sv0t3);
  int ctok = _sv0t4;
  ...
  int site = 0;
  if ((ctok >= 0)) {
    int _sv0t6 = sv0_vec_len(vecf_sites);
    if ((ctok < _sv0t6)) {
      int _sv0t7 = sv0_vec_get(vecf_sites, ctok);
      site = _sv0t7;
    } else {
    }
  } else {
  ...
  if ((site == 3)) {
    sv0_vec_push(diag_sink, 453);
    sv0_vec_push(diag_sink, ctok);
    return 0;
  } else {
  }
  if ((site == 2)) {
    sv0_vec_push(diag_sink, 451);
    sv0_vec_push(diag_sink, ctok);
    return 0;
  } else {
  }
  int elem_pos = (0 - 1);
  int _sv0t8 = tok_text_eq(source, starts, ends, ctok, "vec_push");
  if (_sv0t8) {
    if ((ac == 2)) {
      elem_pos = 1;
    } else {
  ...
  int _sv0t9 = tok_text_eq(source, starts, ends, ctok, "vec_set");
  if (_sv0t9) {
    if ((ac == 3)) {
      elem_pos = 2;
    } else {
  ...
  int _sv0t11 = sv0_vec_get(ed4, idx);
  int _sv0t12 = block_stmt_index(pp, _sv0t10, _sv0t11, elem_pos);
  ...
  int ety = _sv0t13;
  if ((site == 1)) {
    int _sv0t14 = TY_FLOAT();
    if ((ety != _sv0t14)) {
      int _sv0t15 = TY_VAR();
      if ((ety != _sv0t15)) {
        int _sv0t16 = TY_UNKNOWN();
        if ((ety != _sv0t16)) {
...
static int check_array_float_literal(int et, int ed1, int ed2, int ed3, int ed4, int pp, const char* source, int starts, int ends, int env_names, int env_types, int env_muts, int edef_names, int edef_variant_offsets, int edef_variant_counts, int edef_vnames_flat, int edef_vshapes_flat, int fn_names, int fn_ret_types, int ret_ty, int loop_depth, int idx, int diag_sink) {
  ...
  int k = 0;
  while ((k < count)) {
    int _sv0t2 = (idx - count);
    int _sv0t3 = (_sv0t2 + k);
    int _sv0t4 = sv0_vec_get(et, _sv0t3);
    if ((_sv0t4 != 0)) {
      return 0;
    } else {
    }
  ...
  while ((k < count)) {
    ...
    if ((ety == _sv0t8)) {
      sv0_vec_push(diag_sink, 447);
      int _sv0t9 = (idx - count);
      int _sv0t10 = (_sv0t9 + k);
      int _sv0t11 = expr_span_tok(et, ed1, pp, _sv0t10);
      sv0_vec_push(diag_sink, _sv0t11);
      return 0;
    } else {
    }
    k = (k + 1);
...
static int check_unsafe_gate(int et, int ed1, int ed2, int ed3, int ed4, int pp, const char* source, int starts, int ends, int env_names, int env_types, int env_muts, int edef_names, int edef_variant_offsets, int edef_variant_counts, int edef_vnames_flat, int edef_vshapes_flat, int fn_names, int fn_ret_types, int ret_ty, int loop_depth, int in_unsafe, int idx, int vecf_sites, int diag_sink) {
  ...
  if ((tag == 2)) {
    ...
    int unop_tag = _sv0t1;
    int _sv0t2 = sv0_vec_get(ed2, idx);
    int operand_idx = _sv0t2;
    if ((unop_tag == 3)) {
      if ((in_unsafe == 0)) {
        int _sv0t3 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, operand_idx);
        int op_ty = _sv0t3;
        int _sv0t4 = TY_PTR();
        if ((op_ty == _sv0t4)) {
          sv0_vec_push(diag_sink, 550);
          int _sv0t5 = expr_span_tok(et, ed1, pp, idx);
          sv0_vec_push(diag_sink, _sv0t5);
        } else {
        }
        int _sv0t6 = TY_PTRMUT();
        if ((op_ty == _sv0t6)) {
          sv0_vec_push(diag_sink, 550);
          int _sv0t7 = expr_span_tok(et, ed1, pp, idx);
          sv0_vec_push(diag_sink, _sv0t7);
        } else {
        }
      } else {
      }
    ...
    int _sv0t8 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, operand_idx, vecf_sites, diag_sink);
    return _sv0t8;
  } else {
  }
  if ((tag == 3)) {
    int _sv0t9 = sv0_vec_get(ed2, idx);
    int _sv0t10 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t9, vecf_sites, diag_sink);
    int _l3 = _sv0t10;
    int _sv0t11 = sv0_vec_get(ed3, idx);
    int _sv0t12 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t11, vecf_sites, diag_sink);
    return _sv0t12;
  } else {
  }
  if ((tag == 4)) {
    int _sv0t13 = sv0_vec_get(ed2, idx);
    int af4 = _sv0t13;
    int _sv0t14 = sv0_vec_get(ed3, idx);
    int ac4 = _sv0t14;
    int _sv0t15 = sv0_vec_get(ed4, idx);
    int sc4 = _sv0t15;
    int _sv0t16 = sv0_vec_get(ed1, idx);
    int _sv0t17 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t16, vecf_sites, diag_sink);
    int _c4 = _sv0t17;
    int _sv0t18 = check_vec_float_element(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, idx, vecf_sites, diag_sink);
    int _vf4 = _sv0t18;
    int ai4 = 0;
    while ((ai4 < ac4)) {
      int _sv0t19 = block_stmt_index(pp, af4, sc4, ai4);
      int _sv0t20 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t19, vecf_sites, diag_sink);
      int _a4 = _sv0t20;
      ai4 = (ai4 + 1);
    }
    return 0;
  ...
  if ((tag == 5)) {
    ...
    int _sv0t24 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t23, vecf_sites, diag_sink);
    int _mo5 = _sv0t24;
    int ai5 = 0;
    while ((ai5 < mc_ac)) {
      int _sv0t25 = block_stmt_index(pp, 0, mc_sc, ai5);
      int _sv0t26 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t25, vecf_sites, diag_sink);
      int _a5 = _sv0t26;
      ai5 = (ai5 + 1);
    }
    return 0;
  ...
  if ((tag == 6)) {
    ...
    int _sv0t28 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t27, vecf_sites, diag_sink);
    return _sv0t28;
  } else {
  }
  if ((tag == 7)) {
    int _sv0t29 = sv0_vec_get(ed1, idx);
    int _sv0t30 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t29, vecf_sites, diag_sink);
    return _sv0t30;
  } else {
  }
  if ((tag == 8)) {
    int _sv0t31 = sv0_vec_get(ed1, idx);
    int _sv0t32 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t31, vecf_sites, diag_sink);
    int _o8 = _sv0t32;
    int _sv0t33 = sv0_vec_get(ed2, idx);
    int _sv0t34 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t33, vecf_sites, diag_sink);
    return _sv0t34;
  } else {
  }
  if ((tag == 9)) {
    ...
    int sc9 = _sv0t36;
    int _sv0t37 = sv0_vec_get(ed3, idx);
    int tail9 = _sv0t37;
    int _sv0t38 = sv0_vec_get(ed4, idx);
    int sidecar9 = _sv0t38;
    int _sv0t39 = sv0_vec_len(env_names);
    int env_mark9 = _sv0t39;
    int si9 = 0;
    while ((si9 < sc9)) {
      int _sv0t40 = block_stmt_index(pp, sf9, sidecar9, si9);
      int st9 = _sv0t40;
      int _sv0t41 = sv0_vec_get(et, st9);
      int stag9 = _sv0t41;
      if ((stag9 == 27)) {
        int _sv0t42 = sv0_vec_get(ed1, st9);
        int name9 = _sv0t42;
        int _sv0t43 = sv0_vec_get(ed3, st9);
        int init9 = _sv0t43;
        int _sv0t44 = sv0_vec_get(ed4, st9);
        int ismut9 = _sv0t44;
        if ((init9 >= 0)) {
          int _sv0t45 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, init9, vecf_sites, diag_sink);
          int _i9 = _sv0t45;
          int _sv0t46 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, init9);
          int ty9 = _sv0t46;
          if ((ty9 >= 0)) {
            int _sv0t47 = env_extend(env_names, env_types, env_muts, name9, ty9, ismut9);
          } else {
          }
        } else {
        }
      ...
      if ((stag9 == 28)) {
        int _sv0t48 = sv0_vec_get(ed1, st9);
        int e9 = _sv0t48;
        int _sv0t49 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, e9, vecf_sites, diag_sink);
        int _s9 = _sv0t49;
      } else {
      }
      si9 = (si9 + 1);
    }
    int _sv0t50 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, tail9, vecf_sites, diag_sink);
    int r9 = _sv0t50;
    int _sv0t51 = env_scope_restore(env_names, env_mark9);
    int _rst9 = _sv0t51;
    return r9;
  } else {
  }
  if ((tag == 10)) {
    ...
    int _sv0t53 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t52, vecf_sites, diag_sink);
    int _c10 = _sv0t53;
    int _sv0t54 = sv0_vec_get(ed2, idx);
    int _sv0t55 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t54, vecf_sites, diag_sink);
    int _t10 = _sv0t55;
    int _sv0t56 = sv0_vec_get(ed3, idx);
    int else10 = _sv0t56;
    if ((else10 >= 0)) {
      int _sv0t57 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, else10, vecf_sites, diag_sink);
      return _sv0t57;
    } else {
    }
    return 0;
  ...
  if ((tag == 11)) {
    ...
    int arms_f11 = _sv0t59;
    int _sv0t60 = sv0_vec_get(ed3, idx);
    int arms_c11 = _sv0t60;
    int _sv0t61 = sv0_vec_get(ed4, idx);
    int arms_sc11 = _sv0t61;
    int _sv0t62 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, scrut11, vecf_sites, diag_sink);
    int _s11 = _sv0t62;
    int ami11 = 0;
    while ((ami11 < arms_c11)) {
      int _sv0t63 = block_stmt_index(pp, arms_f11, arms_sc11, ami11);
      int arm11 = _sv0t63;
      int _sv0t64 = sv0_vec_get(ed3, arm11);
      int guard11 = _sv0t64;
      int _sv0t65 = sv0_vec_get(ed4, arm11);
      int body11 = _sv0t65;
      if ((guard11 >= 0)) {
        int _sv0t66 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, guard11, vecf_sites, diag_sink);
        int _g11 = _sv0t66;
      } else {
      }
      int _sv0t67 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, body11, vecf_sites, diag_sink);
      int _b11 = _sv0t67;
      ami11 = (ami11 + 1);
    }
    return 0;
  ...
  if ((tag == 12)) {
    ...
    int _sv0t69 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t68, vecf_sites, diag_sink);
    int _c12 = _sv0t69;
    int _sv0t70 = (loop_depth + 1);
    int _sv0t71 = sv0_vec_get(ed2, idx);
    int _sv0t72 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, _sv0t70, in_unsafe, _sv0t71, vecf_sites, diag_sink);
    return _sv0t72;
  } else {
  }
  if ((tag == 13)) {
    int _sv0t73 = sv0_vec_get(ed2, idx);
    int _sv0t74 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t73, vecf_sites, diag_sink);
    int _it13 = _sv0t74;
    int _sv0t75 = (loop_depth + 1);
    int _sv0t76 = sv0_vec_get(ed3, idx);
    int _sv0t77 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, _sv0t75, in_unsafe, _sv0t76, vecf_sites, diag_sink);
    return _sv0t77;
  } else {
  }
  if ((tag == 14)) {
    int _sv0t78 = (loop_depth + 1);
    int _sv0t79 = sv0_vec_get(ed1, idx);
    int _sv0t80 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, _sv0t78, in_unsafe, _sv0t79, vecf_sites, diag_sink);
    return _sv0t80;
  } else {
  }
  if ((tag == 15)) {
    int _sv0t81 = sv0_vec_get(ed1, idx);
    int _sv0t82 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t81, vecf_sites, diag_sink);
    return _sv0t82;
  } else {
  }
  if ((tag == 16)) {
    int _sv0t83 = sv0_vec_get(ed1, idx);
    int _sv0t84 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t83, vecf_sites, diag_sink);
    return _sv0t84;
  } else {
  }
  if ((tag == 18)) {
    int _sv0t85 = sv0_vec_get(ed1, idx);
    int _sv0t86 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t85, vecf_sites, diag_sink);
    int _l18 = _sv0t86;
    int _sv0t87 = sv0_vec_get(ed2, idx);
    int _sv0t88 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t87, vecf_sites, diag_sink);
    return _sv0t88;
  } else {
  }
  if ((tag == 19)) {
    int _sv0t89 = sv0_vec_get(ed2, idx);
    int _sv0t90 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t89, vecf_sites, diag_sink);
    int _l19 = _sv0t90;
    int _sv0t91 = sv0_vec_get(ed3, idx);
    int _sv0t92 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t91, vecf_sites, diag_sink);
    return _sv0t92;
  } else {
  }
  if ((tag == 20)) {
    int _sv0t93 = sv0_vec_get(ed1, idx);
    int _sv0t94 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t93, vecf_sites, diag_sink);
    return _sv0t94;
  } else {
  }
  if ((tag == 22)) {
    int _sv0t95 = sv0_vec_get(ed1, idx);
  ...
  if ((tag == 25)) {
    int _sv0t99 = sv0_vec_get(ed2, idx);
    int tc25 = _sv0t99;
    if ((tc25 == 1)) {
      int _sv0t100 = sv0_vec_get(ed1, idx);
      int _sv0t101 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, in_unsafe, _sv0t100, vecf_sites, diag_sink);
      return _sv0t101;
    } else {
    }
    return 0;
  ...
  if ((tag == 26)) {
    int _sv0t102 = check_array_float_literal(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, idx, diag_sink);
    return _sv0t102;
  } else {
  }
  if ((tag == 34)) {
    int _sv0t103 = sv0_vec_get(ed1, idx);
    int _sv0t104 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, 1, _sv0t103, vecf_sites, diag_sink);
    return _sv0t104;
  } else {
  }
  return 0;
...
static int check_program(int tok_tags, const char* source, int starts, int ends, int pp, int it, int id1, int id2, int id3, int id4, int id5, int fn_param_name_toks, int fn_param_ty_root, int fn_ret_ty_root_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int type_params, int tp_limit, int diag_sink) {
  ...
  int _sv0t1 = sv0_vec_new();
  int struct_names = _sv0t1;
  int _sv0t2 = sv0_vec_new();
  int enum_names = _sv0t2;
  int _sv0t3 = sv0_vec_len(it);
  int nitems = _sv0t3;
  int ni = 0;
  while ((ni < nitems)) {
    int _sv0t4 = sv0_vec_get(it, ni);
    int tg = _sv0t4;
    if ((tg == 1)) {
      int _sv0t5 = sv0_vec_get(id1, ni);
      sv0_vec_push(struct_names, _sv0t5);
    } else {
    }
    if ((tg == 2)) {
      int _sv0t6 = sv0_vec_get(id1, ni);
      sv0_vec_push(enum_names, _sv0t6);
    } else {
    }
    ni = (ni + 1);
  }
  int _sv0t7 = struct_enum_name_clash_str(source, starts, ends, struct_names, enum_names);
  int clash_se = _sv0t7;
  int _sv0t8 = (0 - 1);
  if ((clash_se != _sv0t8)) {
    int _sv0t9 = (0 - 1);
  ...
  int _sv0t10 = sv0_vec_new();
  int sdef_names = _sv0t10;
  int _sv0t11 = sv0_vec_new();
  int sdef_field_offsets = _sv0t11;
  int _sv0t12 = sv0_vec_new();
  int sdef_field_counts = _sv0t12;
  int _sv0t13 = sv0_vec_new();
  int sdef_fnames_flat = _sv0t13;
  int _sv0t14 = sv0_vec_new();
  int sdef_ftypes_flat = _sv0t14;
  int _sv0t15 = init_struct_defs(tok_tags, source, starts, ends, struct_names, enum_names, type_params, tp_limit, it, id1, id2, sdef_names, sdef_field_offsets, sdef_field_counts, sdef_fnames_flat, sdef_ftypes_flat);
  int _sc = _sv0t15;
  int _sv0t16 = sv0_vec_new();
  int edef_names = _sv0t16;
  int _sv0t17 = sv0_vec_new();
  int edef_variant_offsets = _sv0t17;
  int _sv0t18 = sv0_vec_new();
  int edef_variant_counts = _sv0t18;
  int _sv0t19 = sv0_vec_new();
  int edef_vnames_flat = _sv0t19;
  int _sv0t20 = sv0_vec_new();
  int edef_vshapes_flat = _sv0t20;
  int _sv0t21 = init_enum_defs(tok_tags, source, starts, ends, it, id1, id2, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat);
  int _ec = _sv0t21;
  if ((_ec < 0)) {
    int _sv0t22 = (0 - 1);
    return _sv0t22;
  ...
  int fn_names = _sv0t23;
  int _sv0t24 = sv0_vec_new();
  int fn_param_counts = _sv0t24;
  int _sv0t25 = sv0_vec_new();
  int fn_ret_types = _sv0t25;
  int _sv0t26 = sv0_vec_new();
  int fn_param_offsets = _sv0t26;
  int _sv0t27 = sv0_vec_new();
  int fn_param_types_flat = _sv0t27;
  int _sv0t28 = sv0_vec_new();
  int fn_is_extern = _sv0t28;
  int _sv0t29 = register_all_item_fns(tok_tags, source, starts, ends, struct_names, enum_names, type_params, tp_limit, it, id1, id2, id3, id5, fn_param_ty_root, fn_ret_ty_root_by_item, pty_tt, pty_td1, pty_td2, pty_td3, pp, fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, fn_is_extern);
  int _fc = _sv0t29;
  int _sv0t30 = extern_fn_manifest_conflict(fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, fn_is_extern, source, starts, ends);
  int extern_conflict = _sv0t30;
  if ((extern_conflict >= 0)) {
    sv0_vec_push(diag_sink, 552);
    int _sv0t31 = sv0_vec_get(fn_names, extern_conflict);
    sv0_vec_push(diag_sink, _sv0t31);
    int _sv0t32 = (0 - 1);
    return _sv0t32;
  } else {
  }
...
static int builtin_fn_lookup(const char* name_str) {
  ...
  int _sv0t18 = sv0_string_eq(name_str, "slice_len");
  if (_sv0t18) {
    return 18;
  } else {
  }
  int _sv0t19 = sv0_string_eq(name_str, "string_from_bytes");
  if (_sv0t19) {
    return 19;
  } else {
  }
  int _sv0t20 = sv0_string_eq(name_str, "string_byte_view");
  if (_sv0t20) {
    return 20;
  } else {
  }
...
static int synth_expr_call_simple(int et, int ed1, int ed2, int ed3, int ed4, int pp, const char* source, int starts, int ends, int env_names, int env_types, int env_muts, int edef_names, int edef_variant_offsets, int edef_variant_counts, int edef_vnames_flat, int edef_vshapes_flat, int fn_names, int fn_ret_types, int ret_ty, int loop_depth, int callee_idx, int args_first, int args_count, int args_sidecar) {
  ...
  if ((ppc == 1)) {
    ...
    int ai = 0;
    while ((ai < args_count)) {
      int _sv0t12 = block_stmt_index(pp, args_first, args_sidecar, ai);
      int _sv0t13 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, _sv0t12);
      int arg_ty = _sv0t13;
      if ((arg_ty < 0)) {
        int _sv0t14 = (0 - 1);
  ...
  if ((ppc == 2)) {
    ...
    if ((ctor_ty >= 0)) {
      int ai = 0;
      while ((ai < args_count)) {
        int _sv0t19 = block_stmt_index(pp, args_first, args_sidecar, ai);
...
static int synth_expr(int et, int ed1, int ed2, int ed3, int ed4, int pp, const char* source, int starts, int ends, int env_names, int env_types, int env_muts, int edef_names, int edef_variant_offsets, int edef_variant_counts, int edef_vnames_flat, int edef_vshapes_flat, int fn_names, int fn_ret_types, int ret_ty, int loop_depth, int idx) {
  ...
  if ((tag == 2)) {
    ...
    if ((unop_tag == 4)) {
      int _sv0t20 = TY_SLICE();
      if ((op_ty == _sv0t20)) {
        int _sv0t21 = TY_SLICE();
        return _sv0t21;
      } else {
      }
      int _sv0t22 = TY_SLICEMUT();
      if ((op_ty == _sv0t22)) {
        int _sv0t23 = TY_SLICE();
        return _sv0t23;
      } else {
      }
    } else {
    ...
    if ((unop_tag == 5)) {
      int _sv0t24 = TY_SLICE();
      if ((op_ty == _sv0t24)) {
        int _sv0t25 = TY_SLICEMUT();
        return _sv0t25;
      } else {
      }
      int _sv0t26 = TY_SLICEMUT();
      if ((op_ty == _sv0t26)) {
        int _sv0t27 = TY_SLICEMUT();
        return _sv0t27;
      } else {
      }
    } else {
    }
    int _sv0t28 = unop_result_ty_tag(unop_tag);
    return _sv0t28;
  } else {
  }
  if ((tag == 3)) {
    int _sv0t29 = sv0_vec_get(ed1, idx);
    int binop_tag = _sv0t29;
    int _sv0t30 = sv0_vec_get(ed2, idx);
    int lhs_idx = _sv0t30;
    int _sv0t31 = sv0_vec_get(ed3, idx);
    int rhs_idx = _sv0t31;
    int _sv0t32 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, lhs_idx);
    int lhs_ty = _sv0t32;
    if ((lhs_ty < 0)) {
      int _sv0t33 = (0 - 1);
      return _sv0t33;
    ...
    int _sv0t34 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, rhs_idx);
    int rhs_ty = _sv0t34;
    if ((rhs_ty < 0)) {
      int _sv0t35 = (0 - 1);
      return _sv0t35;
    ...
    int _sv0t36 = is_arith_binop(binop_tag);
    if (_sv0t36) {
      return lhs_ty;
    } else {
    }
    int _sv0t37 = binop_result_ty_tag(binop_tag);
    return _sv0t37;
  } else {
  }
  if ((tag == 4)) {
    ...
    int _sv0t41 = sv0_vec_get(ed4, idx);
    int args_sidecar = _sv0t41;
    int _sv0t42 = synth_expr_call_simple(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, callee_idx, args_first, args_count, args_sidecar);
    return _sv0t42;
  } else {
  }
  if ((tag == 5)) {
    ...
    int mc_args_count = _sv0t44;
    int _sv0t45 = sv0_vec_get(ed4, idx);
    int mc_args_sidecar = _sv0t45;
    int _sv0t46 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, mc_obj);
    int mc_obj_ty = _sv0t46;
    if ((mc_obj_ty < 0)) {
      int _sv0t47 = (0 - 1);
      return _sv0t47;
    } else {
    ...
    while ((mc_i < mc_args_count)) {
      int _sv0t48 = block_stmt_index(pp, 0, mc_args_sidecar, mc_i);
      int _sv0t49 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, _sv0t48);
      int mc_arg_ty = _sv0t49;
      if ((mc_arg_ty < 0)) {
        int _sv0t50 = (0 - 1);
        return _sv0t50;
      } else {
  ...
  if ((tag == 6)) {
    int _sv0t52 = sv0_vec_get(ed1, idx);
    int fld_obj = _sv0t52;
    int _sv0t53 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, fld_obj);
    int fld_obj_ty = _sv0t53;
    if ((fld_obj_ty < 0)) {
      int _sv0t54 = (0 - 1);
      return _sv0t54;
    } else {
  ...
  if ((tag == 7)) {
    ...
    int tf_obj = _sv0t56;
    int _sv0t57 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, tf_obj);
    int tf_obj_ty = _sv0t57;
    if ((tf_obj_ty < 0)) {
      int _sv0t58 = (0 - 1);
      return _sv0t58;
    } else {
  ...
  if ((tag == 8)) {
    ...
    int obj_idx = _sv0t60;
    int _sv0t61 = sv0_vec_get(ed2, idx);
    int index_idx = _sv0t61;
    int _sv0t62 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, obj_idx);
    int obj_ty = _sv0t62;
    if ((obj_ty < 0)) {
      int _sv0t63 = (0 - 1);
      return _sv0t63;
    ...
    int _sv0t64 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, index_idx);
    int idx_ty = _sv0t64;
    if ((idx_ty < 0)) {
      int _sv0t65 = (0 - 1);
      return _sv0t65;
    ...
    int _sv0t66 = sv0_vec_get(et, index_idx);
    if ((_sv0t66 == 21)) {
      int _sv0t67 = TY_SLICE();
      return _sv0t67;
    } else {
    }
    int _sv0t68 = TY_INT();
  ...
  if ((tag == 10)) {
    ...
    int cond_idx = _sv0t69;
    int _sv0t70 = sv0_vec_get(ed2, idx);
    int then_idx = _sv0t70;
    int _sv0t71 = sv0_vec_get(ed3, idx);
    int else_idx = _sv0t71;
    int _sv0t72 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, cond_idx);
    int cond_ty = _sv0t72;
    if ((cond_ty < 0)) {
      int _sv0t73 = (0 - 1);
      return _sv0t73;
    ...
    int _sv0t74 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, then_idx);
    int then_ty = _sv0t74;
    if ((then_ty < 0)) {
      int _sv0t75 = (0 - 1);
      return _sv0t75;
    ...
    int _sv0t77 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, else_idx);
    int else_ty = _sv0t77;
    if ((else_ty < 0)) {
      int _sv0t78 = (0 - 1);
      return _sv0t78;
  ...
  if ((tag == 15)) {
    ...
    int _sv0t81 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, val_idx);
    int val_ty = _sv0t81;
    if ((val_ty < 0)) {
      int _sv0t82 = (0 - 1);
      return _sv0t82;
  ...
  if ((tag == 11)) {
    ...
    int scrut_idx = _sv0t87;
    int _sv0t88 = sv0_vec_get(ed2, idx);
    int arms_first = _sv0t88;
    int _sv0t89 = sv0_vec_get(ed3, idx);
    int arms_count = _sv0t89;
    int _sv0t90 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, scrut_idx);
    int scrut_ty = _sv0t90;
    if ((scrut_ty < 0)) {
      int _sv0t91 = (0 - 1);
      return _sv0t91;
    } else {
    ...
    int _sv0t93 = TY_INT();
    int first_body_ty = _sv0t93;
    int ai = 0;
    while ((ai < arms_count)) {
      int _sv0t94 = block_stmt_index(pp, arms_first, arms_sidecar, ai);
      int arm_idx = _sv0t94;
      int _sv0t95 = sv0_vec_get(ed3, arm_idx);
      int guard_idx = _sv0t95;
      int _sv0t96 = sv0_vec_get(ed4, arm_idx);
      int body_idx = _sv0t96;
      int _sv0t97 = sv0_vec_get(ed1, arm_idx);
      int arm_pt = _sv0t97;
      if ((arm_pt == 5)) {
        int _sv0t98 = sv0_vec_get(ed2, arm_idx);
        int apx = _sv0t98;
        int _sv0t99 = sv0_vec_get(ed3, apx);
        int apc = _sv0t99;
        if ((apc > 0)) {
          int apm = (apx - 1);
          int _sv0t100 = sv0_vec_get(et, apm);
          if ((_sv0t100 == 33)) {
            int _sv0t101 = sv0_vec_get(ed1, apm);
            int apac = _sv0t101;
            int _sv0t102 = sv0_vec_get(ed2, apm);
            int apfe = _sv0t102;
            int apj = 0;
            while ((apj < apac)) {
              int apei = (apfe + apj);
              int _sv0t103 = sv0_vec_get(et, apei);
              if ((_sv0t103 == 31)) {
                int _sv0t104 = sv0_vec_get(ed4, apei);
                if ((_sv0t104 == 1)) {
                  int _sv0t105 = sv0_vec_get(ed1, apei);
                  int _sv0t106 = TY_INT();
      ...
      if ((arm_pt == 4)) {
        ...
        int spx = _sv0t108;
        int _sv0t109 = sv0_vec_get(ed3, spx);
        int spc = _sv0t109;
        if ((spc > 0)) {
          int spm = (spx - 1);
          int _sv0t110 = sv0_vec_get(et, spm);
          if ((_sv0t110 == 32)) {
            int _sv0t111 = sv0_vec_get(ed1, spm);
            int spac = _sv0t111;
            int _sv0t112 = sv0_vec_get(ed2, spm);
            int spfe = _sv0t112;
            int spj = 0;
            while ((spj < spac)) {
              int spei = (spfe + spj);
              int _sv0t113 = sv0_vec_get(et, spei);
              if ((_sv0t113 == 31)) {
                int _sv0t114 = sv0_vec_get(ed4, spei);
                if ((_sv0t114 == 1)) {
                  int _sv0t115 = sv0_vec_get(ed1, spei);
                  int _sv0t116 = TY_INT();
                  int _sv0t117 = env_extend(env_names, env_types, env_muts, _sv0t115, _sv0t116, 0);
                } else {
                }
              } else {
              }
      ...
      if ((arm_pt == 1)) {
        int _sv0t118 = sv0_vec_get(ed2, arm_idx);
        int _sv0t119 = env_extend(env_names, env_types, env_muts, _sv0t118, scrut_ty, 0);
      } else {
      }
      if ((guard_idx >= 0)) {
        int _sv0t120 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, guard_idx);
        int g_ty = _sv0t120;
        if ((g_ty < 0)) {
          int _sv0t121 = (0 - 1);
          return _sv0t121;
      ...
      int _sv0t122 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, body_idx);
      int b_ty = _sv0t122;
      if ((b_ty < 0)) {
        int _sv0t123 = (0 - 1);
        return _sv0t123;
  ...
  if ((tag == 12)) {
    ...
    int cond_idx = _sv0t124;
    int _sv0t125 = sv0_vec_get(ed2, idx);
    int body_idx = _sv0t125;
    int _sv0t126 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, cond_idx);
    int cond_ty = _sv0t126;
    if ((cond_ty < 0)) {
      int _sv0t127 = (0 - 1);
      return _sv0t127;
    } else {
    }
    int _sv0t128 = (loop_depth + 1);
    int _sv0t129 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, _sv0t128, body_idx);
    int body_ty = _sv0t129;
    if ((body_ty < 0)) {
      int _sv0t130 = (0 - 1);
      return _sv0t130;
    } else {
    }
    int _sv0t131 = TY_UNIT();
    return _sv0t131;
  } else {
  }
  if ((tag == 13)) {
    int _sv0t132 = sv0_vec_get(ed1, idx);
    int pat_tok = _sv0t132;
    int _sv0t133 = sv0_vec_get(ed2, idx);
    int iter_idx = _sv0t133;
    int _sv0t134 = sv0_vec_get(ed3, idx);
    int fbody_idx = _sv0t134;
    int _sv0t135 = sv0_vec_get(et, iter_idx);
    int rtag = _sv0t135;
    if ((rtag != 21)) {
      int _sv0t136 = (0 - 1);
      return _sv0t136;
    ...
    int _sv0t137 = sv0_vec_get(ed1, iter_idx);
    int lo_idx = _sv0t137;
    int _sv0t138 = sv0_vec_get(ed2, iter_idx);
    int hi_idx = _sv0t138;
    if ((lo_idx >= 0)) {
      int _sv0t139 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, lo_idx);
      int lo_ty = _sv0t139;
      if ((lo_ty < 0)) {
        int _sv0t140 = (0 - 1);
        return _sv0t140;
    ...
    if ((hi_idx >= 0)) {
      int _sv0t141 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, hi_idx);
      int hi_ty = _sv0t141;
      if ((hi_ty < 0)) {
        int _sv0t142 = (0 - 1);
        return _sv0t142;
    ...
    int _sv0t143 = TY_INT();
    int _sv0t144 = env_extend(env_names, env_types, env_muts, pat_tok, _sv0t143, 0);
    int _sv0t145 = (loop_depth + 1);
    int _sv0t146 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, _sv0t145, fbody_idx);
    int fbody_ty = _sv0t146;
    if ((fbody_ty < 0)) {
      int _sv0t147 = (0 - 1);
      return _sv0t147;
    } else {
    }
    int _sv0t148 = TY_UNIT();
    return _sv0t148;
  } else {
  }
  if ((tag == 14)) {
    int _sv0t149 = sv0_vec_get(ed1, idx);
    int body_idx = _sv0t149;
    int _sv0t150 = (loop_depth + 1);
    int _sv0t151 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, _sv0t150, body_idx);
    int body_ty = _sv0t151;
    if ((body_ty < 0)) {
      int _sv0t152 = (0 - 1);
      return _sv0t152;
    } else {
    }
    int _sv0t153 = TY_UNIT();
    return _sv0t153;
  } else {
  }
  if ((tag == 18)) {
    int _sv0t154 = sv0_vec_get(ed1, idx);
    int lhs_idx = _sv0t154;
    int _sv0t155 = sv0_vec_get(ed2, idx);
    int rhs_idx = _sv0t155;
    int _sv0t156 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, lhs_idx);
    int lhs_ty = _sv0t156;
    if ((lhs_ty < 0)) {
      int _sv0t157 = (0 - 1);
      return _sv0t157;
    ...
    int _sv0t158 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, rhs_idx);
    int rhs_ty = _sv0t158;
    if ((rhs_ty < 0)) {
      int _sv0t159 = (0 - 1);
      return _sv0t159;
    ...
    int _sv0t160 = TY_UNIT();
    return _sv0t160;
  } else {
  }
  if ((tag == 19)) {
    int _sv0t161 = sv0_vec_get(ed2, idx);
    int lhs_idx = _sv0t161;
    int _sv0t162 = sv0_vec_get(ed3, idx);
    int rhs_idx = _sv0t162;
    int _sv0t163 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, lhs_idx);
    int lhs_ty = _sv0t163;
    if ((lhs_ty < 0)) {
      int _sv0t164 = (0 - 1);
      return _sv0t164;
    ...
    int _sv0t165 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, rhs_idx);
    int rhs_ty = _sv0t165;
    if ((rhs_ty < 0)) {
      int _sv0t166 = (0 - 1);
      return _sv0t166;
  ...
  if ((tag == 20)) {
    ...
    int cast_src = _sv0t168;
    int _sv0t169 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, cast_src);
    int cast_ty = _sv0t169;
    if ((cast_ty < 0)) {
      int _sv0t170 = (0 - 1);
      return _sv0t170;
    } else {
    }
    int _sv0t171 = sv0_vec_get(ed4, idx);
    int ptr_cast_kind = _sv0t171;
    if ((ptr_cast_kind == 1)) {
      int _sv0t172 = TY_REF();
      if ((cast_ty == _sv0t172)) {
        int _sv0t173 = TY_PTR();
    ...
    if ((ptr_cast_kind == 2)) {
      int _sv0t177 = TY_REFMUT();
      if ((cast_ty == _sv0t177)) {
        int _sv0t178 = TY_PTRMUT();
        return _sv0t178;
      } else {
      }
      int _sv0t179 = (0 - 1);
  ...
  if ((tag == 21)) {
    ...
    int rlo = _sv0t181;
    int _sv0t182 = sv0_vec_get(ed2, idx);
    int rhi = _sv0t182;
    if ((rlo >= 0)) {
      int _sv0t183 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, rlo);
      int rlo_ty = _sv0t183;
      if ((rlo_ty < 0)) {
        int _sv0t184 = (0 - 1);
        return _sv0t184;
    ...
    if ((rhi >= 0)) {
      int _sv0t185 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, rhi);
      int rhi_ty = _sv0t185;
      if ((rhi_ty < 0)) {
        int _sv0t186 = (0 - 1);
        return _sv0t186;
  ...
  if ((tag == 22)) {
    int _sv0t188 = sv0_vec_get(ed1, idx);
    int try_src = _sv0t188;
    int _sv0t189 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, try_src);
    int try_ty = _sv0t189;
    if ((try_ty < 0)) {
      int _sv0t190 = (0 - 1);
      return _sv0t190;
  ...
  if ((tag == 23)) {
    int _sv0t192 = sv0_vec_get(ed1, idx);
    int expr_idx = _sv0t192;
    int _sv0t193 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, expr_idx);
    int expr_ty = _sv0t193;
    if ((expr_ty < 0)) {
      int _sv0t194 = (0 - 1);
      return _sv0t194;
    } else {
    }
    int _sv0t195 = TY_UNIT();
    return _sv0t195;
  } else {
  }
  if ((tag == 24)) {
    int _sv0t196 = sv0_vec_get(ed1, idx);
    int pps_s24 = _sv0t196;
    int _sv0t197 = sv0_vec_get(ed2, idx);
    int ppc_s24 = _sv0t197;
    if ((ppc_s24 == 2)) {
      int _sv0t198 = sv0_vec_get(pp, pps_s24);
      int seg1_s24 = _sv0t198;
      int _sv0t199 = (pps_s24 + 1);
      int _sv0t200 = sv0_vec_get(pp, _sv0t199);
      int seg2_s24 = _sv0t200;
      int _sv0t201 = resolve_ctor_path_ty(edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, source, starts, ends, seg1_s24, seg2_s24);
      int ctor_ty_s24 = _sv0t201;
      if ((ctor_ty_s24 >= 0)) {
        int _sv0t202 = TY_ENUM();
        return _sv0t202;
      } else {
      }
    } else {
  ...
  if ((tag == 25)) {
    int _sv0t204 = sv0_vec_get(ed1, idx);
    int first_idx = _sv0t204;
    int _sv0t205 = sv0_vec_get(ed2, idx);
    int count = _sv0t205;
    if ((count == 1)) {
      int _sv0t206 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, first_idx);
      return _sv0t206;
    } else {
    }
    int _sv0t207 = (0 - 1);
  ...
  if ((tag == 9)) {
    int _sv0t209 = sv0_vec_get(ed1, idx);
    int stmts_first = _sv0t209;
    int _sv0t210 = sv0_vec_get(ed2, idx);
    int stmts_count = _sv0t210;
    int _sv0t211 = sv0_vec_get(ed3, idx);
    int tail_idx = _sv0t211;
    int _sv0t212 = sv0_vec_get(ed4, idx);
    int sidecar = _sv0t212;
    int _sv0t213 = sv0_vec_len(env_names);
    int env_mark = _sv0t213;
    int si = 0;
    while ((si < stmts_count)) {
      int _sv0t214 = block_stmt_index(pp, stmts_first, sidecar, si);
      int _sv0t215 = check_stmt_in_block(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, _sv0t214);
      int rc = _sv0t215;
      if ((rc < 0)) {
        int _sv0t216 = env_scope_restore(env_names, env_mark);
        int _r0 = _sv0t216;
        int _sv0t217 = (0 - 1);
        return _sv0t217;
      } else {
    ...
    if ((tail_idx >= 0)) {
      int _sv0t218 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, tail_idx);
      int tv = _sv0t218;
      int _sv0t219 = env_scope_restore(env_names, env_mark);
      int _r1 = _sv0t219;
      return tv;
    } else {
    }
    if ((stmts_count > 0)) {
      int _sv0t220 = (stmts_count - 1);
      int _sv0t221 = block_stmt_index(pp, stmts_first, sidecar, _sv0t220);
      int last_idx = _sv0t221;
      int _sv0t222 = stmt_returns_arena(et, ed1, last_idx);
      if (_sv0t222) {
        int _sv0t223 = env_scope_restore(env_names, env_mark);
        int _r2 = _sv0t223;
        int _sv0t224 = TY_VAR();
        return _sv0t224;
      } else {
    ...
    int _sv0t225 = env_scope_restore(env_names, env_mark);
    int _r3 = _sv0t225;
    int _sv0t226 = TY_UNIT();
    return _sv0t226;
  } else {
  }
  if ((tag == 30)) {
    int _sv0t227 = TY_UNIT();
    return _sv0t227;
  } else {
  }
  if ((tag == 31)) {
    int _sv0t228 = TY_UNIT();
    return _sv0t228;
  } else {
  }
  if ((tag == 32)) {
    int _sv0t229 = TY_UNIT();
    return _sv0t229;
  } else {
  }
  if ((tag == 33)) {
    int _sv0t230 = TY_UNIT();
    return _sv0t230;
  } else {
  }
  if ((tag == 34)) {
    int _sv0t231 = sv0_vec_get(ed1, idx);
    int _sv0t232 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, env_names, env_types, env_muts, edef_names, edef_variant_offsets, edef_variant_counts, edef_vnames_flat, edef_vshapes_flat, fn_names, fn_ret_types, ret_ty, loop_depth, _sv0t231);
    return _sv0t232;
  } else {
  }
  int _sv0t233 = (0 - 1);
...
static int test_ast_type_names(void) {
  ...
  int _sv0t16 = ast_type_name_to_tag("byte");
  if ((_sv0t16 != 1)) {
    return 16;
  } else {
  }
  int _sv0t17 = is_primitive_type_name("byte");
  if ((_sv0t17 != 1)) {
    return 17;
  } else {
  }
  int _sv0t18 = int_width_from_name("byte");
  if ((_sv0t18 != 8)) {
    return 18;
  } else {
  }
  int _sv0t19 = ast_ty_to_types_tag("byte");
  if ((_sv0t19 != 8)) {
    return 19;
  } else {
  }
...
static int test_binop_unop_result_ty(void) {
  ...
  int _sv0t16 = unop_result_ty_tag(4);
  int _sv0t17 = TY_REF();
  if ((_sv0t16 != _sv0t17)) {
    return 9;
  } else {
  }
  int _sv0t18 = unop_result_ty_tag(5);
  int _sv0t19 = TY_REFMUT();
  if ((_sv0t18 != _sv0t19)) {
    return 10;
  } else {
  }
...
static int test_pty_root_to_type_tag(void) {
  ...
  sv0_vec_push(td3, 0);
  sv0_vec_push(td3, 0);
  int _sv0t10 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 0, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t10 != 0)) {
    return 1;
  } else {
  }
  int _sv0t11 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 1, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t11 != 6)) {
    return 2;
  } else {
  }
  int _sv0t12 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 2, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t12 != 7)) {
    return 3;
  } else {
  }
  int _sv0t13 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 3, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t13 != 16)) {
    return 4;
  } else {
  }
  int _sv0t14 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 4, source, starts, ends, sn, en, tp, 2);
  int _sv0t15 = (0 - 1);
  if ((_sv0t14 != _sv0t15)) {
    return 5;
  } else {
  }
  int _sv0t16 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 5, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t16 != 15)) {
    return 6;
  } else {
  }
  int _sv0t17 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 6, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t17 != 12)) {
    return 7;
  } else {
  }
  int _sv0t18 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 7, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t18 != 13)) {
    return 8;
  } else {
  }
  int _sv0t19 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 8, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t19 != 14)) {
    return 9;
  } else {
  }
  int _sv0t20 = pty_root_to_type_tag(tt, td1, td2, td3, pp, 9, source, starts, ends, sn, en, tp, 2);
  if ((_sv0t20 != 2)) {
    return 10;
  } else {
  }
  ...
  int _sv0t23 = (0 - 1);
  int _sv0t24 = pty_root_to_type_tag(tt, td1, td2, td3, pp, _sv0t23, source, starts, ends, sn, en, tp, 2);
  int _sv0t25 = (0 - 1);
  if ((_sv0t24 != _sv0t25)) {
    return 12;
  } else {
...
static int test_register_all_item_fns(void) {
  ...
  sv0_vec_push(r_ptd3, 0);
  sv0_vec_push(r_ptd3, 0);
  int _sv0t24 = register_all_item_fns(tt, source, starts, ends, sn, en, tp, 0, item_t, item_d1, item_d2, item_d3, r_id5, r_fpt, r_frt, r_ptt, r_ptd1, r_ptd2, r_ptd3, r_pp, fnames, fpcs, frets, foffs, fptf, fis);
  int count = _sv0t24;
  if ((count != 2)) {
    return 1;
  } else {
  }
  int _sv0t25 = sv0_vec_get(fis, 0);
  if ((_sv0t25 != 0)) {
    return 10;
  } else {
  }
  int _sv0t26 = sv0_vec_get(fis, 1);
  if ((_sv0t26 != 0)) {
    return 11;
  } else {
  }
  int _sv0t27 = sv0_vec_len(fnames);
  if ((_sv0t27 != 2)) {
    return 2;
  } else {
  }
  int _sv0t28 = fn_table_lookup_str(fnames, source, starts, ends, "foo");
  int idx0 = _sv0t28;
  if ((idx0 < 0)) {
    return 3;
  } else {
  }
  int _sv0t29 = fn_table_ret_type(frets, idx0);
  int _sv0t30 = TY_BOOL();
  if ((_sv0t29 != _sv0t30)) {
    return 4;
  } else {
  }
  int _sv0t31 = fn_table_param_count(fpcs, idx0);
  if ((_sv0t31 != 1)) {
    return 5;
  } else {
  }
  int _sv0t32 = fn_table_param_type(foffs, fptf, idx0, 0);
  int _sv0t33 = TY_INT();
  if ((_sv0t32 != _sv0t33)) {
    return 6;
  } else {
  }
  int _sv0t34 = fn_table_lookup_str(fnames, source, starts, ends, "bar");
  int idx1 = _sv0t34;
  if ((idx1 < 0)) {
    return 7;
  } else {
  }
  int _sv0t35 = fn_table_ret_type(frets, idx1);
  int _sv0t36 = TY_INT();
  if ((_sv0t35 != _sv0t36)) {
    return 8;
  } else {
  }
  int _sv0t37 = fn_table_param_count(fpcs, idx1);
  if ((_sv0t37 != 0)) {
    return 9;
  } else {
  }
...
static int test_register_all_item_fns_extern_fn(void) {
  ...
  int _sv0t25 = fn_table_lookup_str(fnames, source, starts, ends, "e");
  int idx0 = _sv0t25;
  if ((idx0 < 0)) {
    return 2;
  } else {
...
static int test_extern_fn_manifest_conflict_mismatch(void) {
  ...
  int fn_names = _sv0t2;
  int _sv0t3 = sv0_vec_new();
  int fn_param_counts = _sv0t3;
  int _sv0t4 = sv0_vec_new();
  int fn_ret_types = _sv0t4;
  int _sv0t5 = sv0_vec_new();
  int fn_param_offsets = _sv0t5;
  int _sv0t6 = sv0_vec_new();
  int fn_param_types_flat = _sv0t6;
  int _sv0t7 = sv0_vec_new();
  int fn_is_extern = _sv0t7;
  int _sv0t8 = sv0_vec_new();
  int p1 = _sv0t8;
  int _sv0t9 = TY_INT();
  sv0_vec_push(p1, _sv0t9);
  int _sv0t10 = TY_INT();
  int _sv0t11 = fn_table_add(fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, 0, _sv0t10, p1, 1);
  int _r0 = _sv0t11;
  sv0_vec_push(fn_is_extern, 1);
  int _sv0t12 = sv0_vec_new();
  int p2 = _sv0t12;
  int _sv0t13 = TY_INT();
  sv0_vec_push(p2, _sv0t13);
  int _sv0t14 = TY_INT();
  sv0_vec_push(p2, _sv0t14);
  int _sv0t15 = TY_INT();
  int _sv0t16 = fn_table_add(fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, 1, _sv0t15, p2, 2);
  int _r1 = _sv0t16;
  sv0_vec_push(fn_is_extern, 1);
  int _sv0t17 = extern_fn_manifest_conflict(fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, fn_is_extern, source, starts, ends);
  int conflict = _sv0t17;
  if ((conflict != 1)) {
    return 1;
  } else {
  }
...
static int test_extern_fn_manifest_conflict_silent_on_identical_redecl(void) {
  ...
  sv0_vec_push(p2, _sv0t13);
  int _sv0t14 = TY_INT();
  int _sv0t15 = fn_table_add(fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, 1, _sv0t14, p2, 1);
  int _r1 = _sv0t15;
  sv0_vec_push(fn_is_extern, 1);
  int _sv0t16 = extern_fn_manifest_conflict(fn_names, fn_param_counts, fn_ret_types, fn_param_offsets, fn_param_types_flat, fn_is_extern, source, starts, ends);
  int conflict = _sv0t16;
  int _sv0t17 = (0 - 1);
  if ((conflict != _sv0t17)) {
    return 1;
  } else {
...
static int test_synth_expr(void) {
  ...
  int _sv0t122 = TY_INT();
  int _sv0t123 = synth_expr_call_simple(et, ed1, ed2, ed3, ed4v, ppool, source, starts, ends, en, ety, em, edn, edvo, edvc, edvn, edvs, fnames, frtypes, _sv0t122, 0, 2, 0, 0, 0);
  int rc = _sv0t123;
...
static int test_check_fn_body(void) {
  ...
  int _sv0t21 = TY_INT();
  int _sv0t22 = sv0_vec_new();
  int _sv0t23 = check_fn_body(bet, bed1, bed2, bed3, bed4, bpp, source, starts, ends, men, met, mem, ppn, ppt, ppm, 0, _sv0t21, 0, edn, edvo, edvc, edvn, edvs, fnn, fnrt, _sv0t22);
  int r1 = _sv0t23;
  if ((r1 != 0)) {
    return 1;
  } else {
  ...
  int _sv0t24 = TY_BOOL();
  int _sv0t25 = sv0_vec_new();
  int _sv0t26 = check_fn_body(bet, bed1, bed2, bed3, bed4, bpp, source, starts, ends, men, met, mem, ppn, ppt, ppm, 0, _sv0t24, 0, edn, edvo, edvc, edvn, edvs, fnn, fnrt, _sv0t25);
  int r2 = _sv0t26;
  int _sv0t27 = (0 - 1);
  if ((r2 != _sv0t27)) {
    return 2;
  ...
  int _sv0t28 = TY_UNIT();
  int _sv0t29 = sv0_vec_new();
  int _sv0t30 = check_fn_body(bet, bed1, bed2, bed3, bed4, bpp, source, starts, ends, men, met, mem, ppn, ppt, ppm, 0, _sv0t28, 0, edn, edvo, edvc, edvn, edvs, fnn, fnrt, _sv0t29);
  int r3 = _sv0t30;
  if ((r3 != 0)) {
    return 3;
  } else {
...
static int test_check_program(void) {
  ...
  int tp_a = _sv0t22;
  int _sv0t23 = sv0_vec_new();
  int _sv0t24 = check_program(tt_a, source_a, starts_a, ends_a, pp_a, it_a, id1_a, id2_a, id3_a, id4_a, id5_a, fpn_a, fpt_a, frt_a, ptt_a, ptd1_a, ptd2_a, ptd3_a, body_et_a, body_ed1_a, body_ed2_a, body_ed3_a, body_ed4_a, tp_a, 0, _sv0t23);
  int ra = _sv0t24;
  if ((ra != 0)) {
    return 1;
  } else {
  ...
  int _sv0t33 = sv0_vec_new();
  int body_et_b = _sv0t33;
  int _sv0t34 = sv0_vec_new();
  int body_ed1_b = _sv0t34;
  int _sv0t35 = sv0_vec_new();
  int body_ed2_b = _sv0t35;
  int _sv0t36 = sv0_vec_new();
  int body_ed3_b = _sv0t36;
  int _sv0t37 = sv0_vec_new();
  int body_ed4_b = _sv0t37;
  ...
  int _sv0t49 = check_program(tt_b, source_b, starts_b, ends_b, pp_b, it_b, id1_b, id2_b, id3_b, id4_b, id5_b, fpn_b, fpt_b, frt_b, ptt_b, ptd1_b, ptd2_b, ptd3_b, body_et_b, body_ed1_b, body_ed2_b, body_ed3_b, body_ed4_b, tp_b, 0, _sv0t48);
  int rb = _sv0t49;
  if ((rb != 0)) {
    return 2;
  } else {
...
static int test_check_program_mangled_name(void) {
  ...
  int tp = _sv0t22;
  int _sv0t23 = sv0_vec_new();
  int _sv0t24 = check_program(tt, source, starts, ends, pp, it, id1, id2, id3, id4, id5, fpn, fpt, frt, ptt, ptd1, ptd2, ptd3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, tp, 0, _sv0t23);
  int cr = _sv0t24;
  if ((cr != 0)) {
    return 1;
  } else {
...
static int test_resolve_field_ty_tag_ptr(void) {
  ...
  source = "";
  int _sv0t1 = sv0_vec_new();
  int ty_tags_c = _sv0t1;
  sv0_vec_push(ty_tags_c, 8);
  int _sv0t2 = sv0_vec_new();
  int ty_d1_c = _sv0t2;
  int _sv0t3 = (0 - 1);
  sv0_vec_push(ty_d1_c, _sv0t3);
  int _sv0t4 = resolve_field_ty_tag(ty_tags_c, ty_d1_c, empty_i, empty_i, empty_i, source, empty_i, empty_i, empty_i, empty_i, empty_i, 0, 0);
  int r1 = _sv0t4;
  int _sv0t5 = TY_PTR();
  if ((r1 != _sv0t5)) {
    return 1;
  ...
  int _sv0t6 = sv0_vec_new();
  int ty_tags_m = _sv0t6;
  sv0_vec_push(ty_tags_m, 9);
  int _sv0t7 = sv0_vec_new();
  int ty_d1_m = _sv0t7;
  int _sv0t8 = (0 - 1);
  sv0_vec_push(ty_d1_m, _sv0t8);
  int _sv0t9 = resolve_field_ty_tag(ty_tags_m, ty_d1_m, empty_i, empty_i, empty_i, source, empty_i, empty_i, empty_i, empty_i, empty_i, 0, 0);
  int r2 = _sv0t9;
  int _sv0t10 = TY_PTRMUT();
  if ((r2 != _sv0t10)) {
    return 2;
  } else {
  }
...
static int test_ast_ty_to_ty_payload_ptr(void) {
  ...
  int _sv0t4 = sv0_vec_new();
  int out1 = _sv0t4;
  int _sv0t5 = ast_ty_to_ty_payload(ty_tags_c, ty_d1_c, empty_i, empty_i, empty_i, source, empty_i, empty_i, empty_i, empty_i, empty_i, 0, 0, out1);
  int r1 = _sv0t5;
  int _sv0t6 = TY_PTR();
  if ((r1 != _sv0t6)) {
    return 1;
  ...
  int _sv0t8 = sv0_vec_new();
  int ty_tags_m = _sv0t8;
  sv0_vec_push(ty_tags_m, 9);
  int _sv0t9 = sv0_vec_new();
  int ty_d1_m = _sv0t9;
  int _sv0t10 = (0 - 1);
  sv0_vec_push(ty_d1_m, _sv0t10);
  int _sv0t11 = sv0_vec_new();
  int out2 = _sv0t11;
  int _sv0t12 = ast_ty_to_ty_payload(ty_tags_m, ty_d1_m, empty_i, empty_i, empty_i, source, empty_i, empty_i, empty_i, empty_i, empty_i, 0, 0, out2);
  int r2 = _sv0t12;
...
static int test_slice_ctor_base_node_excludes_ptr_cast(void) {
  ...
  sv0_vec_push(bed2, 0);
  int _sv0t3 = sv0_vec_new();
  int out_is_mut = _sv0t3;
  int _sv0t4 = slice_ctor_base_node(bet, bed1, bed2, 2, out_is_mut);
  int r = _sv0t4;
  int _sv0t5 = (0 - 1);
  if ((r != _sv0t5)) {
    return 1;
...
static int synth_ptr_cast_fixture(int unop_tag, int ptr_cast_kind) {
  ...
  int _sv0t19 = TY_INT();
  int _sv0t20 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, en, ety, em, edn, edvo, edvc, edvn, edvs, tfn, tfrt, _sv0t19, 0, 2);
  return _sv0t20;
}

static int test_synth_expr_ptr_cast_const_from_shared_ref(void) {
  int _sv0t0 = synth_ptr_cast_fixture(4, 1);
  int _sv0t1 = TY_PTR();
  if ((_sv0t0 != _sv0t1)) {
    return 1;
  } else {
...
static int test_synth_expr_ptr_cast_const_from_mut_ref(void) {
  int _sv0t0 = synth_ptr_cast_fixture(5, 1);
  int _sv0t1 = TY_PTR();
  if ((_sv0t0 != _sv0t1)) {
    return 1;
  } else {
...
static int test_synth_expr_ptr_cast_mut_from_mut_ref(void) {
  int _sv0t0 = synth_ptr_cast_fixture(5, 2);
  int _sv0t1 = TY_PTRMUT();
  if ((_sv0t0 != _sv0t1)) {
    return 1;
  } else {
  }
...
static int test_synth_expr_ptr_cast_mut_from_shared_ref_rejected(void) {
  int _sv0t0 = synth_ptr_cast_fixture(4, 2);
  int _sv0t1 = (0 - 1);
  if ((_sv0t0 != _sv0t1)) {
    return 1;
  } else {
...
static int test_synth_expr_cast_non_ptr_still_ty_int(void) {
  int _sv0t0 = synth_ptr_cast_fixture(4, 0);
  int _sv0t1 = TY_INT();
  if ((_sv0t0 != _sv0t1)) {
    return 1;
  } else {
...
static int test_synth_expr_unsafe_block_transparent(void) {
  ...
  sv0_vec_push(ed4, 0);
  int _sv0t18 = TY_INT();
  int _sv0t19 = synth_expr(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, en, ety, em, edn, edvo, edvc, edvn, edvs, tfn, tfrt, _sv0t18, 0, 2);
  int r = _sv0t19;
  int _sv0t20 = TY_INT();
  if ((r != _sv0t20)) {
    return 1;
...
static int unsafe_gate_deref_fixture(int in_unsafe) {
  ...
  int tfrt = _sv0t19;
  int _sv0t20 = sv0_vec_new();
  int diag_sink = _sv0t20;
  int _sv0t21 = TY_INT();
  int _sv0t22 = sv0_vec_new();
  int _sv0t23 = check_unsafe_gate(et, ed1, ed2, ed3, ed4, pp, source, starts, ends, en, ety, em, edn, edvo, edvc, edvn, edvs, tfn, tfrt, _sv0t21, 0, in_unsafe, 1, _sv0t22, diag_sink);
  int _r = _sv0t23;
  return diag_sink;
}

static int test_check_unsafe_gate_flags_deref_outside_unsafe(void) {
  int _sv0t0 = unsafe_gate_deref_fixture(0);
  int diag_sink = _sv0t0;
  int _sv0t1 = sv0_vec_len(diag_sink);
  if ((_sv0t1 != 2)) {
    return 1;
  } else {
  }
  int _sv0t2 = sv0_vec_get(diag_sink, 0);
  if ((_sv0t2 != 550)) {
    return 2;
  } else {
  }
...
static int test_check_unsafe_gate_silent_inside_unsafe(void) {
  int _sv0t0 = unsafe_gate_deref_fixture(1);
  int diag_sink = _sv0t0;
  int _sv0t1 = sv0_vec_len(diag_sink);
  if ((_sv0t1 != 0)) {
    return 1;
...
static int test_chk_vecf_case_param_f64(void) {
  ...
  sv0_vec_push(st, 49);
  sv0_vec_push(en, 50);
  int _sv0t3 = chk_vecf_site_map(tags, src, st, en);
  int m = _sv0t3;
...
static int test_chk_vecf_lookup_kinds(void) {
  ...
  int _sv0t4 = chk_vecf_lookup(names, kinds, src, st, en, 1);
  if ((_sv0t4 != 1)) {
    return 1;
  } else {
  }
  ...
  int _sv0t5 = chk_vecf_lookup(names, kinds, src, st, en, 1);
  if ((_sv0t5 != 2)) {
    return 2;
  } else {
  }
  ...
  sv0_vec_push(n3, 1);
  sv0_vec_push(k3, 3);
  int _sv0t8 = chk_vecf_lookup(n3, k3, src, st, en, 1);
  if ((_sv0t8 != 3)) {
    return 3;
  } else {
  }
  ...
  sv0_vec_push(n2, 0);
  sv0_vec_push(k2, 2);
  int _sv0t11 = chk_vecf_lookup(n2, k2, src, st, en, 1);
  if ((_sv0t11 != 0)) {
    return 4;
  } else {
  }
  int _sv0t12 = sv0_vec_new();
  int empty = _sv0t12;
  int _sv0t13 = chk_vecf_lookup(empty, empty, src, st, en, 1);
  if ((_sv0t13 != 0)) {
    return 5;
  } else {
  }
...
int main(void) {
  ...
  int _sv0t93 = test_pty_root_to_type_tag();
  int r47b = _sv0t93;
  if ((r47b != 0)) {
    int _sv0t94 = (460 + r47b);
    return _sv0t94;
  } else {
  }
  ...
  int _sv0t139 = test_resolve_field_ty_tag_ptr();
  int r67 = _sv0t139;
  if ((r67 != 0)) {
    int _sv0t140 = (700 + r67);
    return _sv0t140;
  } else {
  }
  int _sv0t141 = test_ast_ty_to_ty_payload_ptr();
  int r68 = _sv0t141;
  if ((r68 != 0)) {
    int _sv0t142 = (710 + r68);
    return _sv0t142;
  } else {
  }
  int _sv0t143 = test_slice_ctor_base_node_excludes_ptr_cast();
  int r69 = _sv0t143;
  if ((r69 != 0)) {
    int _sv0t144 = (720 + r69);
    return _sv0t144;
  } else {
  }
  int _sv0t145 = test_synth_expr_ptr_cast_const_from_shared_ref();
  int r70 = _sv0t145;
  if ((r70 != 0)) {
    int _sv0t146 = (730 + r70);
    return _sv0t146;
  } else {
  }
  int _sv0t147 = test_synth_expr_ptr_cast_const_from_mut_ref();
  int r71 = _sv0t147;
  if ((r71 != 0)) {
    int _sv0t148 = (740 + r71);
    return _sv0t148;
  } else {
  }
  int _sv0t149 = test_synth_expr_ptr_cast_mut_from_mut_ref();
  int r72 = _sv0t149;
  if ((r72 != 0)) {
    int _sv0t150 = (750 + r72);
    return _sv0t150;
  } else {
  }
  int _sv0t151 = test_synth_expr_ptr_cast_mut_from_shared_ref_rejected();
  int r73 = _sv0t151;
  if ((r73 != 0)) {
    int _sv0t152 = (760 + r73);
    return _sv0t152;
  } else {
  }
  int _sv0t153 = test_synth_expr_cast_non_ptr_still_ty_int();
  int r74 = _sv0t153;
  if ((r74 != 0)) {
  ...
  int _sv0t157 = test_synth_expr_unsafe_block_transparent();
  int r76 = _sv0t157;
  if ((r76 != 0)) {
    int _sv0t158 = (790 + r76);
    return _sv0t158;
  } else {
  }
  int _sv0t159 = test_check_unsafe_gate_flags_deref_outside_unsafe();
  int r77 = _sv0t159;
  if ((r77 != 0)) {
    int _sv0t160 = (800 + r77);
    return _sv0t160;
  } else {
  }
  int _sv0t161 = test_check_unsafe_gate_silent_inside_unsafe();
  int r78 = _sv0t161;
  if ((r78 != 0)) {
  ...
  int _sv0t171 = test_extern_fn_manifest_conflict_mismatch();
  int r83 = _sv0t171;
  if ((r83 != 0)) {
    int _sv0t172 = (860 + r83);
    return _sv0t172;
  } else {
  }
  int _sv0t173 = test_extern_fn_manifest_conflict_silent_on_identical_redecl();
  int r84 = _sv0t173;
  if ((r84 != 0)) {
    int _sv0t174 = (870 + r84);
    return _sv0t174;
  } else {
  }
  int _sv0t175 = test_extern_fn_manifest_conflict_ignores_non_extern_rows();
  int r85 = _sv0t175;
  if ((r85 != 0)) {
  ...
  int _sv0t185 = test_chk_vecf_case_param_f64();
  int rv0 = _sv0t185;
  if ((rv0 != 0)) {
    int _sv0t186 = (930 + 0);
    int _sv0t187 = (_sv0t186 + rv0);
    return _sv0t187;
  } else {
  }
  int _sv0t188 = test_chk_vecf_case_let_f64();
  int rv1 = _sv0t188;
  if ((rv1 != 0)) {
    int _sv0t189 = (930 + 10);
    int _sv0t190 = (_sv0t189 + rv1);
    return _sv0t190;
  } else {
  }
  int _sv0t191 = test_chk_vecf_case_ambiguous();
  int rv2 = _sv0t191;
  if ((rv2 != 0)) {
    int _sv0t192 = (930 + 20);
    int _sv0t193 = (_sv0t192 + rv2);
    return _sv0t193;
  } else {
  }
  int _sv0t194 = test_chk_vecf_case_typed_on_int();
  int rv3 = _sv0t194;
  if ((rv3 != 0)) {
    int _sv0t195 = (930 + 30);
    int _sv0t196 = (_sv0t195 + rv3);
    return _sv0t196;
  } else {
  }
  int _sv0t197 = test_chk_vecf_case_struct_field();
  int rv4 = _sv0t197;
  if ((rv4 != 0)) {
    int _sv0t198 = (930 + 40);
    int _sv0t199 = (_sv0t198 + rv4);
    return _sv0t199;
  } else {
  }
  int _sv0t200 = test_chk_vecf_case_fn_return();
  int rv5 = _sv0t200;
  if ((rv5 != 0)) {
    int _sv0t201 = (930 + 50);
    int _sv0t202 = (_sv0t201 + rv5);
    return _sv0t202;
  } else {
  }
  int _sv0t203 = test_chk_vecf_case_word_vec();
  int rv6 = _sv0t203;
  if ((rv6 != 0)) {
    int _sv0t204 = (930 + 60);
    int _sv0t205 = (_sv0t204 + rv6);
    return _sv0t205;
  } else {
  }
  int _sv0t206 = test_chk_vecf_case_two_fns();
  int rv7 = _sv0t206;
  if ((rv7 != 0)) {
    int _sv0t207 = (930 + 70);
    int _sv0t208 = (_sv0t207 + rv7);
    return _sv0t208;
  } else {
  }
  int _sv0t209 = test_chk_vecf_lookup_kinds();
  int rv8 = _sv0t209;
  if ((rv8 != 0)) {
    int _sv0t210 = (930 + 80);
    int _sv0t211 = (_sv0t210 + rv8);
    return _sv0t211;
  } else {
  }
  int _sv0t212 = test_chk_vecf_case2_fresh_float();
  int rw0 = _sv0t212;
  if ((rw0 != 0)) {
    int _sv0t213 = (1000 + 0);
    int _sv0t214 = (_sv0t213 + rw0);
    return _sv0t214;
  } else {
  }
  int _sv0t215 = test_chk_vecf_case2_fresh_int();
  int rw1 = _sv0t215;
  if ((rw1 != 0)) {
    int _sv0t216 = (1000 + 10);
    int _sv0t217 = (_sv0t216 + rw1);
    return _sv0t217;
  } else {
  }
  int _sv0t218 = test_chk_vecf_case2_fresh_conflict();
  int rw2 = _sv0t218;
  if ((rw2 != 0)) {
    int _sv0t219 = (1000 + 20);
    int _sv0t220 = (_sv0t219 + rw2);
    return _sv0t220;
  } else {
  }
  int _sv0t221 = test_chk_vecf_case2_fresh_annot_read();
  int rw3 = _sv0t221;
  if ((rw3 != 0)) {
    int _sv0t222 = (1000 + 30);
    int _sv0t223 = (_sv0t222 + rw3);
    return _sv0t223;
  } else {
  }
  int _sv0t224 = test_chk_vecf_case2_fresh_set_lit();
  int rw4 = _sv0t224;
  if ((rw4 != 0)) {
    int _sv0t225 = (1000 + 40);
    int _sv0t226 = (_sv0t225 + rw4);
    return _sv0t226;
  } else {
  }
  int _sv0t227 = test_chk_vecf_case2_fresh_arg();
  int rw5 = _sv0t227;
  if ((rw5 != 0)) {
    int _sv0t228 = (1000 + 50);
    int _sv0t229 = (_sv0t228 + rw5);
    return _sv0t229;
  } else {
  }
  int _sv0t230 = test_chk_vecf_case2_fresh_arg_second();
  int rw6 = _sv0t230;
  if ((rw6 != 0)) {
    int _sv0t231 = (1000 + 60);
    int _sv0t232 = (_sv0t231 + rw6);
    return _sv0t232;
  } else {
  }
  int _sv0t233 = test_chk_vecf_case2_fresh_arg_int_vec();
  int rw7 = _sv0t233;
  if ((rw7 != 0)) {
    int _sv0t234 = (1000 + 70);
    int _sv0t235 = (_sv0t234 + rw7);
    return _sv0t235;
  } else {
  }
  int _sv0t236 = test_chk_vecf_case2_fresh_return();
  int rw8 = _sv0t236;
  if ((rw8 != 0)) {
    int _sv0t237 = (1000 + 80);
    int _sv0t238 = (_sv0t237 + rw8);
    return _sv0t238;
  } else {
  }
  int _sv0t239 = test_chk_vecf_case2_fresh_field();
  int rw9 = _sv0t239;
  if ((rw9 != 0)) {
    int _sv0t240 = (1000 + 90);
    int _sv0t241 = (_sv0t240 + rw9);
    return _sv0t241;
  } else {
  }
  int _sv0t242 = test_chk_vecf_case2_fresh_untyped();
  int rw10 = _sv0t242;
  if ((rw10 != 0)) {
    int _sv0t243 = (1000 + 100);
    int _sv0t244 = (_sv0t243 + rw10);
    return _sv0t244;
  } else {
  }
  return 0;
