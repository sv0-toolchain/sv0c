...
static int resolve_expr(int et, int ed1, int ed2, int ed3, int ed4, int idx, const char* source, int starts, int ends, int mod_vals, int mod_tys, int fn_arities, int frames, int pp) {
  ...
  if ((tag == 1)) {
    ...
    if ((ppc == 2)) {
      ...
      const char* _sv0t9 = tok_str(source, starts, ends, _sv0t8);
      const char* seg0;
      seg0 = _sv0t9;
      int _sv0t10 = res_type_exists(mod_tys, seg0, source, starts, ends);
      if (_sv0t10) {
        return 0;
      } else {
      }
  ...
  if ((tag == 2)) {
    ...
    int _sv0t12 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t11, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    return _sv0t12;
  } else {
  }
  if ((tag == 3)) {
    int _sv0t13 = sv0_vec_get(ed2, idx);
    int _sv0t14 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t13, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int r1 = _sv0t14;
    if ((r1 != 0)) {
      return r1;
    } else {
  ...
  if ((tag == 4)) {
    int _sv0t17 = sv0_vec_get(ed1, idx);
    int callee = _sv0t17;
    int _sv0t18 = sv0_vec_get(ed2, idx);
    int args_first = _sv0t18;
    int _sv0t19 = sv0_vec_get(ed3, idx);
    int args_count = _sv0t19;
    int _sv0t20 = sv0_vec_get(et, callee);
    if ((_sv0t20 == 1)) {
      int _sv0t21 = sv0_vec_get(ed1, callee);
      int cpps = _sv0t21;
      int _sv0t22 = sv0_vec_get(ed2, callee);
      int cppc = _sv0t22;
      ...
      while ((ck < cppc)) {
        ...
        sv0_vec_push(cpath, _sv0t25);
        ck = (ck + 1);
      }
      const char* _sv0t26 = path_join_vec(source, starts, ends, cpath);
      const char* cps;
      cps = _sv0t26;
      if ((cppc == 1)) {
        int _sv0t27 = sv0_string_eq(cps, "forall");
        if (_sv0t27) {
          if ((args_count == 3)) {
            int binder = args_first;
            int _sv0t28 = sv0_vec_get(et, binder);
            if ((_sv0t28 == 1)) {
              int _sv0t29 = sv0_vec_get(ed1, binder);
              int _sv0t30 = sv0_vec_get(pp, _sv0t29);
              int bpos = _sv0t30;
              int _sv0t31 = (args_first + 1);
              int _sv0t32 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t31, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
              int rd = _sv0t32;
              if ((rd != 0)) {
                return rd;
              } else {
              }
              int _sv0t33 = res_enter_scope(frames);
              int _sv0t34 = res_bind_local(frames, bpos);
              int _sv0t35 = (args_first + 2);
              int _sv0t36 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t35, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
              int rb = _sv0t36;
              return rb;
            } else {
            }
        ...
        int _sv0t37 = sv0_string_eq(cps, "exists");
        if (_sv0t37) {
          if ((args_count == 3)) {
            int binder = args_first;
            int _sv0t38 = sv0_vec_get(et, binder);
            if ((_sv0t38 == 1)) {
              int _sv0t39 = sv0_vec_get(ed1, binder);
              int _sv0t40 = sv0_vec_get(pp, _sv0t39);
              int bpos = _sv0t40;
              int _sv0t41 = (args_first + 1);
              int _sv0t42 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t41, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
              int rd = _sv0t42;
              if ((rd != 0)) {
                return rd;
              } else {
              }
              int _sv0t43 = res_enter_scope(frames);
              int _sv0t44 = res_bind_local(frames, bpos);
              int _sv0t45 = (args_first + 2);
              int _sv0t46 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t45, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
              int rb = _sv0t46;
              return rb;
            } else {
            }
      ...
      int _sv0t47 = res_lookup_fn_arity_str(fn_arities, cps, source, starts, ends);
      int arity = _sv0t47;
      if ((arity >= 0)) {
        if ((arity != args_count)) {
          return 307;
    ...
    int _sv0t48 = resolve_expr(et, ed1, ed2, ed3, ed4, callee, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int rf = _sv0t48;
    if ((rf != 0)) {
      return rf;
    } else {
    ...
    int ai = 0;
    while ((ai < args_count)) {
      int _sv0t49 = (args_first + ai);
      int _sv0t50 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t49, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int ra = _sv0t50;
      if ((ra != 0)) {
        return ra;
      } else {
  ...
  if ((tag == 5)) {
    ...
    int margs_first = _sv0t52;
    int _sv0t53 = sv0_vec_get(ed4, idx);
    int margs_count = _sv0t53;
    int _sv0t54 = resolve_expr(et, ed1, ed2, ed3, ed4, recv, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int rr = _sv0t54;
    if ((rr != 0)) {
      return rr;
    } else {
    ...
    while ((mi < margs_count)) {
      int _sv0t55 = (margs_first + mi);
      int _sv0t56 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t55, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int rm = _sv0t56;
      if ((rm != 0)) {
        return rm;
      } else {
  ...
  if ((tag == 9)) {
    int _sv0t65 = sv0_vec_get(ed1, idx);
    int sf = _sv0t65;
    int _sv0t66 = sv0_vec_get(ed2, idx);
    int sc = _sv0t66;
    int _sv0t67 = sv0_vec_get(ed3, idx);
    int tail = _sv0t67;
    int _sv0t68 = sv0_vec_get(ed4, idx);
    int sidecar = _sv0t68;
    int _sv0t69 = res_enter_scope(frames);
    int si = 0;
    while ((si < sc)) {
      int _sv0t70 = block_stmt_index(pp, sf, sidecar, si);
      int _sv0t71 = resolve_stmt(et, ed1, ed2, ed3, ed4, _sv0t70, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int rs = _sv0t71;
      if ((rs != 0)) {
        return rs;
      } else {
    ...
    if ((tail >= 0)) {
      int _sv0t72 = resolve_expr(et, ed1, ed2, ed3, ed4, tail, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      return _sv0t72;
    } else {
    }
    return 0;
  ...
  if ((tag == 10)) {
    ...
    int _sv0t74 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t73, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int rc = _sv0t74;
    if ((rc != 0)) {
      return rc;
    } else {
    }
    int _sv0t75 = sv0_vec_get(ed2, idx);
    ...
    int else_idx = _sv0t77;
    if ((else_idx >= 0)) {
      int _sv0t78 = resolve_expr(et, ed1, ed2, ed3, ed4, else_idx, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      return _sv0t78;
    } else {
    }
    return 0;
  ...
  if ((tag == 11)) {
    ...
    int scrut = _sv0t79;
    int _sv0t80 = sv0_vec_get(ed2, idx);
    int arms_f = _sv0t80;
    int _sv0t81 = sv0_vec_get(ed3, idx);
    int arms_c = _sv0t81;
    int _sv0t82 = sv0_vec_get(ed4, idx);
    int arms_sidecar = _sv0t82;
    int _sv0t83 = resolve_expr(et, ed1, ed2, ed3, ed4, scrut, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int rsc = _sv0t83;
    if ((rsc != 0)) {
      return rsc;
    } else {
    ...
    int ami = 0;
    while ((ami < arms_c)) {
      int _sv0t84 = block_stmt_index(pp, arms_f, arms_sidecar, ami);
      int arm_idx = _sv0t84;
      int _sv0t85 = sv0_vec_get(ed1, arm_idx);
      int arm_pat_tag = _sv0t85;
      int _sv0t86 = sv0_vec_get(ed2, arm_idx);
      int arm_pat_d1 = _sv0t86;
      int _sv0t87 = sv0_vec_get(ed3, arm_idx);
      int guard = _sv0t87;
      int _sv0t88 = sv0_vec_get(ed4, arm_idx);
      int body = _sv0t88;
      int _sv0t89 = res_enter_scope(frames);
      if ((arm_pat_tag == 1)) {
        int _sv0t90 = res_bind_local(frames, arm_pat_d1);
      } else {
      }
      if ((arm_pat_tag == 5)) {
        int _sv0t91 = sv0_vec_get(ed3, arm_pat_d1);
        int argc_r = _sv0t91;
        if ((argc_r > 0)) {
          int meta_r = (arm_pat_d1 - 1);
          int _sv0t92 = sv0_vec_get(et, meta_r);
          if ((_sv0t92 == 33)) {
            int _sv0t93 = sv0_vec_get(ed1, meta_r);
            int ac_r = _sv0t93;
            int _sv0t94 = sv0_vec_get(ed2, meta_r);
            int first_r = _sv0t94;
            int ej_r = 0;
            while ((ej_r < ac_r)) {
              int eidx_r = (first_r + ej_r);
              int _sv0t95 = sv0_vec_get(et, eidx_r);
              if ((_sv0t95 == 31)) {
                int _sv0t96 = sv0_vec_get(ed4, eidx_r);
                if ((_sv0t96 == 1)) {
                  int _sv0t97 = sv0_vec_get(ed1, eidx_r);
                  int _sv0t98 = res_bind_local(frames, _sv0t97);
                } else {
                }
              } else {
              }
      ...
      if ((guard >= 0)) {
        int _sv0t99 = resolve_expr(et, ed1, ed2, ed3, ed4, guard, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
        int rg = _sv0t99;
        if ((rg != 0)) {
          return rg;
        } else {
      ...
      int _sv0t100 = resolve_expr(et, ed1, ed2, ed3, ed4, body, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int rb = _sv0t100;
      if ((rb != 0)) {
        return rb;
      } else {
  ...
  if ((tag == 12)) {
    ...
    int inv_f = _sv0t103;
    int _sv0t104 = sv0_vec_get(ed4, idx);
    int inv_c = _sv0t104;
    int _sv0t105 = resolve_expr(et, ed1, ed2, ed3, ed4, cond, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int rwc = _sv0t105;
    if ((rwc != 0)) {
      return rwc;
    } else {
    ...
    int ii = 0;
    while ((ii < inv_c)) {
      int _sv0t106 = (inv_f + ii);
      int _sv0t107 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t106, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int ri = _sv0t107;
      if ((ri != 0)) {
        return ri;
      } else {
    ...
    int _sv0t108 = resolve_expr(et, ed1, ed2, ed3, ed4, wbody, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    return _sv0t108;
  } else {
  }
  if ((tag == 13)) {
    int _sv0t109 = sv0_vec_get(ed1, idx);
    int pat_tok = _sv0t109;
    int _sv0t110 = sv0_vec_get(ed2, idx);
    int iter = _sv0t110;
    int _sv0t111 = sv0_vec_get(ed3, idx);
    int fbody = _sv0t111;
    int _sv0t112 = resolve_expr(et, ed1, ed2, ed3, ed4, iter, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int rit = _sv0t112;
    if ((rit != 0)) {
      return rit;
    } else {
    }
    int _sv0t113 = res_enter_scope(frames);
    int _sv0t114 = res_bind_local(frames, pat_tok);
    int _sv0t115 = resolve_expr(et, ed1, ed2, ed3, ed4, fbody, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    return _sv0t115;
  } else {
  }
  if ((tag == 14)) {
    int _sv0t116 = sv0_vec_get(ed1, idx);
    int _sv0t117 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t116, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    return _sv0t117;
  } else {
  }
  if ((tag == 15)) {
    ...
    int rv = _sv0t118;
    if ((rv >= 0)) {
      int _sv0t119 = resolve_expr(et, ed1, ed2, ed3, ed4, rv, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      return _sv0t119;
    } else {
    }
    return 0;
  ...
  if ((tag == 16)) {
    ...
    int bv = _sv0t120;
    if ((bv >= 0)) {
      int _sv0t121 = resolve_expr(et, ed1, ed2, ed3, ed4, bv, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      return _sv0t121;
    } else {
    }
    return 0;
  ...
  if ((tag == 18)) {
    ...
    int _sv0t123 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t122, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    int ra = _sv0t123;
    if ((ra != 0)) {
      return ra;
    } else {
  ...
  if ((tag == 21)) {
    ...
    int hi = _sv0t133;
    if ((lo >= 0)) {
      int _sv0t134 = resolve_expr(et, ed1, ed2, ed3, ed4, lo, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int rl = _sv0t134;
      if ((rl != 0)) {
        return rl;
      } else {
    ...
    if ((hi >= 0)) {
      int _sv0t135 = resolve_expr(et, ed1, ed2, ed3, ed4, hi, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      return _sv0t135;
    } else {
    }
    return 0;
  ...
  if ((tag == 22)) {
    ...
    int _sv0t137 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t136, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
    return _sv0t137;
  } else {
  }
  if ((tag == 23)) {
  ...
  if ((tag == 24)) {
    ...
    int sppc = _sv0t141;
    int _sv0t142 = sv0_vec_get(ed3, idx);
    int sfc = _sv0t142;
    int _sv0t143 = sv0_vec_new();
    int spath = _sv0t143;
    int sk = 0;
    while ((sk < sppc)) {
      int _sv0t144 = (spps + sk);
      int _sv0t145 = sv0_vec_get(pp, _sv0t144);
      sv0_vec_push(spath, _sv0t145);
      sk = (sk + 1);
    }
    const char* _sv0t146 = path_join_vec(source, starts, ends, spath);
    const char* sps;
    sps = _sv0t146;
    int _sv0t147 = res_type_exists(mod_tys, sps, source, starts, ends);
    if ((_sv0t147 != 1)) {
      return 301;
    } else {
    }
    int sfi = 0;
    while ((sfi < sfc)) {
      int _sv0t148 = (idx - sfc);
      int _sv0t149 = (_sv0t148 + sfi);
      int _sv0t150 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t149, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int rfe = _sv0t150;
      if ((rfe != 0)) {
        return rfe;
      } else {
  ...
  if ((tag == 26)) {
    ...
    while ((ari < ac)) {
      int _sv0t157 = (af + ari);
      int _sv0t158 = resolve_expr(et, ed1, ed2, ed3, ed4, _sv0t157, source, starts, ends, mod_vals, mod_tys, fn_arities, frames, pp);
      int rae = _sv0t158;
      if ((rae != 0)) {
        return rae;
      } else {
