...
static Value lower_tag_call(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  while (1) {
    ...
    int _sv0t102 = block_stmt_index(pp, args_first, args_sidecar, ai);
    int a_idx = _sv0t102;
    Value _sv0t103 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, a_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Value av;
    av = _sv0t103;
    int _sv0t104 = sv0_box_alloc(3);
    sv0_box_store(_sv0t104, 0, av.tag);
    sv0_box_store(_sv0t104, 1, av.p0);
    sv0_box_store(_sv0t104, 2, av.p1);
    sv0_vec_push(arg_vals, _sv0t104);
    ai = (ai + 1);
  }
  int _sv0t105 = sv0_vec_get(et, callee_idx);
  int ct = _sv0t105;
  if ((ct == 1)) {
    int _sv0t106 = sv0_vec_get(ed1, callee_idx);
    int cpps = _sv0t106;
    int _sv0t107 = sv0_vec_get(ed2, callee_idx);
    int cppc = _sv0t107;
    if ((cppc == 1)) {
      int _sv0t108 = sv0_vec_get(pp, cpps);
      int callee_tok = _sv0t108;
      int _sv0t109 = ctr_fresh(ctr);
      int t = _sv0t109;
      int bid = 0;
      if ((callee_tok >= 0)) {
        int _sv0t110 = sv0_vec_len(builtin_map);
        if ((callee_tok < _sv0t110)) {
          int _sv0t111 = sv0_vec_get(builtin_map, callee_tok);
          bid = _sv0t111;
        } else {
        }
      } else {
      ...
      if ((bid == 0)) {
        int _sv0t112 = lower_callee_is_void(et, ed1, ed2, pp, idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
        if (_sv0t112) {
          ...
          sv0_box_store(_sv0t113, 0, void_call_instr.tag);
          sv0_box_store(_sv0t113, 1, void_call_instr.p0);
          sv0_box_store(_sv0t113, 2, void_call_instr.p1);
          sv0_box_store(_sv0t113, 3, void_call_instr.p2);
          sv0_box_store(_sv0t113, 4, void_call_instr.p3);
          sv0_vec_push(out_instrs, _sv0t113);
          Value _sv0t114;
          _sv0t114.tag = 4;
          return _sv0t114;
        } else {
        ...
        int rt_u = 0;
        int _sv0t115 = lower_call_ret_is_string(et, ed1, ed2, pp, idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
        if (_sv0t115) {
          int _sv0t116 = lower_string_cty();
          rt_u = _sv0t116;
        } else {
          int _sv0t117 = lower_call_ret_user_ty_tok(et, ed1, ed2, pp, idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
          int uty_c = _sv0t117;
          if ((uty_c >= 0)) {
            rt_u = uty_c;
          } else {
        ...
        sv0_box_store(_sv0t118, 0, call_instr.tag);
        sv0_box_store(_sv0t118, 1, call_instr.p0);
        sv0_box_store(_sv0t118, 2, call_instr.p1);
        sv0_box_store(_sv0t118, 3, call_instr.p2);
        sv0_box_store(_sv0t118, 4, call_instr.p3);
      ...
      if ((bid == 14)) {
        if ((args_count >= 1)) {
          int _sv0t120 = sv0_vec_get(arg_vals, 0);
          Value _sv0t121;
          int _sv0t122 = sv0_box_load(_sv0t120, 0);
          _sv0t121.tag = _sv0t122;
          int _sv0t123 = sv0_box_load(_sv0t120, 1);
          _sv0t121.p0 = _sv0t123;
          int _sv0t124 = sv0_box_load(_sv0t120, 2);
          _sv0t121.p1 = _sv0t124;
          Value na_val;
          na_val.tag = (_sv0t121).tag;
          na_val.p0 = (_sv0t121).p0;
          na_val.p1 = (_sv0t121).p1;
          return na_val;
        } else {
        }
        Value _sv0t125;
      ...
      if ((is_void == 1)) {
        ...
        sv0_box_store(_sv0t126, 0, vc.tag);
        sv0_box_store(_sv0t126, 1, vc.p0);
        sv0_box_store(_sv0t126, 2, vc.p1);
        sv0_box_store(_sv0t126, 3, vc.p2);
        sv0_box_store(_sv0t126, 4, vc.p3);
        sv0_vec_push(out_instrs, _sv0t126);
        Value _sv0t127;
        _sv0t127.tag = 4;
        return _sv0t127;
      } else {
      ...
      sv0_box_store(_sv0t128, 0, bc.tag);
      sv0_box_store(_sv0t128, 1, bc.p0);
      sv0_box_store(_sv0t128, 2, bc.p1);
      sv0_box_store(_sv0t128, 3, bc.p2);
      sv0_box_store(_sv0t128, 4, bc.p3);
    ...
    if ((cppc == 2)) {
      int _sv0t130 = sv0_vec_get(pp, cpps);
      int en_tok = _sv0t130;
      int _sv0t131 = (cpps + 1);
      int _sv0t132 = sv0_vec_get(pp, _sv0t131);
      int vn_tok = _sv0t132;
      int _sv0t133 = enum_tag_lookup_str(enum_names, enum_tags_flat, enum_tag_offsets, enum_tag_counts, en_tok, vn_tok, source, starts, ends);
      int k = _sv0t133;
      int _sv0t134 = ctr_fresh(ctr);
      int t = _sv0t134;
      Instr decl;
      decl.tag = 2;
      decl.p0 = en_tok;
      ...
      sv0_box_store(_sv0t135, 0, decl.tag);
      sv0_box_store(_sv0t135, 1, decl.p0);
      sv0_box_store(_sv0t135, 2, decl.p1);
      sv0_box_store(_sv0t135, 3, decl.p2);
      sv0_box_store(_sv0t135, 4, decl.p3);
      ...
      sv0_box_store(_sv0t139, 0, tag_e.tag);
      sv0_box_store(_sv0t139, 1, tag_e.p0);
      sv0_box_store(_sv0t139, 2, tag_e.p1);
      sv0_box_store(_sv0t139, 3, tag_e.p2);
      sf_tag.tag = 5;
      sf_tag.p0 = t;
      sf_tag.p1 = _sv0t138;
      sf_tag.p2 = _sv0t139;
      int _sv0t140 = sv0_box_alloc(5);
      sv0_box_store(_sv0t140, 0, sf_tag.tag);
      sv0_box_store(_sv0t140, 1, sf_tag.p0);
      sv0_box_store(_sv0t140, 2, sf_tag.p1);
      sv0_box_store(_sv0t140, 3, sf_tag.p2);
      sv0_box_store(_sv0t140, 4, sf_tag.p3);
      ...
      while (1) {
        ...
        int _sv0t141 = sv0_vec_get(arg_vals, pi);
        Value _sv0t142;
        int _sv0t143 = sv0_box_load(_sv0t141, 0);
        _sv0t142.tag = _sv0t143;
        int _sv0t144 = sv0_box_load(_sv0t141, 1);
        _sv0t142.p0 = _sv0t144;
        int _sv0t145 = sv0_box_load(_sv0t141, 2);
        _sv0t142.p1 = _sv0t145;
        Value pv;
        pv.tag = (_sv0t142).tag;
        pv.p0 = (_sv0t142).p0;
        pv.p1 = (_sv0t142).p1;
        Expr _sv0t146 = value_to_expr(pv);
        Expr pe;
        pe = _sv0t146;
        int _sv0t147 = (0 - 10);
        int field_sentinel = (_sv0t147 - pi);
        Instr sf_p;
        int _sv0t148 = sv0_box_alloc(4);
        sv0_box_store(_sv0t148, 0, pe.tag);
        sv0_box_store(_sv0t148, 1, pe.p0);
        sv0_box_store(_sv0t148, 2, pe.p1);
        sv0_box_store(_sv0t148, 3, pe.p2);
        sf_p.tag = 5;
        sf_p.p0 = t;
        sf_p.p1 = field_sentinel;
        sf_p.p2 = _sv0t148;
        int _sv0t149 = sv0_box_alloc(5);
        sv0_box_store(_sv0t149, 0, sf_p.tag);
        sv0_box_store(_sv0t149, 1, sf_p.p0);
        sv0_box_store(_sv0t149, 2, sf_p.p1);
        sv0_box_store(_sv0t149, 3, sf_p.p2);
        sv0_box_store(_sv0t149, 4, sf_p.p3);
...
static Value lower_tag_block(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  while (1) {
    ...
    if ((s_tag == 27)) {
      ...
      if ((init_idx >= 0)) {
        ...
        int _sv0t20 = sv0_vec_get(et, init_idx);
        if ((_sv0t20 == 4)) {
          int _sv0t21 = sv0_vec_get(ed1, init_idx);
          int callee_cb = _sv0t21;
          int _sv0t22 = sv0_vec_get(et, callee_cb);
          if ((_sv0t22 == 1)) {
            int _sv0t23 = sv0_vec_get(ed2, callee_cb);
            if ((_sv0t23 == 2)) {
              int _sv0t24 = sv0_vec_get(ed1, callee_cb);
              int _sv0t25 = sv0_vec_get(pp, _sv0t24);
              int ety_cb = _sv0t25;
              Instr decl_eb;
              decl_eb.tag = 2;
              decl_eb.p0 = ety_cb;
              ...
              sv0_box_store(_sv0t26, 0, decl_eb.tag);
              sv0_box_store(_sv0t26, 1, decl_eb.p0);
              sv0_box_store(_sv0t26, 2, decl_eb.p1);
              sv0_box_store(_sv0t26, 3, decl_eb.p2);
              sv0_box_store(_sv0t26, 4, decl_eb.p3);
        ...
        int _sv0t27 = lower_expr_yields_string(et, ed1, ed2, ed3, pp, init_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
        if (_sv0t27) {
          Instr decl_sb;
          int _sv0t28 = lower_string_cty();
          decl_sb.tag = 2;
          decl_sb.p0 = _sv0t28;
          decl_sb.p1 = name_tok;
          int _sv0t29 = sv0_box_alloc(5);
          sv0_box_store(_sv0t29, 0, decl_sb.tag);
          sv0_box_store(_sv0t29, 1, decl_sb.p0);
          sv0_box_store(_sv0t29, 2, decl_sb.p1);
          sv0_box_store(_sv0t29, 3, decl_sb.p2);
          sv0_box_store(_sv0t29, 4, decl_sb.p3);
          sv0_vec_push(out_instrs, _sv0t29);
          let_declared = 1;
        } else {
        }
        if ((let_declared == 0)) {
          int _sv0t30 = lower_call_ret_is_string(et, ed1, ed2, pp, init_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
          if (_sv0t30) {
            Instr decl_scb;
            int _sv0t31 = lower_string_cty();
            decl_scb.tag = 2;
            decl_scb.p0 = _sv0t31;
            decl_scb.p1 = name_tok;
            int _sv0t32 = sv0_box_alloc(5);
            sv0_box_store(_sv0t32, 0, decl_scb.tag);
            sv0_box_store(_sv0t32, 1, decl_scb.p0);
            sv0_box_store(_sv0t32, 2, decl_scb.p1);
            sv0_box_store(_sv0t32, 3, decl_scb.p2);
            sv0_box_store(_sv0t32, 4, decl_scb.p3);
        ...
        if ((let_declared == 0)) {
          int _sv0t33 = lower_init_ident_is_string_param(et, ed1, ed2, pp, init_idx, item_tags, item_names, item_d3, tok_tags, source, starts, ends, item_fn_row);
          if (_sv0t33) {
            Instr decl_spb;
            int _sv0t34 = lower_string_cty();
            decl_spb.tag = 2;
            decl_spb.p0 = _sv0t34;
            decl_spb.p1 = name_tok;
            int _sv0t35 = sv0_box_alloc(5);
            sv0_box_store(_sv0t35, 0, decl_spb.tag);
            sv0_box_store(_sv0t35, 1, decl_spb.p0);
            sv0_box_store(_sv0t35, 2, decl_spb.p1);
            sv0_box_store(_sv0t35, 3, decl_spb.p2);
            sv0_box_store(_sv0t35, 4, decl_spb.p3);
        ...
        if ((let_declared == 0)) {
          int _sv0t36 = lower_call_ret_user_ty_tok(et, ed1, ed2, pp, init_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
          int uty_lb = _sv0t36;
          if ((uty_lb >= 0)) {
            Instr decl_utb;
            decl_utb.tag = 2;
            decl_utb.p0 = uty_lb;
            decl_utb.p1 = name_tok;
            int _sv0t37 = sv0_box_alloc(5);
            sv0_box_store(_sv0t37, 0, decl_utb.tag);
            sv0_box_store(_sv0t37, 1, decl_utb.p0);
            sv0_box_store(_sv0t37, 2, decl_utb.p1);
            sv0_box_store(_sv0t37, 3, decl_utb.p2);
            sv0_box_store(_sv0t37, 4, decl_utb.p3);
        ...
        if ((let_declared == 0)) {
          int _sv0t38 = sv0_vec_get(ed2, s_idx);
          int _sv0t39 = lower_typed_box_deref_let(et, ed1, ed2, ed3, ed4, pp, tok_tags, init_idx, name_tok, _sv0t38, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
          int bdb = _sv0t39;
          if ((bdb == 1)) {
            let_declared = 1;
            init_handled = 1;
      ...
      if ((init_idx >= 0)) {
        if ((init_handled == 0)) {
          Value _sv0t40 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, init_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
          Value iv;
          iv = _sv0t40;
          if ((let_declared == 0)) {
            Instr _sv0t41;
            ...
            sv0_vec_push(out_instrs, _sv0t42);
          } else {
          }
          Expr lit_e;
          int _sv0t43 = sv0_box_alloc(3);
          sv0_box_store(_sv0t43, 0, iv.tag);
          sv0_box_store(_sv0t43, 1, iv.p0);
          sv0_box_store(_sv0t43, 2, iv.p1);
          lit_e.tag = 0;
          lit_e.p0 = _sv0t43;
          Instr asgn;
          int _sv0t44 = sv0_box_alloc(4);
          sv0_box_store(_sv0t44, 0, lit_e.tag);
          sv0_box_store(_sv0t44, 1, lit_e.p0);
          sv0_box_store(_sv0t44, 2, lit_e.p1);
          sv0_box_store(_sv0t44, 3, lit_e.p2);
          asgn.tag = 4;
          asgn.p0 = name_tok;
          asgn.p1 = _sv0t44;
          int _sv0t45 = sv0_box_alloc(5);
          sv0_box_store(_sv0t45, 0, asgn.tag);
          sv0_box_store(_sv0t45, 1, asgn.p0);
          sv0_box_store(_sv0t45, 2, asgn.p1);
          sv0_box_store(_sv0t45, 3, asgn.p2);
          sv0_box_store(_sv0t45, 4, asgn.p3);
          sv0_vec_push(out_instrs, _sv0t45);
        } else {
        }
      } else {
    ...
    if ((s_tag == 28)) {
      int _sv0t48 = sv0_vec_get(ed1, s_idx);
      int semi_idx = _sv0t48;
      int _sv0t49 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, semi_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      int de1 = _sv0t49;
    } else {
    }
    si = (si + 1);
  ...
  if ((tail_idx >= 0)) {
    Value _sv0t50 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, tail_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    return _sv0t50;
  } else {
  }
  Value _sv0t51;
...
static Value lower_expr_to_value(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  if ((tag == 12)) {
    ...
    int cond_is = _sv0t118;
    Expr _sv0t119 = lower_cond_expr(et, ed1, ed2, ed3, ed4, pp, tok_tags, cond_idx2, ctr, cond_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Expr ce2;
    ce2 = _sv0t119;
    ...
    Value discard3;
    discard3 = _sv0t121;
    int _sv0t122 = sv0_vec_len(cond_is);
    if ((_sv0t122 == 0)) {
      Instr wl;
      int _sv0t123 = sv0_box_alloc(4);
      sv0_box_store(_sv0t123, 0, ce2.tag);
      sv0_box_store(_sv0t123, 1, ce2.p0);
      sv0_box_store(_sv0t123, 2, ce2.p1);
      sv0_box_store(_sv0t123, 3, ce2.p2);
      wl.tag = 7;
      wl.p0 = _sv0t123;
      wl.p1 = body_is;
      int _sv0t124 = sv0_box_alloc(5);
      sv0_box_store(_sv0t124, 0, wl.tag);
      sv0_box_store(_sv0t124, 1, wl.p0);
      sv0_box_store(_sv0t124, 2, wl.p1);
      sv0_box_store(_sv0t124, 3, wl.p2);
      sv0_box_store(_sv0t124, 4, wl.p3);
      sv0_vec_push(out_instrs, _sv0t124);
    } else {
      int _sv0t125 = ctr_fresh(ctr);
      int ct_w = _sv0t125;
      int _sv0t126 = sv0_vec_new();
      int loop_body = _sv0t126;
      int ci = 0;
      while (1) {
        int _sv0t127 = sv0_vec_len(cond_is);
        int _sv0t129 = (ci < _sv0t127);
        if ((!_sv0t129)) {
          break;
        } else {
        }
        int _sv0t128 = sv0_vec_get(cond_is, ci);
        sv0_vec_push(loop_body, _sv0t128);
        ci = (ci + 1);
      }
      Instr asg_w;
      int _sv0t130 = sv0_box_alloc(4);
      sv0_box_store(_sv0t130, 0, ce2.tag);
      sv0_box_store(_sv0t130, 1, ce2.p0);
      sv0_box_store(_sv0t130, 2, ce2.p1);
      sv0_box_store(_sv0t130, 3, ce2.p2);
      asg_w.tag = 3;
      asg_w.p0 = ct_w;
      asg_w.p1 = _sv0t130;
      int _sv0t131 = sv0_box_alloc(5);
      sv0_box_store(_sv0t131, 0, asg_w.tag);
      sv0_box_store(_sv0t131, 1, asg_w.p0);
      sv0_box_store(_sv0t131, 2, asg_w.p1);
      sv0_box_store(_sv0t131, 3, asg_w.p2);
      sv0_box_store(_sv0t131, 4, asg_w.p3);
      sv0_vec_push(loop_body, _sv0t131);
      Expr neg_w;
      Value _sv0t132;
      _sv0t132.tag = 3;
      _sv0t132.p0 = ct_w;
      int _sv0t133 = sv0_box_alloc(3);
      sv0_box_store(_sv0t133, 0, _sv0t132.tag);
      sv0_box_store(_sv0t133, 1, _sv0t132.p0);
      sv0_box_store(_sv0t133, 2, _sv0t132.p1);
      neg_w.tag = 3;
      neg_w.p0 = 1;
      neg_w.p1 = _sv0t133;
      int _sv0t134 = sv0_vec_new();
      int brk_blk = _sv0t134;
      Instr _sv0t135;
      _sv0t135.tag = 9;
      ...
      sv0_box_store(_sv0t136, 3, _sv0t135.p2);
      ...
      sv0_box_store(_sv0t138, 1, neg_w.p0);
      sv0_box_store(_sv0t138, 2, neg_w.p1);
      ...
      sv0_box_store(_sv0t139, 2, if_w.p1);
      sv0_box_store(_sv0t139, 3, if_w.p2);
      sv0_box_store(_sv0t139, 4, if_w.p3);
      sv0_vec_push(loop_body, _sv0t139);
      int bi = 0;
      while (1) {
        int _sv0t140 = sv0_vec_len(body_is);
        int _sv0t142 = (bi < _sv0t140);
        if ((!_sv0t142)) {
          break;
        } else {
        }
        int _sv0t141 = sv0_vec_get(body_is, bi);
        sv0_vec_push(loop_body, _sv0t141);
        bi = (bi + 1);
      }
      Instr wl;
      Expr _sv0t143;
      ...
      sv0_box_store(_sv0t146, 0, _sv0t143.tag);
      sv0_box_store(_sv0t146, 1, _sv0t143.p0);
      sv0_box_store(_sv0t146, 2, _sv0t143.p1);
      sv0_box_store(_sv0t146, 3, _sv0t143.p2);
      wl.tag = 7;
      wl.p0 = _sv0t146;
      wl.p1 = loop_body;
      int _sv0t147 = sv0_box_alloc(5);
      sv0_box_store(_sv0t147, 0, wl.tag);
      sv0_box_store(_sv0t147, 1, wl.p0);
      sv0_box_store(_sv0t147, 2, wl.p1);
      sv0_box_store(_sv0t147, 3, wl.p2);
      sv0_box_store(_sv0t147, 4, wl.p3);
  ...
  if ((tag == 14)) {
    ...
    int loop_body = _sv0t150;
    Value true_v;
    true_v.tag = 1;
    Expr true_e;
    int _sv0t151 = sv0_box_alloc(3);
    sv0_box_store(_sv0t151, 0, true_v.tag);
    sv0_box_store(_sv0t151, 1, true_v.p0);
    sv0_box_store(_sv0t151, 2, true_v.p1);
    true_e.tag = 0;
    true_e.p0 = _sv0t151;
    int _sv0t152 = sv0_vec_new();
    int loop_is = _sv0t152;
    Value _sv0t153 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, loop_body, ctr, loop_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Value discard4;
    discard4 = _sv0t153;
    Instr ll;
    int _sv0t154 = sv0_box_alloc(4);
    sv0_box_store(_sv0t154, 0, true_e.tag);
    sv0_box_store(_sv0t154, 1, true_e.p0);
    sv0_box_store(_sv0t154, 2, true_e.p1);
    sv0_box_store(_sv0t154, 3, true_e.p2);
    ll.tag = 7;
    ll.p0 = _sv0t154;
    ll.p1 = loop_is;
    int _sv0t155 = sv0_box_alloc(5);
    sv0_box_store(_sv0t155, 0, ll.tag);
    sv0_box_store(_sv0t155, 1, ll.p0);
    sv0_box_store(_sv0t155, 2, ll.p1);
    sv0_box_store(_sv0t155, 3, ll.p2);
    sv0_box_store(_sv0t155, 4, ll.p3);
  ...
  if ((tag == 15)) {
    ...
    int val_idx = _sv0t157;
    if ((val_idx >= 0)) {
      Value _sv0t158 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, val_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      Value rv;
      rv = _sv0t158;
      Instr ret_instr;
      int _sv0t159 = sv0_box_alloc(3);
      sv0_box_store(_sv0t159, 0, rv.tag);
      sv0_box_store(_sv0t159, 1, rv.p0);
      sv0_box_store(_sv0t159, 2, rv.p1);
      ret_instr.tag = 15;
      ret_instr.p0 = _sv0t159;
      int _sv0t160 = sv0_box_alloc(5);
      sv0_box_store(_sv0t160, 0, ret_instr.tag);
      sv0_box_store(_sv0t160, 1, ret_instr.p0);
      sv0_box_store(_sv0t160, 2, ret_instr.p1);
      sv0_box_store(_sv0t160, 3, ret_instr.p2);
      sv0_box_store(_sv0t160, 4, ret_instr.p3);
    ...
    sv0_box_store(_sv0t162, 0, ret_void.tag);
    sv0_box_store(_sv0t162, 1, ret_void.p0);
    sv0_box_store(_sv0t162, 2, ret_void.p1);
    sv0_box_store(_sv0t162, 3, ret_void.p2);
    sv0_box_store(_sv0t162, 4, ret_void.p3);
  ...
  if ((tag == 16)) {
    ...
    sv0_box_store(_sv0t164, 0, brk.tag);
    sv0_box_store(_sv0t164, 1, brk.p0);
    sv0_box_store(_sv0t164, 2, brk.p1);
    sv0_box_store(_sv0t164, 3, brk.p2);
    sv0_box_store(_sv0t164, 4, brk.p3);
  ...
  if ((tag == 17)) {
    ...
    sv0_box_store(_sv0t166, 0, cnt.tag);
    sv0_box_store(_sv0t166, 1, cnt.p0);
    sv0_box_store(_sv0t166, 2, cnt.p1);
    sv0_box_store(_sv0t166, 3, cnt.p2);
    sv0_box_store(_sv0t166, 4, cnt.p3);
  ...
  if ((tag == 18)) {
    ...
    int lhs_idx = _sv0t168;
    int _sv0t169 = sv0_vec_get(ed2, idx);
    int rhs_idx = _sv0t169;
    Expr _sv0t170 = lower_expr_with_instrs(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Expr rhs_e;
    rhs_e = _sv0t170;
    int _sv0t171 = sv0_vec_new();
    int aout = _sv0t171;
    int _sv0t172 = classify_assign_lhs_arena(et, ed1, ed2, pp, lhs_idx, aout);
    int cls = _sv0t172;
    if ((cls == 0)) {
      int _sv0t173 = sv0_vec_get(aout, 0);
      int var_tok = _sv0t173;
      Instr store;
      int _sv0t174 = sv0_box_alloc(4);
      sv0_box_store(_sv0t174, 0, rhs_e.tag);
      sv0_box_store(_sv0t174, 1, rhs_e.p0);
      sv0_box_store(_sv0t174, 2, rhs_e.p1);
      sv0_box_store(_sv0t174, 3, rhs_e.p2);
      store.tag = 4;
      store.p0 = var_tok;
      store.p1 = _sv0t174;
      int _sv0t175 = sv0_box_alloc(5);
      sv0_box_store(_sv0t175, 0, store.tag);
      sv0_box_store(_sv0t175, 1, store.p0);
      sv0_box_store(_sv0t175, 2, store.p1);
      sv0_box_store(_sv0t175, 3, store.p2);
      sv0_box_store(_sv0t175, 4, store.p3);
      sv0_vec_push(out_instrs, _sv0t175);
    } else {
    }
    if ((cls == 1)) {
      int _sv0t176 = sv0_vec_get(aout, 0);
      int obj_tok = _sv0t176;
      int _sv0t177 = sv0_vec_get(aout, 1);
      int fld_tok = _sv0t177;
      Instr sf;
      ...
      sv0_box_store(_sv0t179, 0, sf.tag);
      sv0_box_store(_sv0t179, 1, sf.p0);
      sv0_box_store(_sv0t179, 2, sf.p1);
      sv0_box_store(_sv0t179, 3, sf.p2);
      sv0_box_store(_sv0t179, 4, sf.p3);
  ...
  if ((tag == 19)) {
    ...
    int lhs_idx2 = _sv0t182;
    int _sv0t183 = sv0_vec_get(ed3, idx);
    int rhs_idx2 = _sv0t183;
    int _sv0t184 = sv0_vec_new();
    int aout2 = _sv0t184;
    int _sv0t185 = classify_assign_lhs_arena(et, ed1, ed2, pp, lhs_idx2, aout2);
    int cls2 = _sv0t185;
    if ((cls2 == 0)) {
      int _sv0t186 = sv0_vec_get(aout2, 0);
      int var_tok2 = _sv0t186;
      Value cur;
      cur.tag = 3;
      cur.p0 = var_tok2;
      Value _sv0t187 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx2, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      Value rv2;
      rv2 = _sv0t187;
      Expr be;
      int _sv0t188 = sv0_box_alloc(3);
      sv0_box_store(_sv0t188, 0, cur.tag);
      sv0_box_store(_sv0t188, 1, cur.p0);
      sv0_box_store(_sv0t188, 2, cur.p1);
      int _sv0t189 = sv0_box_alloc(3);
      sv0_box_store(_sv0t189, 0, rv2.tag);
      sv0_box_store(_sv0t189, 1, rv2.p0);
      sv0_box_store(_sv0t189, 2, rv2.p1);
      be.tag = 2;
      be.p0 = op_tag;
      be.p1 = _sv0t188;
      be.p2 = _sv0t189;
      ...
      sv0_box_store(_sv0t190, 0, be.tag);
      sv0_box_store(_sv0t190, 1, be.p0);
      sv0_box_store(_sv0t190, 2, be.p1);
      sv0_box_store(_sv0t190, 3, be.p2);
      st2.tag = 4;
      st2.p0 = var_tok2;
      st2.p1 = _sv0t190;
      int _sv0t191 = sv0_box_alloc(5);
      sv0_box_store(_sv0t191, 0, st2.tag);
      sv0_box_store(_sv0t191, 1, st2.p0);
      sv0_box_store(_sv0t191, 2, st2.p1);
      sv0_box_store(_sv0t191, 3, st2.p2);
      sv0_box_store(_sv0t191, 4, st2.p3);
  ...
  if ((tag == 20)) {
    int _sv0t193 = sv0_vec_get(ed1, idx);
    int cast_src = _sv0t193;
    Value _sv0t194 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, cast_src, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Value cv;
    cv = _sv0t194;
    int _sv0t195 = ctr_fresh(ctr);
    int ct2 = _sv0t195;
    Expr cast_e;
    int _sv0t196 = sv0_box_alloc(3);
    sv0_box_store(_sv0t196, 0, cv.tag);
    sv0_box_store(_sv0t196, 1, cv.p0);
    sv0_box_store(_sv0t196, 2, cv.p1);
    cast_e.tag = 3;
    cast_e.p0 = 99;
    cast_e.p1 = _sv0t196;
    Instr cast_i;
    int _sv0t197 = sv0_box_alloc(4);
    sv0_box_store(_sv0t197, 0, cast_e.tag);
    sv0_box_store(_sv0t197, 1, cast_e.p0);
    sv0_box_store(_sv0t197, 2, cast_e.p1);
    sv0_box_store(_sv0t197, 3, cast_e.p2);
    cast_i.tag = 3;
    cast_i.p0 = ct2;
    cast_i.p1 = _sv0t197;
    int _sv0t198 = sv0_box_alloc(5);
    sv0_box_store(_sv0t198, 0, cast_i.tag);
    sv0_box_store(_sv0t198, 1, cast_i.p0);
    sv0_box_store(_sv0t198, 2, cast_i.p1);
    sv0_box_store(_sv0t198, 3, cast_i.p2);
    sv0_box_store(_sv0t198, 4, cast_i.p3);
  ...
  if ((tag == 22)) {
    Value _sv0t200 = lower_tag_try(et, ed1, ed2, ed3, ed4, pp, tok_tags, idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    return _sv0t200;
  } else {
  }
  if ((tag == 24)) {
    int _sv0t201 = sv0_vec_get(ed1, idx);
    int pps_s = _sv0t201;
    int _sv0t202 = sv0_vec_get(ed2, idx);
    int ppc_s = _sv0t202;
    int _sv0t203 = sv0_vec_get(ed3, idx);
    int fc_s = _sv0t203;
    int _sv0t204 = sv0_vec_get(ed4, idx);
    int sf0 = _sv0t204;
    if ((ppc_s < 1)) {
      Value _sv0t205;
      _sv0t205.tag = 4;
    ...
    int _sv0t207 = (pps_s + ppc_s);
    int sty_idx = (_sv0t207 - 1);
    int _sv0t208 = sv0_vec_get(pp, sty_idx);
    int sty_tok = _sv0t208;
    int _sv0t209 = ctr_fresh(ctr);
    int t_s = _sv0t209;
    Instr decl_s;
    decl_s.tag = 2;
    decl_s.p0 = sty_tok;
    ...
    sv0_box_store(_sv0t210, 0, decl_s.tag);
    sv0_box_store(_sv0t210, 1, decl_s.p0);
    sv0_box_store(_sv0t210, 2, decl_s.p1);
    sv0_box_store(_sv0t210, 3, decl_s.p2);
    sv0_box_store(_sv0t210, 4, decl_s.p3);
    sv0_vec_push(out_instrs, _sv0t210);
    int fi_s = 0;
    while ((fi_s < fc_s)) {
      int _sv0t211 = (fi_s * 2);
      int _sv0t212 = (sf0 + _sv0t211);
      int _sv0t213 = (_sv0t212 + 1);
      int _sv0t214 = sv0_vec_get(lit_sf_names, _sv0t213);
      int ch_s = _sv0t214;
      Value _sv0t215 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, ch_s, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      Value fv_s;
      fv_s = _sv0t215;
      Expr _sv0t216 = value_to_expr(fv_s);
      Expr fe_s;
      fe_s = _sv0t216;
      int _sv0t217 = (fi_s * 2);
      int _sv0t218 = (sf0 + _sv0t217);
      int _sv0t219 = sv0_vec_get(lit_sf_names, _sv0t218);
      int fnm_s = _sv0t219;
      Instr stf_s;
      int _sv0t220 = sv0_box_alloc(4);
      sv0_box_store(_sv0t220, 0, fe_s.tag);
      sv0_box_store(_sv0t220, 1, fe_s.p0);
      sv0_box_store(_sv0t220, 2, fe_s.p1);
      sv0_box_store(_sv0t220, 3, fe_s.p2);
      stf_s.tag = 5;
      stf_s.p0 = t_s;
      stf_s.p1 = fnm_s;
      stf_s.p2 = _sv0t220;
      int _sv0t221 = sv0_box_alloc(5);
      sv0_box_store(_sv0t221, 0, stf_s.tag);
      sv0_box_store(_sv0t221, 1, stf_s.p0);
      sv0_box_store(_sv0t221, 2, stf_s.p1);
      sv0_box_store(_sv0t221, 3, stf_s.p2);
      sv0_box_store(_sv0t221, 4, stf_s.p3);
  ...
  if ((tag == 25)) {
    int _sv0t223 = sv0_vec_get(ed2, idx);
    int elem_count = _sv0t223;
    if ((elem_count == 1)) {
      int _sv0t224 = sv0_vec_get(ed1, idx);
      int first_idx = _sv0t224;
      Value _sv0t225 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, first_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      return _sv0t225;
    } else {
    }
  } else {
  ...
  if ((tag == 23)) {
    int _sv0t226 = sv0_vec_get(ed1, idx);
    int assert_expr = _sv0t226;
    int _sv0t227 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, assert_expr, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Value _sv0t228;
    _sv0t228.tag = 4;
    return _sv0t228;
  } else {
...
static int lower_for_effect(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  if ((etag == 10)) {
    ...
    int _sv0t3 = sv0_vec_get(ed3, idx);
    int else_idx = _sv0t3;
    Expr _sv0t4 = lower_cond_expr(et, ed1, ed2, ed3, ed4, pp, tok_tags, cond_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Expr cond_e;
    cond_e = _sv0t4;
    int _sv0t5 = sv0_vec_new();
    int then_is = _sv0t5;
    int _sv0t6 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, then_idx, ctr, then_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    int rt = _sv0t6;
    int _sv0t7 = sv0_vec_new();
    int else_is = _sv0t7;
    if ((else_idx >= 0)) {
      int _sv0t8 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, else_idx, ctr, else_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      int re = _sv0t8;
    } else {
    }
    Instr _sv0t9;
    int _sv0t10 = sv0_box_alloc(4);
    sv0_box_store(_sv0t10, 0, cond_e.tag);
    sv0_box_store(_sv0t10, 1, cond_e.p0);
    sv0_box_store(_sv0t10, 2, cond_e.p1);
    sv0_box_store(_sv0t10, 3, cond_e.p2);
    _sv0t9.tag = 6;
    _sv0t9.p0 = _sv0t10;
    _sv0t9.p1 = then_is;
    _sv0t9.p2 = else_is;
    ...
    sv0_box_store(_sv0t11, 4, _sv0t9.p3);
    sv0_vec_push(out_instrs, _sv0t11);
    return 0;
  } else {
  }
  Value _sv0t12 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
  Value discard5;
  discard5 = _sv0t12;
  return 0;
}
...
static int lower_stmt(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int s_idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases, int str_locals) {
  ...
  if ((s_tag == 27)) {
    ...
    if ((init_idx >= 0)) {
      ...
      if ((_sv0t10 == 1)) {
        ...
        if ((_sv0t11 == 2)) {
          ...
          int _sv0t13 = sv0_vec_get(pp, _sv0t12);
          int ety_tok = _sv0t13;
          int _sv0t14 = sv0_vec_get(ed1, init_idx);
          int _sv0t15 = (_sv0t14 + 1);
          int _sv0t16 = sv0_vec_get(pp, _sv0t15);
          int vn_tok_n = _sv0t16;
          Instr _sv0t17;
          _sv0t17.tag = 2;
          _sv0t17.p0 = ety_tok;
          _sv0t17.p1 = name_tok;
          ...
          sv0_vec_push(out_instrs, _sv0t18);
          int _sv0t19 = enum_tag_lookup_str(enum_names, enum_tags_flat, enum_tag_offsets, enum_tag_counts, ety_tok, vn_tok_n, source, starts, ends);
          int k_n = _sv0t19;
          Expr tag_en;
          Value _sv0t20;
          _sv0t20.tag = 0;
          ...
          int _sv0t23 = (0 - 1);
          int _sv0t24 = sv0_box_alloc(4);
          sv0_box_store(_sv0t24, 0, tag_en.tag);
          sv0_box_store(_sv0t24, 1, tag_en.p0);
          sv0_box_store(_sv0t24, 2, tag_en.p1);
          sv0_box_store(_sv0t24, 3, tag_en.p2);
          _sv0t22.tag = 5;
          _sv0t22.p0 = name_tok;
          _sv0t22.p1 = _sv0t23;
          _sv0t22.p2 = _sv0t24;
          ...
          sv0_box_store(_sv0t25, 4, _sv0t22.p3);
          sv0_vec_push(out_instrs, _sv0t25);
          let_declared = 1;
          init_handled = 1;
        } else {
      ...
      int _sv0t26 = sv0_vec_get(et, init_idx);
      if ((_sv0t26 == 4)) {
        int _sv0t27 = sv0_vec_get(ed1, init_idx);
        int callee_ci = _sv0t27;
        int _sv0t28 = sv0_vec_get(et, callee_ci);
        if ((_sv0t28 == 1)) {
          int _sv0t29 = sv0_vec_get(ed2, callee_ci);
          if ((_sv0t29 == 2)) {
            int _sv0t30 = sv0_vec_get(ed1, callee_ci);
            int _sv0t31 = sv0_vec_get(pp, _sv0t30);
            int en_tok_c = _sv0t31;
            int _sv0t32 = sv0_vec_get(ed1, callee_ci);
            int _sv0t33 = (_sv0t32 + 1);
            int _sv0t34 = sv0_vec_get(pp, _sv0t33);
            int vn_tok_c = _sv0t34;
            Instr _sv0t35;
            _sv0t35.tag = 2;
            _sv0t35.p0 = en_tok_c;
            _sv0t35.p1 = name_tok;
            ...
            sv0_box_store(_sv0t36, 1, _sv0t35.p0);
            sv0_box_store(_sv0t36, 2, _sv0t35.p1);
            sv0_box_store(_sv0t36, 3, _sv0t35.p2);
            sv0_box_store(_sv0t36, 4, _sv0t35.p3);
            sv0_vec_push(out_instrs, _sv0t36);
            int _sv0t37 = enum_tag_lookup_str(enum_names, enum_tags_flat, enum_tag_offsets, enum_tag_counts, en_tok_c, vn_tok_c, source, starts, ends);
            int k_c = _sv0t37;
            int _sv0t38 = sv0_vec_get(ed2, init_idx);
            int args_first_c = _sv0t38;
            int _sv0t39 = sv0_vec_get(ed3, init_idx);
            int args_count_c = _sv0t39;
            int _sv0t40 = sv0_vec_get(ed4, init_idx);
            int args_sidecar_c = _sv0t40;
            int _sv0t41 = sv0_vec_new();
            int arg_vals_c = _sv0t41;
            int ai_c = 0;
            while ((ai_c < args_count_c)) {
              int _sv0t42 = block_stmt_index(pp, args_first_c, args_sidecar_c, ai_c);
              int a_idx_c = _sv0t42;
              Value _sv0t43 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, a_idx_c, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
              Value av_c;
              av_c = _sv0t43;
              int _sv0t44 = sv0_box_alloc(3);
              sv0_box_store(_sv0t44, 0, av_c.tag);
              sv0_box_store(_sv0t44, 1, av_c.p0);
              sv0_box_store(_sv0t44, 2, av_c.p1);
              sv0_vec_push(arg_vals_c, _sv0t44);
              ai_c = (ai_c + 1);
            }
            Expr tag_ec;
            Value _sv0t45;
            ...
            int _sv0t48 = (0 - 1);
            int _sv0t49 = sv0_box_alloc(4);
            sv0_box_store(_sv0t49, 0, tag_ec.tag);
            sv0_box_store(_sv0t49, 1, tag_ec.p0);
            sv0_box_store(_sv0t49, 2, tag_ec.p1);
            sv0_box_store(_sv0t49, 3, tag_ec.p2);
            _sv0t47.tag = 5;
            _sv0t47.p0 = name_tok;
            _sv0t47.p1 = _sv0t48;
            _sv0t47.p2 = _sv0t49;
            ...
            sv0_box_store(_sv0t50, 4, _sv0t47.p3);
            sv0_vec_push(out_instrs, _sv0t50);
            int pi_c = 0;
            while ((pi_c < args_count_c)) {
              int _sv0t51 = sv0_vec_get(arg_vals_c, pi_c);
              Value _sv0t52;
              ...
              _sv0t52.p1 = _sv0t55;
              Value pv_c;
              pv_c.tag = (_sv0t52).tag;
              pv_c.p0 = (_sv0t52).p0;
              pv_c.p1 = (_sv0t52).p1;
              int _sv0t56 = (0 - 10);
              int fs_c = (_sv0t56 - pi_c);
              Instr _sv0t57;
              Expr _sv0t58 = value_to_expr(pv_c);
      ...
      int _sv0t61 = lower_expr_yields_string(et, ed1, ed2, ed3, pp, init_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
      if (_sv0t61) {
        int _sv0t62 = lower_string_cty();
        deferred_ty = _sv0t62;
        has_deferred_decl = 1;
        let_declared = 1;
        str_let = 1;
      ...
      if ((let_declared == 0)) {
        int _sv0t63 = lower_call_ret_is_string(et, ed1, ed2, pp, init_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
        if (_sv0t63) {
          Instr decl_su;
          int _sv0t64 = lower_string_cty();
          decl_su.tag = 2;
          decl_su.p0 = _sv0t64;
          decl_su.p1 = name_tok;
          int _sv0t65 = sv0_box_alloc(5);
          sv0_box_store(_sv0t65, 0, decl_su.tag);
          sv0_box_store(_sv0t65, 1, decl_su.p0);
          sv0_box_store(_sv0t65, 2, decl_su.p1);
          sv0_box_store(_sv0t65, 3, decl_su.p2);
          sv0_box_store(_sv0t65, 4, decl_su.p3);
          sv0_vec_push(out_instrs, _sv0t65);
          let_declared = 1;
          str_let = 1;
        } else {
        }
      ...
      if ((let_declared == 0)) {
        int _sv0t66 = lower_init_ident_is_string_param(et, ed1, ed2, pp, init_idx, item_tags, item_names, item_d3, tok_tags, source, starts, ends, item_fn_row);
        if (_sv0t66) {
          Instr decl_sp;
          int _sv0t67 = lower_string_cty();
          decl_sp.tag = 2;
          decl_sp.p0 = _sv0t67;
          decl_sp.p1 = name_tok;
          int _sv0t68 = sv0_box_alloc(5);
          sv0_box_store(_sv0t68, 0, decl_sp.tag);
          sv0_box_store(_sv0t68, 1, decl_sp.p0);
          sv0_box_store(_sv0t68, 2, decl_sp.p1);
          sv0_box_store(_sv0t68, 3, decl_sp.p2);
          sv0_box_store(_sv0t68, 4, decl_sp.p3);
      ...
      if ((let_declared == 0)) {
        int _sv0t69 = lower_ident_in_str_locals(et, ed1, ed2, pp, init_idx, str_locals, source, starts, ends);
        if (_sv0t69) {
          Instr decl_sl;
          int _sv0t70 = lower_string_cty();
          decl_sl.tag = 2;
          decl_sl.p0 = _sv0t70;
          decl_sl.p1 = name_tok;
          int _sv0t71 = sv0_box_alloc(5);
          sv0_box_store(_sv0t71, 0, decl_sl.tag);
          sv0_box_store(_sv0t71, 1, decl_sl.p0);
          sv0_box_store(_sv0t71, 2, decl_sl.p1);
          sv0_box_store(_sv0t71, 3, decl_sl.p2);
          sv0_box_store(_sv0t71, 4, decl_sl.p3);
          sv0_vec_push(out_instrs, _sv0t71);
          let_declared = 1;
          str_let = 1;
        } else {
        }
      ...
      if ((let_declared == 0)) {
        int _sv0t72 = lower_call_ret_user_ty_tok(et, ed1, ed2, pp, init_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
        int uty_ls = _sv0t72;
        if ((uty_ls >= 0)) {
          deferred_ty = uty_ls;
          has_deferred_decl = 1;
      ...
      if ((let_declared == 0)) {
        int _sv0t73 = sv0_vec_get(ed2, s_idx);
        int _sv0t74 = lower_typed_box_deref_let(et, ed1, ed2, ed3, ed4, pp, tok_tags, init_idx, name_tok, _sv0t73, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
        int bd = _sv0t74;
        if ((bd == 1)) {
          let_declared = 1;
          init_handled = 1;
    ...
    if ((init_idx >= 0)) {
      if ((init_handled == 0)) {
        Expr _sv0t75 = lower_expr_with_instrs(et, ed1, ed2, ed3, ed4, pp, tok_tags, init_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
        Expr e;
        e = _sv0t75;
        if ((has_deferred_decl == 1)) {
          Instr _sv0t76;
          _sv0t76.tag = 2;
          _sv0t76.p0 = deferred_ty;
          _sv0t76.p1 = name_tok;
          int _sv0t77 = sv0_box_alloc(5);
          sv0_box_store(_sv0t77, 0, _sv0t76.tag);
          sv0_box_store(_sv0t77, 1, _sv0t76.p0);
          sv0_box_store(_sv0t77, 2, _sv0t76.p1);
          sv0_box_store(_sv0t77, 3, _sv0t76.p2);
          sv0_box_store(_sv0t77, 4, _sv0t76.p3);
          sv0_vec_push(out_instrs, _sv0t77);
        } else {
          if ((let_declared == 0)) {
            Instr _sv0t78;
            _sv0t78.tag = 1;
            ...
            sv0_box_store(_sv0t79, 4, _sv0t78.p3);
            sv0_vec_push(out_instrs, _sv0t79);
          } else {
          }
        }
        Instr si;
        int _sv0t80 = sv0_box_alloc(4);
        sv0_box_store(_sv0t80, 0, e.tag);
        sv0_box_store(_sv0t80, 1, e.p0);
        sv0_box_store(_sv0t80, 2, e.p1);
        sv0_box_store(_sv0t80, 3, e.p2);
        si.tag = 4;
        si.p0 = name_tok;
        si.p1 = _sv0t80;
        int _sv0t81 = sv0_box_alloc(5);
        sv0_box_store(_sv0t81, 0, si.tag);
        sv0_box_store(_sv0t81, 1, si.p0);
        sv0_box_store(_sv0t81, 2, si.p1);
        sv0_box_store(_sv0t81, 3, si.p2);
        sv0_box_store(_sv0t81, 4, si.p3);
        sv0_vec_push(out_instrs, _sv0t81);
      } else {
      }
    } else {
      if ((let_declared == 0)) {
        ...
        sv0_box_store(_sv0t83, 3, _sv0t82.p2);
        sv0_box_store(_sv0t83, 4, _sv0t82.p3);
  ...
  if ((s_tag == 28)) {
    int _sv0t84 = sv0_vec_get(ed1, s_idx);
    int expr_idx = _sv0t84;
    int _sv0t85 = sv0_vec_get(et, expr_idx);
    if ((_sv0t85 == 15)) {
      int _sv0t86 = sv0_vec_get(ed1, expr_idx);
      int ret_val = _sv0t86;
      int _sv0t87 = lower_return(et, ed1, ed2, ed3, ed4, pp, tok_tags, ret_val, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
      return _sv0t87;
    } else {
    }
    int _sv0t88 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, expr_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    int rc = _sv0t88;
    return 0;
  } else {
  }
...
static int lower_typed_box_deref_let(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int init_idx, int name_tok, int ann_tok, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  sv0_box_store(_sv0t22, 0, av.tag);
  sv0_box_store(_sv0t22, 1, av.p0);
  sv0_box_store(_sv0t22, 2, av.p1);
  sv0_vec_push(args, _sv0t22);
  Instr call;
  int _sv0t23 = (0 - 13);
  call.tag = 11;
  call.p0 = name_tok;
  ...
  call.p3 = ann_tok;
  int _sv0t24 = sv0_box_alloc(5);
  sv0_box_store(_sv0t24, 0, call.tag);
  sv0_box_store(_sv0t24, 1, call.p0);
  sv0_box_store(_sv0t24, 2, call.p1);
  sv0_box_store(_sv0t24, 3, call.p2);
  sv0_box_store(_sv0t24, 4, call.p3);
...
static int test_lower_stmt_fn(void) {
  ...
  int _sv0t26 = sv0_vec_new();
  int _sv0t27 = sv0_vec_new();
  int _sv0t28 = lower_stmt(et, ed1, ed2, ed3, ed4, pp, tok_tags, 1, ctr, out, en_n, en_to, en_tc, en_tf, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, _sv0t25, _sv0t26, _sv0t27);
  int rc = _sv0t28;
  if ((rc != 0)) {
    return 1;
  } else {
  ...
  int _sv0t32 = sv0_vec_new();
  int _sv0t33 = sv0_vec_new();
  int _sv0t34 = lower_stmt(et, ed1, ed2, ed3, ed4, pp, tok_tags, 2, ctr, out2, en_n, en_to, en_tc, en_tf, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, _sv0t31, _sv0t32, _sv0t33);
  int rc2 = _sv0t34;
  if ((rc2 != 0)) {
    return 3;
  } else {
