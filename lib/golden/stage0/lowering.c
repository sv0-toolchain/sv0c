...
static int lower_typed_box_deref_let(int et, int ed1, int ed2, int ed3, int ed4, int pp, int init_idx, int name_tok, int ann_tok, int out_instrs, int item_tags, int item_names, const char* source, int starts, int ends);
    ...
    if ((s_tag == 27)) {
      ...
      if ((init_idx >= 0)) {
        ...
        if ((let_declared == 0)) {
          ...
          int _sv0t39 = lower_typed_box_deref_let(et, ed1, ed2, ed3, ed4, pp, init_idx, name_tok, _sv0t38, out_instrs, item_tags, item_names, source, starts, ends);
          int bdb = _sv0t39;
          if ((bdb == 1)) {
            let_declared = 1;
            init_handled = 1;
...
static Value lower_tag_if(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  if ((else_idx >= 0)) {
    ...
    int if_is_str = 0;
    int _sv0t17 = lower_expr_yields_string(et, ed1, ed2, ed3, pp, then_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
    if (_sv0t17) {
      if_is_str = 1;
    } else {
    }
    int _sv0t18 = lower_expr_yields_string(et, ed1, ed2, ed3, pp, else_idx, item_tags, item_names, item_d2, tok_tags, source, starts, ends);
    if (_sv0t18) {
      if_is_str = 1;
    } else {
    }
    if ((if_is_str == 1)) {
      Instr _sv0t19;
      int _sv0t20 = lower_string_cty();
      _sv0t19.tag = 2;
      _sv0t19.p0 = _sv0t20;
      _sv0t19.p1 = t;
      int _sv0t21 = sv0_box_alloc(5);
      sv0_box_store(_sv0t21, 0, _sv0t19.tag);
      sv0_box_store(_sv0t21, 1, _sv0t19.p0);
      sv0_box_store(_sv0t21, 2, _sv0t19.p1);
      sv0_box_store(_sv0t21, 3, _sv0t19.p2);
      sv0_box_store(_sv0t21, 4, _sv0t19.p3);
      ...
      sv0_box_store(_sv0t24, 0, _sv0t22.tag);
      sv0_box_store(_sv0t24, 1, _sv0t22.p0);
      sv0_box_store(_sv0t24, 2, _sv0t22.p1);
      sv0_box_store(_sv0t24, 3, _sv0t22.p2);
      sv0_box_store(_sv0t24, 4, _sv0t22.p3);
      ...
      sv0_box_store(_sv0t26, 3, _sv0t25.p2);
      sv0_box_store(_sv0t26, 4, _sv0t25.p3);
      sv0_vec_push(out_instrs, _sv0t26);
      Instr _sv0t27;
      _sv0t27.tag = 1;
      _sv0t27.p0 = u;
      ...
      sv0_box_store(_sv0t28, 4, _sv0t27.p3);
      sv0_vec_push(out_instrs, _sv0t28);
    }
    Instr if_instr;
    int _sv0t29 = sv0_box_alloc(4);
    sv0_box_store(_sv0t29, 0, cond_expr.tag);
    sv0_box_store(_sv0t29, 1, cond_expr.p0);
    sv0_box_store(_sv0t29, 2, cond_expr.p1);
    sv0_box_store(_sv0t29, 3, cond_expr.p2);
    if_instr.tag = 6;
    if_instr.p0 = _sv0t29;
  ...
  sv0_box_store(_sv0t38, 0, if_no_el.tag);
  sv0_box_store(_sv0t38, 1, if_no_el.p0);
  sv0_box_store(_sv0t38, 2, if_no_el.p1);
  sv0_box_store(_sv0t38, 3, if_no_el.p2);
  sv0_box_store(_sv0t38, 4, if_no_el.p3);
...
static Value lower_expr_to_value(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  if ((tag == 18)) {
    ...
    Value _sv0t170 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, item_fn_row, match_env_inherit, import_aliases);
    Value rhs_v;
    rhs_v = _sv0t170;
    Expr rhs_e;
    int _sv0t171 = sv0_box_alloc(3);
    sv0_box_store(_sv0t171, 0, rhs_v.tag);
    sv0_box_store(_sv0t171, 1, rhs_v.p0);
    sv0_box_store(_sv0t171, 2, rhs_v.p1);
    rhs_e.tag = 0;
    rhs_e.p0 = _sv0t171;
  ...
  if ((s_tag == 27)) {
    ...
    if ((init_idx >= 0)) {
      ...
      if ((let_declared == 0)) {
        ...
        int _sv0t37 = lower_typed_box_deref_let(et, ed1, ed2, ed3, ed4, pp, init_idx, name_tok, _sv0t36, out_instrs, item_tags, item_names, source, starts, ends);
        int bd = _sv0t37;
        if ((bd == 1)) {
          let_declared = 1;
          init_handled = 1;
...
static int lower_typed_box_deref_let(int et, int ed1, int ed2, int ed3, int ed4, int pp, int init_idx, int name_tok, int ann_tok, int out_instrs, int item_tags, int item_names, const char* source, int starts, int ends) {
  ...
  int _sv0t20 = sv0_vec_get(et, arg_idx);
  if ((_sv0t20 != 1)) {
    return 0;
  } else {
  }
  int _sv0t21 = sv0_vec_get(ed2, arg_idx);
  if ((_sv0t21 != 1)) {
    return 0;
  } else {
  }
  int _sv0t22 = sv0_vec_get(ed1, arg_idx);
  int arg_pps = _sv0t22;
  if ((arg_pps < 0)) {
    return 0;
  } else {
  ...
  int _sv0t24 = sv0_vec_get(pp, arg_pps);
  int arg_tok = _sv0t24;
  Value av;
  av.tag = 3;
  av.p0 = arg_tok;
  ...
  sv0_box_store(_sv0t26, 0, av.tag);
  sv0_box_store(_sv0t26, 1, av.p0);
  sv0_box_store(_sv0t26, 2, av.p1);
  sv0_vec_push(args, _sv0t26);
  Instr call;
  int _sv0t27 = (0 - 13);
  call.tag = 11;
  call.p0 = name_tok;
  ...
  call.p3 = ann_tok;
  int _sv0t28 = sv0_box_alloc(5);
  sv0_box_store(_sv0t28, 0, call.tag);
  sv0_box_store(_sv0t28, 1, call.p0);
  sv0_box_store(_sv0t28, 2, call.p1);
  sv0_box_store(_sv0t28, 3, call.p2);
  sv0_box_store(_sv0t28, 4, call.p3);
  sv0_vec_push(out_instrs, _sv0t28);
  return 1;
}
