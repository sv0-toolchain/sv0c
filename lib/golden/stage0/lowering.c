...
static Value lower_expr_to_value(int et, int ed1, int ed2, int ed3, int ed4, int pp, int tok_tags, int idx, int ctr, int out_instrs, int enum_names, int enum_tag_offsets, int enum_tag_counts, int enum_tags_flat, int fn_ctx, int builtin_map, int lit_sf_names, const char* source, int starts, int ends, int item_tags, int item_names, int item_d2, int item_d3, int item_d4, int item_field_counts, int enum_vnames_flat, int enum_max_payloads, int item_fn_row, int match_env_inherit, int import_aliases) {
  ...
  if ((tag == 10)) {
    Value _sv0t178 = lower_tag_if(et, ed1, ed2, ed3, ed4, pp, tok_tags, idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    return _sv0t178;
  } else {
  }
  if ((tag == 11)) {
    Value _sv0t179 = lower_tag_match(et, ed1, ed2, ed3, ed4, pp, tok_tags, idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    return _sv0t179;
  } else {
  }
  if ((tag == 12)) {
    int _sv0t180 = sv0_vec_get(ed1, idx);
    int cond_idx2 = _sv0t180;
    int _sv0t181 = sv0_vec_get(ed2, idx);
    int body_idx2 = _sv0t181;
    int _sv0t182 = sv0_vec_new();
    int cond_is = _sv0t182;
    Expr _sv0t183 = lower_cond_expr(et, ed1, ed2, ed3, ed4, pp, tok_tags, cond_idx2, ctr, cond_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    Expr ce2;
    ce2 = _sv0t183;
    int _sv0t184 = sv0_vec_new();
    int body_is = _sv0t184;
    int _sv0t185 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, body_idx2, ctr, body_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    int discard3 = _sv0t185;
    int _sv0t186 = sv0_vec_len(cond_is);
    if ((_sv0t186 == 0)) {
      Instr wl;
      int _sv0t187 = sv0_box_alloc(4);
      sv0_box_store(_sv0t187, 0, ce2.tag);
      sv0_box_store(_sv0t187, 1, ce2.p0);
      sv0_box_store(_sv0t187, 2, ce2.p1);
      sv0_box_store(_sv0t187, 3, ce2.p2);
      wl.tag = 7;
      wl.p0 = _sv0t187;
      wl.p1 = body_is;
      int _sv0t188 = sv0_box_alloc(5);
      sv0_box_store(_sv0t188, 0, wl.tag);
      sv0_box_store(_sv0t188, 1, wl.p0);
      sv0_box_store(_sv0t188, 2, wl.p1);
      sv0_box_store(_sv0t188, 3, wl.p2);
      sv0_box_store(_sv0t188, 4, wl.p3);
      sv0_vec_push(out_instrs, _sv0t188);
    } else {
      int _sv0t189 = ctr_fresh(ctr);
      int ct_w = _sv0t189;
      int _sv0t190 = sv0_vec_new();
      int loop_body = _sv0t190;
      int ci = 0;
      while (1) {
        int _sv0t191 = sv0_vec_len(cond_is);
        int _sv0t193 = (ci < _sv0t191);
        if ((!_sv0t193)) {
          break;
        } else {
        }
        int _sv0t192 = sv0_vec_get(cond_is, ci);
        sv0_vec_push(loop_body, _sv0t192);
        ci = (ci + 1);
      }
      Instr asg_w;
      int _sv0t194 = sv0_box_alloc(4);
      sv0_box_store(_sv0t194, 0, ce2.tag);
      sv0_box_store(_sv0t194, 1, ce2.p0);
      sv0_box_store(_sv0t194, 2, ce2.p1);
      sv0_box_store(_sv0t194, 3, ce2.p2);
      asg_w.tag = 3;
      asg_w.p0 = ct_w;
      asg_w.p1 = _sv0t194;
      int _sv0t195 = sv0_box_alloc(5);
      sv0_box_store(_sv0t195, 0, asg_w.tag);
      sv0_box_store(_sv0t195, 1, asg_w.p0);
      sv0_box_store(_sv0t195, 2, asg_w.p1);
      sv0_box_store(_sv0t195, 3, asg_w.p2);
      sv0_box_store(_sv0t195, 4, asg_w.p3);
      ...
      int brk_blk = _sv0t198;
      Instr _sv0t199;
      _sv0t199.tag = 9;
      int _sv0t200 = sv0_box_alloc(5);
      sv0_box_store(_sv0t200, 0, _sv0t199.tag);
      sv0_box_store(_sv0t200, 1, _sv0t199.p0);
      sv0_box_store(_sv0t200, 2, _sv0t199.p1);
      sv0_box_store(_sv0t200, 3, _sv0t199.p2);
      sv0_box_store(_sv0t200, 4, _sv0t199.p3);
      sv0_vec_push(brk_blk, _sv0t200);
      int _sv0t201 = sv0_vec_new();
      int empty_else = _sv0t201;
      Instr if_w;
      int _sv0t202 = sv0_box_alloc(4);
      sv0_box_store(_sv0t202, 0, neg_w.tag);
      sv0_box_store(_sv0t202, 1, neg_w.p0);
      sv0_box_store(_sv0t202, 2, neg_w.p1);
      sv0_box_store(_sv0t202, 3, neg_w.p2);
      if_w.tag = 6;
      if_w.p0 = _sv0t202;
      if_w.p1 = brk_blk;
      if_w.p2 = empty_else;
      int _sv0t203 = sv0_box_alloc(5);
      sv0_box_store(_sv0t203, 0, if_w.tag);
      sv0_box_store(_sv0t203, 1, if_w.p0);
      sv0_box_store(_sv0t203, 2, if_w.p1);
      sv0_box_store(_sv0t203, 3, if_w.p2);
      sv0_box_store(_sv0t203, 4, if_w.p3);
      sv0_vec_push(loop_body, _sv0t203);
      int bi = 0;
      while (1) {
        int _sv0t204 = sv0_vec_len(body_is);
        int _sv0t206 = (bi < _sv0t204);
        if ((!_sv0t206)) {
          break;
        } else {
        }
        int _sv0t205 = sv0_vec_get(body_is, bi);
      ...
      Value _sv0t208;
      _sv0t208.tag = 1;
      int _sv0t209 = sv0_box_alloc(3);
      sv0_box_store(_sv0t209, 0, _sv0t208.tag);
      sv0_box_store(_sv0t209, 1, _sv0t208.p0);
      sv0_box_store(_sv0t209, 2, _sv0t208.p1);
      _sv0t207.tag = 0;
      _sv0t207.p0 = _sv0t209;
      int _sv0t210 = sv0_box_alloc(4);
      sv0_box_store(_sv0t210, 0, _sv0t207.tag);
      sv0_box_store(_sv0t210, 1, _sv0t207.p0);
      sv0_box_store(_sv0t210, 2, _sv0t207.p1);
      sv0_box_store(_sv0t210, 3, _sv0t207.p2);
      wl.tag = 7;
      wl.p0 = _sv0t210;
      wl.p1 = loop_body;
  ...
  if ((tag == 13)) {
    Value _sv0t213 = lower_tag_for(et, ed1, ed2, ed3, ed4, pp, tok_tags, idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    return _sv0t213;
  } else {
  }
  if ((tag == 14)) {
    int _sv0t214 = sv0_vec_get(ed1, idx);
    int loop_body = _sv0t214;
    Value true_v;
    true_v.tag = 1;
    Expr true_e;
    int _sv0t215 = sv0_box_alloc(3);
    sv0_box_store(_sv0t215, 0, true_v.tag);
    sv0_box_store(_sv0t215, 1, true_v.p0);
    sv0_box_store(_sv0t215, 2, true_v.p1);
    true_e.tag = 0;
    true_e.p0 = _sv0t215;
    int _sv0t216 = sv0_vec_new();
    int loop_is = _sv0t216;
    int _sv0t217 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, loop_body, ctr, loop_is, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    int discard4 = _sv0t217;
    Instr ll;
    int _sv0t218 = sv0_box_alloc(4);
    sv0_box_store(_sv0t218, 0, true_e.tag);
    sv0_box_store(_sv0t218, 1, true_e.p0);
    sv0_box_store(_sv0t218, 2, true_e.p1);
    sv0_box_store(_sv0t218, 3, true_e.p2);
    ll.tag = 7;
    ll.p0 = _sv0t218;
    ll.p1 = loop_is;
    int _sv0t219 = sv0_box_alloc(5);
    sv0_box_store(_sv0t219, 0, ll.tag);
    sv0_box_store(_sv0t219, 1, ll.p0);
    sv0_box_store(_sv0t219, 2, ll.p1);
    sv0_box_store(_sv0t219, 3, ll.p2);
    sv0_box_store(_sv0t219, 4, ll.p3);
    sv0_vec_push(out_instrs, _sv0t219);
    Value _sv0t220;
    _sv0t220.tag = 4;
    return _sv0t220;
  } else {
  ...
  if ((tag == 15)) {
    ...
    int val_idx = _sv0t221;
    if ((val_idx >= 0)) {
      Value _sv0t222 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, val_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value rv;
      rv = _sv0t222;
      Instr ret_instr;
      int _sv0t223 = sv0_box_alloc(3);
      sv0_box_store(_sv0t223, 0, rv.tag);
      sv0_box_store(_sv0t223, 1, rv.p0);
      sv0_box_store(_sv0t223, 2, rv.p1);
      ret_instr.tag = 15;
      ret_instr.p0 = _sv0t223;
      int _sv0t224 = sv0_box_alloc(5);
      sv0_box_store(_sv0t224, 0, ret_instr.tag);
      sv0_box_store(_sv0t224, 1, ret_instr.p0);
      sv0_box_store(_sv0t224, 2, ret_instr.p1);
      sv0_box_store(_sv0t224, 3, ret_instr.p2);
      sv0_box_store(_sv0t224, 4, ret_instr.p3);
      sv0_vec_push(out_instrs, _sv0t224);
      Value _sv0t225;
      _sv0t225.tag = 4;
      return _sv0t225;
    } else {
    ...
    Instr ret_void;
    ret_void.tag = 14;
    int _sv0t226 = sv0_box_alloc(5);
    sv0_box_store(_sv0t226, 0, ret_void.tag);
    sv0_box_store(_sv0t226, 1, ret_void.p0);
    sv0_box_store(_sv0t226, 2, ret_void.p1);
    sv0_box_store(_sv0t226, 3, ret_void.p2);
    sv0_box_store(_sv0t226, 4, ret_void.p3);
    sv0_vec_push(out_instrs, _sv0t226);
    Value _sv0t227;
    _sv0t227.tag = 4;
    return _sv0t227;
  } else {
  ...
  if ((tag == 16)) {
    ...
    sv0_box_store(_sv0t228, 0, brk.tag);
    sv0_box_store(_sv0t228, 1, brk.p0);
    sv0_box_store(_sv0t228, 2, brk.p1);
    sv0_box_store(_sv0t228, 3, brk.p2);
    sv0_box_store(_sv0t228, 4, brk.p3);
  ...
  if ((tag == 17)) {
    ...
    sv0_box_store(_sv0t230, 0, cnt.tag);
    sv0_box_store(_sv0t230, 1, cnt.p0);
    sv0_box_store(_sv0t230, 2, cnt.p1);
    sv0_box_store(_sv0t230, 3, cnt.p2);
    sv0_box_store(_sv0t230, 4, cnt.p3);
  ...
  if ((tag == 18)) {
    int _sv0t232 = sv0_vec_get(ed1, idx);
    int lhs_idx = _sv0t232;
    int _sv0t233 = sv0_vec_get(ed2, idx);
    int rhs_idx = _sv0t233;
    int _sv0t234 = sv0_vec_get(et, lhs_idx);
    if ((_sv0t234 == 8)) {
      int _sv0t235 = sv0_vec_get(ed1, lhs_idx);
      int base_c = _sv0t235;
      int _sv0t236 = sv0_vec_get(ed2, lhs_idx);
      int ixe_c = _sv0t236;
      Value _sv0t237 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, base_c, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value v_base;
      v_base = _sv0t237;
      Value _sv0t238 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, ixe_c, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value v_ixe;
      v_ixe = _sv0t238;
      Value _sv0t239 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value v_rhs_s;
      v_rhs_s = _sv0t239;
      int _sv0t240 = sv0_vec_new();
      int a_iset = _sv0t240;
      int _sv0t241 = sv0_box_alloc(3);
      sv0_box_store(_sv0t241, 0, v_base.tag);
      sv0_box_store(_sv0t241, 1, v_base.p0);
      sv0_box_store(_sv0t241, 2, v_base.p1);
      sv0_vec_push(a_iset, _sv0t241);
      int _sv0t242 = sv0_box_alloc(3);
      sv0_box_store(_sv0t242, 0, v_ixe.tag);
      sv0_box_store(_sv0t242, 1, v_ixe.p0);
      sv0_box_store(_sv0t242, 2, v_ixe.p1);
      sv0_vec_push(a_iset, _sv0t242);
      int _sv0t243 = sv0_box_alloc(3);
      sv0_box_store(_sv0t243, 0, v_rhs_s.tag);
      sv0_box_store(_sv0t243, 1, v_rhs_s.p0);
      ...
      _sv0t244.p2 = a_iset;
      _sv0t244.p3 = 0;
      int _sv0t246 = sv0_box_alloc(5);
      sv0_box_store(_sv0t246, 0, _sv0t244.tag);
      sv0_box_store(_sv0t246, 1, _sv0t244.p0);
      sv0_box_store(_sv0t246, 2, _sv0t244.p1);
      sv0_box_store(_sv0t246, 3, _sv0t244.p2);
      sv0_box_store(_sv0t246, 4, _sv0t244.p3);
      sv0_vec_push(out_instrs, _sv0t246);
      Value _sv0t247;
      _sv0t247.tag = 4;
      return _sv0t247;
    } else {
    }
    Expr _sv0t248 = lower_expr_with_instrs(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    Expr rhs_e;
    rhs_e = _sv0t248;
    int _sv0t249 = sv0_vec_new();
    int aout = _sv0t249;
    int _sv0t250 = classify_assign_lhs_arena(et, ed1, ed2, pp, lhs_idx, aout);
    int cls = _sv0t250;
    if ((cls == 0)) {
      int _sv0t251 = sv0_vec_get(aout, 0);
      int var_tok = _sv0t251;
      Instr store;
      int _sv0t252 = sv0_box_alloc(4);
      sv0_box_store(_sv0t252, 0, rhs_e.tag);
      sv0_box_store(_sv0t252, 1, rhs_e.p0);
      sv0_box_store(_sv0t252, 2, rhs_e.p1);
      sv0_box_store(_sv0t252, 3, rhs_e.p2);
      store.tag = 4;
      store.p0 = var_tok;
      store.p1 = _sv0t252;
      int _sv0t253 = sv0_box_alloc(5);
      sv0_box_store(_sv0t253, 0, store.tag);
      sv0_box_store(_sv0t253, 1, store.p0);
      sv0_box_store(_sv0t253, 2, store.p1);
      sv0_box_store(_sv0t253, 3, store.p2);
      sv0_box_store(_sv0t253, 4, store.p3);
      sv0_vec_push(out_instrs, _sv0t253);
    } else {
    }
    if ((cls == 1)) {
      int _sv0t254 = sv0_vec_get(aout, 0);
      int obj_tok = _sv0t254;
      int _sv0t255 = sv0_vec_get(aout, 1);
      int fld_tok = _sv0t255;
      Instr sf;
      int _sv0t256 = sv0_box_alloc(4);
      sv0_box_store(_sv0t256, 0, rhs_e.tag);
      sv0_box_store(_sv0t256, 1, rhs_e.p0);
      sv0_box_store(_sv0t256, 2, rhs_e.p1);
      sv0_box_store(_sv0t256, 3, rhs_e.p2);
      sf.tag = 5;
      sf.p0 = obj_tok;
      sf.p1 = fld_tok;
      sf.p2 = _sv0t256;
      int _sv0t257 = sv0_box_alloc(5);
      sv0_box_store(_sv0t257, 0, sf.tag);
      sv0_box_store(_sv0t257, 1, sf.p0);
      sv0_box_store(_sv0t257, 2, sf.p1);
      sv0_box_store(_sv0t257, 3, sf.p2);
      sv0_box_store(_sv0t257, 4, sf.p3);
  ...
  if ((tag == 19)) {
    int _sv0t259 = sv0_vec_get(ed1, idx);
    int op_tag = _sv0t259;
    int _sv0t260 = sv0_vec_get(ed2, idx);
    int lhs_idx2 = _sv0t260;
    int _sv0t261 = sv0_vec_get(ed3, idx);
    int rhs_idx2 = _sv0t261;
    int _sv0t262 = sv0_vec_new();
    int aout2 = _sv0t262;
    int _sv0t263 = classify_assign_lhs_arena(et, ed1, ed2, pp, lhs_idx2, aout2);
    int cls2 = _sv0t263;
    if ((cls2 == 0)) {
      int _sv0t264 = sv0_vec_get(aout2, 0);
      int var_tok2 = _sv0t264;
      Value cur;
      cur.tag = 3;
      cur.p0 = var_tok2;
      Value _sv0t265 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx2, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value rv2;
      rv2 = _sv0t265;
      Expr be;
      int _sv0t266 = sv0_box_alloc(3);
      sv0_box_store(_sv0t266, 0, cur.tag);
      sv0_box_store(_sv0t266, 1, cur.p0);
      sv0_box_store(_sv0t266, 2, cur.p1);
      int _sv0t267 = sv0_box_alloc(3);
      sv0_box_store(_sv0t267, 0, rv2.tag);
      sv0_box_store(_sv0t267, 1, rv2.p0);
      sv0_box_store(_sv0t267, 2, rv2.p1);
      be.tag = 2;
      be.p0 = op_tag;
      be.p1 = _sv0t266;
      be.p2 = _sv0t267;
      ...
      sv0_box_store(_sv0t268, 0, be.tag);
      sv0_box_store(_sv0t268, 1, be.p0);
      sv0_box_store(_sv0t268, 2, be.p1);
      sv0_box_store(_sv0t268, 3, be.p2);
      st2.tag = 4;
      st2.p0 = var_tok2;
      st2.p1 = _sv0t268;
      int _sv0t269 = sv0_box_alloc(5);
      sv0_box_store(_sv0t269, 0, st2.tag);
      sv0_box_store(_sv0t269, 1, st2.p0);
      sv0_box_store(_sv0t269, 2, st2.p1);
      sv0_box_store(_sv0t269, 3, st2.p2);
      sv0_box_store(_sv0t269, 4, st2.p3);
      sv0_vec_push(out_instrs, _sv0t269);
    } else {
    }
    if ((cls2 == 1)) {
      int _sv0t270 = sv0_vec_get(aout2, 0);
      int obj_tok2 = _sv0t270;
      int _sv0t271 = sv0_vec_get(aout2, 1);
      int fld_tok2 = _sv0t271;
      Value cur2;
      Value _sv0t272;
      _sv0t272.tag = 3;
      _sv0t272.p0 = obj_tok2;
      int _sv0t273 = sv0_box_alloc(3);
      sv0_box_store(_sv0t273, 0, _sv0t272.tag);
      sv0_box_store(_sv0t273, 1, _sv0t272.p0);
      sv0_box_store(_sv0t273, 2, _sv0t272.p1);
      cur2.tag = 6;
      cur2.p0 = _sv0t273;
      cur2.p1 = fld_tok2;
      Value _sv0t274 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, rhs_idx2, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value rv2b;
      rv2b = _sv0t274;
      Expr be2;
      int _sv0t275 = sv0_box_alloc(3);
      sv0_box_store(_sv0t275, 0, cur2.tag);
      sv0_box_store(_sv0t275, 1, cur2.p0);
      sv0_box_store(_sv0t275, 2, cur2.p1);
      int _sv0t276 = sv0_box_alloc(3);
      sv0_box_store(_sv0t276, 0, rv2b.tag);
      sv0_box_store(_sv0t276, 1, rv2b.p0);
      sv0_box_store(_sv0t276, 2, rv2b.p1);
      be2.tag = 2;
      be2.p0 = op_tag;
      be2.p1 = _sv0t275;
      be2.p2 = _sv0t276;
      Instr sf2;
      int _sv0t277 = sv0_box_alloc(4);
      sv0_box_store(_sv0t277, 0, be2.tag);
      sv0_box_store(_sv0t277, 1, be2.p0);
      sv0_box_store(_sv0t277, 2, be2.p1);
      sv0_box_store(_sv0t277, 3, be2.p2);
      sf2.tag = 5;
      sf2.p0 = obj_tok2;
      sf2.p1 = fld_tok2;
      sf2.p2 = _sv0t277;
      int _sv0t278 = sv0_box_alloc(5);
      sv0_box_store(_sv0t278, 0, sf2.tag);
      sv0_box_store(_sv0t278, 1, sf2.p0);
      sv0_box_store(_sv0t278, 2, sf2.p1);
      sv0_box_store(_sv0t278, 3, sf2.p2);
      sv0_box_store(_sv0t278, 4, sf2.p3);
      sv0_vec_push(out_instrs, _sv0t278);
    } else {
    }
    Value _sv0t279;
    _sv0t279.tag = 4;
  ...
  if ((tag == 20)) {
    int _sv0t280 = sv0_vec_get(ed1, idx);
    int cast_src = _sv0t280;
    Value _sv0t281 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, cast_src, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    Value cv;
    cv = _sv0t281;
    int _sv0t282 = ctr_fresh(ctr);
    int ct2 = _sv0t282;
    int _sv0t283 = sv0_vec_get(ed4, idx);
    int ptr_cast_kind = _sv0t283;
    if ((ptr_cast_kind != 0)) {
      int _sv0t284 = sv0_vec_get(ed3, idx);
      int inner_tok = _sv0t284;
      Instr _sv0t285;
      _sv0t285.tag = 16;
      _sv0t285.p0 = inner_tok;
      _sv0t285.p1 = ptr_cast_kind;
      _sv0t285.p2 = ct2;
      int _sv0t286 = sv0_box_alloc(5);
      sv0_box_store(_sv0t286, 0, _sv0t285.tag);
      sv0_box_store(_sv0t286, 1, _sv0t285.p0);
      sv0_box_store(_sv0t286, 2, _sv0t285.p1);
      sv0_box_store(_sv0t286, 3, _sv0t285.p2);
      sv0_box_store(_sv0t286, 4, _sv0t285.p3);
      sv0_vec_push(out_instrs, _sv0t286);
      Expr store_e;
      int _sv0t287 = sv0_box_alloc(3);
      sv0_box_store(_sv0t287, 0, cv.tag);
      sv0_box_store(_sv0t287, 1, cv.p0);
      sv0_box_store(_sv0t287, 2, cv.p1);
      store_e.tag = 3;
      store_e.p0 = 99;
      store_e.p1 = _sv0t287;
      Instr _sv0t288;
      int _sv0t289 = sv0_box_alloc(4);
      sv0_box_store(_sv0t289, 0, store_e.tag);
      sv0_box_store(_sv0t289, 1, store_e.p0);
      sv0_box_store(_sv0t289, 2, store_e.p1);
      sv0_box_store(_sv0t289, 3, store_e.p2);
      _sv0t288.tag = 4;
      _sv0t288.p0 = ct2;
      _sv0t288.p1 = _sv0t289;
      int _sv0t290 = sv0_box_alloc(5);
      sv0_box_store(_sv0t290, 0, _sv0t288.tag);
      sv0_box_store(_sv0t290, 1, _sv0t288.p0);
      sv0_box_store(_sv0t290, 2, _sv0t288.p1);
      sv0_box_store(_sv0t290, 3, _sv0t288.p2);
      sv0_box_store(_sv0t290, 4, _sv0t288.p3);
      sv0_vec_push(out_instrs, _sv0t290);
      Value _sv0t291;
      _sv0t291.tag = 3;
      _sv0t291.p0 = ct2;
      return _sv0t291;
    ...
    sv0_box_store(_sv0t292, 0, cv.tag);
    sv0_box_store(_sv0t292, 1, cv.p0);
    sv0_box_store(_sv0t292, 2, cv.p1);
    cast_e.tag = 3;
    cast_e.p0 = 99;
    cast_e.p1 = _sv0t292;
    Instr cast_i;
    int _sv0t293 = sv0_box_alloc(4);
    sv0_box_store(_sv0t293, 0, cast_e.tag);
    sv0_box_store(_sv0t293, 1, cast_e.p0);
    sv0_box_store(_sv0t293, 2, cast_e.p1);
    sv0_box_store(_sv0t293, 3, cast_e.p2);
    cast_i.tag = 3;
    cast_i.p0 = ct2;
    cast_i.p1 = _sv0t293;
    int _sv0t294 = sv0_box_alloc(5);
    sv0_box_store(_sv0t294, 0, cast_i.tag);
    sv0_box_store(_sv0t294, 1, cast_i.p0);
    sv0_box_store(_sv0t294, 2, cast_i.p1);
    sv0_box_store(_sv0t294, 3, cast_i.p2);
    sv0_box_store(_sv0t294, 4, cast_i.p3);
    sv0_vec_push(out_instrs, _sv0t294);
    Value _sv0t295;
    _sv0t295.tag = 3;
    _sv0t295.p0 = ct2;
    return _sv0t295;
  ...
  if ((tag == 22)) {
    Value _sv0t296 = lower_tag_try(et, ed1, ed2, ed3, ed4, pp, tok_tags, idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    return _sv0t296;
  } else {
  }
  if ((tag == 24)) {
    int _sv0t297 = sv0_vec_get(ed1, idx);
    int pps_s = _sv0t297;
    int _sv0t298 = sv0_vec_get(ed2, idx);
    int ppc_s = _sv0t298;
    int _sv0t299 = sv0_vec_get(ed3, idx);
    int fc_s = _sv0t299;
    int _sv0t300 = sv0_vec_get(ed4, idx);
    int sf0 = _sv0t300;
    if ((ppc_s < 1)) {
      Value _sv0t301;
      _sv0t301.tag = 4;
    ...
    int _sv0t303 = (pps_s + ppc_s);
    int sty_idx = (_sv0t303 - 1);
    int _sv0t304 = sv0_vec_get(pp, sty_idx);
    int sty_tok = _sv0t304;
    int _sv0t305 = ctr_fresh(ctr);
    int t_s = _sv0t305;
    Instr decl_s;
    decl_s.tag = 2;
    decl_s.p0 = sty_tok;
    ...
    sv0_box_store(_sv0t306, 0, decl_s.tag);
    sv0_box_store(_sv0t306, 1, decl_s.p0);
    sv0_box_store(_sv0t306, 2, decl_s.p1);
    sv0_box_store(_sv0t306, 3, decl_s.p2);
    sv0_box_store(_sv0t306, 4, decl_s.p3);
    sv0_vec_push(out_instrs, _sv0t306);
    int fi_s = 0;
    while ((fi_s < fc_s)) {
      int _sv0t307 = (fi_s * 2);
      int _sv0t308 = (sf0 + _sv0t307);
      int _sv0t309 = (_sv0t308 + 1);
      int _sv0t310 = sv0_vec_get(lit_sf_names, _sv0t309);
      int ch_s = _sv0t310;
      Value _sv0t311 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, ch_s, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      Value fv_s;
      fv_s = _sv0t311;
      Expr _sv0t312 = value_to_expr(fv_s);
      Expr fe_s;
      fe_s = _sv0t312;
      int _sv0t313 = (fi_s * 2);
      int _sv0t314 = (sf0 + _sv0t313);
      int _sv0t315 = sv0_vec_get(lit_sf_names, _sv0t314);
      int fnm_s = _sv0t315;
      Instr stf_s;
      int _sv0t316 = sv0_box_alloc(4);
      sv0_box_store(_sv0t316, 0, fe_s.tag);
      sv0_box_store(_sv0t316, 1, fe_s.p0);
      sv0_box_store(_sv0t316, 2, fe_s.p1);
      sv0_box_store(_sv0t316, 3, fe_s.p2);
      stf_s.tag = 5;
      stf_s.p0 = t_s;
      stf_s.p1 = fnm_s;
      stf_s.p2 = _sv0t316;
      int _sv0t317 = sv0_box_alloc(5);
      sv0_box_store(_sv0t317, 0, stf_s.tag);
      sv0_box_store(_sv0t317, 1, stf_s.p0);
      sv0_box_store(_sv0t317, 2, stf_s.p1);
      sv0_box_store(_sv0t317, 3, stf_s.p2);
      sv0_box_store(_sv0t317, 4, stf_s.p3);
      sv0_vec_push(out_instrs, _sv0t317);
      fi_s = (fi_s + 1);
    }
    Value _sv0t318;
    _sv0t318.tag = 3;
  ...
  if ((tag == 25)) {
    int _sv0t319 = sv0_vec_get(ed2, idx);
    int elem_count = _sv0t319;
    if ((elem_count == 1)) {
      int _sv0t320 = sv0_vec_get(ed1, idx);
      int first_idx = _sv0t320;
      Value _sv0t321 = lower_expr_to_value(et, ed1, ed2, ed3, ed4, pp, tok_tags, first_idx, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
      return _sv0t321;
    } else {
    }
  } else {
  ...
  if ((tag == 23)) {
    int _sv0t322 = sv0_vec_get(ed1, idx);
    int assert_expr = _sv0t322;
    int _sv0t323 = lower_for_effect(et, ed1, ed2, ed3, ed4, pp, tok_tags, assert_expr, ctr, out_instrs, enum_names, enum_tag_offsets, enum_tag_counts, enum_tags_flat, fn_ctx, builtin_map, lit_sf_names, source, starts, ends, item_tags, item_names, item_d2, item_d3, item_d4, item_field_counts, enum_vnames_flat, enum_max_payloads, item_fn_row, match_env_inherit, import_aliases);
    Value _sv0t324;
    _sv0t324.tag = 4;
    return _sv0t324;
  } else {
