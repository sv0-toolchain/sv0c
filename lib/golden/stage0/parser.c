...
static int try_assign_stmt(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  ...
  int _sv0t7 = ps_peek(tags, op_pos);
  int nt = _sv0t7;
  if ((nt == 35)) {
    ...
    int _sv0t11 = parse_expr(tags, starts, ends, source, rhs_pos, et, ed1, ed2, ed3, ed4, pp, 1);
    int pe = _sv0t11;
    if ((pe < 0)) {
      int _sv0t12 = (0 - 1);
      return _sv0t12;
  ...
  int _sv0t18 = has_assign_binop(nt);
  if ((_sv0t18 == 1)) {
    int _sv0t19 = assign_binop(nt);
    int bop = _sv0t19;
    int _sv0t20 = sv0_vec_len(pp);
    int pps = _sv0t20;
    sv0_vec_push(pp, pos);
    sv0_vec_push(et, 1);
    sv0_vec_push(ed1, pps);
    ...
    int _sv0t23 = parse_expr(tags, starts, ends, source, rhs_pos, et, ed1, ed2, ed3, ed4, pp, 1);
    int pe = _sv0t23;
    if ((pe < 0)) {
      int _sv0t24 = (0 - 1);
      return _sv0t24;
    ...
    int _sv0t25 = sv0_vec_len(et);
    int rhs_idx = (_sv0t25 - 1);
    int _sv0t26 = ps_peek(tags, pe);
    if ((_sv0t26 != 13)) {
      int _sv0t27 = (0 - 1);
      return _sv0t27;
    } else {
...
int main(void) {
  ...
  int r62b = _sv0t123;
  int _sv0t124 = test_parse_match_pat_or();
  int r62c = _sv0t124;
  if ((r62b != 0)) {
    int _sv0t125 = (735 + r62b);
    return _sv0t125;
  } else {
  }
  if ((r62c != 0)) {
    int _sv0t126 = (736 + r62c);
    return _sv0t126;
  } else {
  }
  int _sv0t127 = test_parse_quant();
  int r63 = _sv0t127;
  if ((r63 != 0)) {
    int _sv0t128 = (740 + r63);
    return _sv0t128;
  } else {
  }
  int _sv0t129 = test_parse_old();
  int r64 = _sv0t129;
  if ((r64 != 0)) {
    int _sv0t130 = (750 + r64);
    return _sv0t130;
  } else {
  }
  int _sv0t131 = test_parse_no_alias();
  int r65 = _sv0t131;
  if ((r65 != 0)) {
    int _sv0t132 = (760 + r65);
    return _sv0t132;
  } else {
  }
  int _sv0t133 = test_parse_while_inv();
  int r66 = _sv0t133;
  if ((r66 != 0)) {
    int _sv0t134 = (770 + r66);
    return _sv0t134;
  } else {
  }
  int _sv0t135 = test_parse_fn_simple();
  int r67 = _sv0t135;
  if ((r67 != 0)) {
    int _sv0t136 = (780 + r67);
    return _sv0t136;
  } else {
  }
  int _sv0t137 = test_parse_fn_ret();
  int r68 = _sv0t137;
  if ((r68 != 0)) {
    int _sv0t138 = (790 + r68);
    return _sv0t138;
  } else {
  }
  int _sv0t139 = test_parse_struct();
  int r69 = _sv0t139;
  if ((r69 != 0)) {
    int _sv0t140 = (800 + r69);
    return _sv0t140;
  } else {
  }
  int _sv0t141 = test_parse_enum_mixed();
  int r70 = _sv0t141;
  if ((r70 != 0)) {
    int _sv0t142 = (810 + r70);
    return _sv0t142;
  } else {
  }
  int _sv0t143 = test_parse_impl();
  int r71 = _sv0t143;
  if ((r71 != 0)) {
    int _sv0t144 = (820 + r71);
    return _sv0t144;
  } else {
  }
  int _sv0t145 = test_parse_fn_contract();
  int r72 = _sv0t145;
  if ((r72 != 0)) {
    int _sv0t146 = (830 + r72);
    return _sv0t146;
  } else {
  }
  int _sv0t147 = test_parse_program();
  int r73 = _sv0t147;
  if ((r73 != 0)) {
    int _sv0t148 = (840 + r73);
    return _sv0t148;
  } else {
  }
  return 0;
