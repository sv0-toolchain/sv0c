...
static int ps_peek_extern_c_attribute(int tags, const char* source, int starts, int ends, int pos);
...
static int parse_struct_fields(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names, int out_meta);
...
static int scan_index_assign_eq(int tags, int pos);
...
static int enum_payload_root_simple_name_tok(int root, int pty_tt, int pty_td1, int pty_td2, int pp);
static int parse_enum_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int id5, int pp, int enum_variant_name_toks, int fn_ret_ty_root_by_item, int fn_contract_base_by_item, int enum_variant_payload_ty_root, int enum_variant_payload_base_by_item, int enum_variant_payload_count_by_item, int enum_variant_payload_max_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int tparam_names_out, int enum_variant_payload_count_by_variant, int enum_variant_payload_ty_name_tok);
...
static int test_parse_type_ptr_const(void);
static int test_parse_type_ptr_mut(void);
static int test_parse_type_ptr_bare_star_rejected(void);
...
static int test_parse_expr_cast_ptr_const(void);
static int test_parse_expr_cast_ptr_mut(void);
static int test_parse_expr_cast_non_ptr_unaffected(void);
static int test_parse_expr_precedence(void);
static int test_parse_expr_index(void);
static int test_parse_expr_index_range_full(void);
static int test_parse_expr_index_range_bounded(void);
static int test_parse_block_empty(void);
static int test_parse_unsafe_block_empty(void);
...
static int test_parse_extern_c_fn_decl(void);
static int test_parse_extern_c_fn_with_body_rejected(void);
static int parser_scan_case(int spec_tags, int expect);
static int test_scan_index_assign_places(void);
...
static int ps_peek_extern_c_attribute(int tags, const char* source, int starts, int ends, int pos) {
  ...
  int _sv0t8 = (pos + 2);
  int _sv0t9 = sv0_vec_get(starts, _sv0t8);
  int s = _sv0t9;
  int _sv0t10 = (pos + 2);
  int _sv0t11 = sv0_vec_get(ends, _sv0t10);
  int e = _sv0t11;
  int _sv0t12 = (e - s);
  const char* _sv0t13 = sv0_string_substr(source, s, _sv0t12);
  const char* nm;
  nm = _sv0t13;
  int _sv0t14 = sv0_string_eq(nm, "extern_c");
  if ((!_sv0t14)) {
    int _sv0t15 = (0 - 1);
    return _sv0t15;
  } else {
...
static int parse_type(int tags, int starts, int ends, const char* source, int pos, int ty_tags, int ty_data1, int ty_data2, int ty_data3, int path_pool) {
  ...
  if ((t == 24)) {
    int p1 = (pos + 1);
    int _sv0t22 = ps_peek(tags, p1);
    if ((_sv0t22 == 58)) {
      int _sv0t23 = (p1 + 1);
      int _sv0t24 = parse_type(tags, starts, ends, source, _sv0t23, ty_tags, ty_data1, ty_data2, ty_data3, path_pool);
      int p2 = _sv0t24;
      if ((p2 < 0)) {
        int _sv0t25 = (0 - 1);
        return _sv0t25;
      ...
      int _sv0t26 = sv0_vec_len(ty_tags);
      int inner = (_sv0t26 - 1);
      sv0_vec_push(ty_tags, 8);
      sv0_vec_push(ty_data1, inner);
      sv0_vec_push(ty_data2, 0);
      sv0_vec_push(ty_data3, 0);
      return p2;
    ...
    int _sv0t27 = ps_peek(tags, p1);
    if ((_sv0t27 == 77)) {
      int _sv0t28 = (p1 + 1);
      int _sv0t29 = parse_type(tags, starts, ends, source, _sv0t28, ty_tags, ty_data1, ty_data2, ty_data3, path_pool);
      int p2 = _sv0t29;
      if ((p2 < 0)) {
        int _sv0t30 = (0 - 1);
        return _sv0t30;
      ...
      int _sv0t31 = sv0_vec_len(ty_tags);
      int inner = (_sv0t31 - 1);
      sv0_vec_push(ty_tags, 9);
      sv0_vec_push(ty_data1, inner);
      sv0_vec_push(ty_data2, 0);
      sv0_vec_push(ty_data3, 0);
      return p2;
  ...
  if ((t == 10)) {
    int p1 = (pos + 1);
    int _sv0t33 = parse_type(tags, starts, ends, source, p1, ty_tags, ty_data1, ty_data2, ty_data3, path_pool);
    int p2 = _sv0t33;
    if ((p2 < 0)) {
      int _sv0t34 = (0 - 1);
      return _sv0t34;
    ...
    int _sv0t35 = sv0_vec_len(ty_tags);
    int elem = (_sv0t35 - 1);
    int _sv0t36 = ps_peek(tags, p2);
    if ((_sv0t36 == 13)) {
      int p3 = (p2 + 1);
      int len_kind = 0;
      int _sv0t37 = ps_peek(tags, p3);
      if ((_sv0t37 != 0)) {
        int _sv0t38 = ps_peek(tags, p3);
        if ((_sv0t38 != 5)) {
          int _sv0t39 = (0 - 1);
          return _sv0t39;
        } else {
      ...
      sv0_vec_push(ty_data3, len_kind);
      int _sv0t42 = (p4 + 1);
      return _sv0t42;
    } else {
    }
    int _sv0t43 = ps_peek(tags, p2);
    if ((_sv0t43 == 11)) {
  ...
  if ((t == 87)) {
    int p1 = (pos + 1);
    int _sv0t46 = ps_peek(tags, p1);
    if ((_sv0t46 == 15)) {
      int _sv0t47 = (p1 + 1);
      int _sv0t48 = ps_peek(tags, _sv0t47);
      if ((_sv0t48 == 5)) {
        int _sv0t49 = sv0_vec_len(path_pool);
        int path_start = _sv0t49;
        sv0_vec_push(path_pool, pos);
        int _sv0t50 = (p1 + 1);
        sv0_vec_push(path_pool, _sv0t50);
        int p2 = (p1 + 2);
        int _sv0t51 = ps_peek(tags, p2);
        if ((_sv0t51 == 38)) {
          int _sv0t52 = ps_skip_generic_params(tags, p2);
          p2 = _sv0t52;
        } else {
        }
    ...
    int _sv0t53 = sv0_vec_len(path_pool);
    int path_start = _sv0t53;
    sv0_vec_push(path_pool, pos);
    sv0_vec_push(ty_tags, 0);
    sv0_vec_push(ty_data1, path_start);
  ...
  if ((t == 5)) {
    int _sv0t54 = is_builtin_type_name(source, starts, ends, pos);
    if (_sv0t54) {
      int _sv0t55 = sv0_vec_len(path_pool);
      int path_start = _sv0t55;
      sv0_vec_push(path_pool, pos);
      sv0_vec_push(ty_tags, 0);
      sv0_vec_push(ty_data1, path_start);
      sv0_vec_push(ty_data2, 1);
    ...
    int _sv0t57 = sv0_vec_len(path_pool);
    int path_start = _sv0t57;
    int _sv0t58 = parse_path(tags, pos, path_pool);
    int p1 = _sv0t58;
    if ((p1 < 0)) {
      int _sv0t59 = (0 - 1);
      return _sv0t59;
    ...
    int _sv0t60 = sv0_vec_len(path_pool);
    int seg_count = (_sv0t60 - path_start);
    int _sv0t61 = ps_peek(tags, p1);
    if ((_sv0t61 == 38)) {
      int p = (p1 + 1);
      int arg_count = 0;
      int _sv0t62 = ps_peek(tags, p);
      if ((_sv0t62 == 39)) {
        sv0_vec_push(ty_tags, 0);
        sv0_vec_push(ty_data1, path_start);
      ...
      int done = 0;
      while ((done != 1)) {
        int _sv0t64 = ps_peek(tags, p);
        if ((_sv0t64 == 39)) {
          done = 1;
        } else {
          int _sv0t65 = parse_type(tags, starts, ends, source, p, ty_tags, ty_data1, ty_data2, ty_data3, path_pool);
          int p2 = _sv0t65;
          if ((p2 < 0)) {
            int _sv0t66 = (0 - 1);
            return _sv0t66;
          ...
          int _sv0t67 = ps_peek(tags, p2);
          if ((_sv0t67 == 12)) {
            p = (p2 + 1);
          } else {
            int _sv0t68 = ps_peek(tags, p2);
            if ((_sv0t68 == 39)) {
              p = p2;
            } else {
              int _sv0t69 = (0 - 1);
...
static int parse_pat_atom(int tags, int starts, int ends, const char* source, int pos, int pat_tags, int pat_data1, int pat_data2, int pat_data3, int path_pool) {
  ...
  if ((t == 5)) {
    ...
    int _sv0t17 = ps_peek(tags, _sv0t16);
    if ((_sv0t17 == 8)) {
      int _sv0t18 = sv0_vec_len(path_pool);
      int sp_start = _sv0t18;
      int _sv0t19 = parse_path(tags, pos, path_pool);
      int sp1 = _sv0t19;
      if ((sp1 < 0)) {
        int _sv0t20 = (0 - 1);
        return _sv0t20;
      ...
      int _sv0t21 = sv0_vec_len(path_pool);
      int sp_count = (_sv0t21 - sp_start);
      int _sv0t22 = path_pattern_from(tags, starts, ends, source, sp1, pat_tags, pat_data1, pat_data2, pat_data3, path_pool, sp_start, sp_count);
      return _sv0t22;
    } else {
    }
    sv0_vec_push(pat_tags, 1);
  ...
  if ((t == 23)) {
    int _sv0t24 = (pos + 1);
    int _sv0t25 = ps_peek(tags, _sv0t24);
    int nt = _sv0t25;
    if ((nt == 0)) {
      sv0_vec_push(pat_tags, 2);
      sv0_vec_push(pat_data1, 0);
      int _sv0t26 = (pos + 1);
      sv0_vec_push(pat_data2, _sv0t26);
    ...
    if ((nt == 1)) {
      ...
      int _sv0t28 = (pos + 1);
      sv0_vec_push(pat_data2, _sv0t28);
      sv0_vec_push(pat_data3, 1);
      int _sv0t29 = (pos + 2);
      return _sv0t29;
    } else {
  ...
  if ((t == 6)) {
    ...
    int _sv0t35 = sv0_vec_len(pat_tags);
    int first_idx = _sv0t35;
    int _sv0t36 = parse_pat(tags, starts, ends, source, p1, pat_tags, pat_data1, pat_data2, pat_data3, path_pool);
    int p2 = _sv0t36;
    if ((p2 < 0)) {
      int _sv0t37 = (0 - 1);
      return _sv0t37;
    ...
    int _sv0t38 = ps_peek(tags, p2);
    if ((_sv0t38 == 7)) {
      int _sv0t39 = (p2 + 1);
      return _sv0t39;
    } else {
    }
    int _sv0t40 = ps_peek(tags, p2);
    if ((_sv0t40 == 12)) {
      int p = (p2 + 1);
      int count = 1;
      int done = 0;
      while ((done != 1)) {
        int _sv0t41 = ps_peek(tags, p);
        if ((_sv0t41 == 7)) {
          sv0_vec_push(pat_tags, 3);
        ...
        int _sv0t43 = parse_pat(tags, starts, ends, source, p, pat_tags, pat_data1, pat_data2, pat_data3, path_pool);
        int pn = _sv0t43;
        if ((pn < 0)) {
          int _sv0t44 = (0 - 1);
          return _sv0t44;
        ...
        count = (count + 1);
        p = pn;
        int _sv0t45 = ps_peek(tags, p);
        if ((_sv0t45 == 12)) {
          p = (p + 1);
        } else {
          int _sv0t46 = ps_peek(tags, p);
          if ((_sv0t46 != 7)) {
            int _sv0t47 = (0 - 1);
            return _sv0t47;
          } else {
...
static int parse_struct_fields(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names, int out_meta) {
        ...
        if ((t == 17)) {
          ...
          if ((t == 5)) {
            ...
            if ((nt == 14)) {
              ...
              sv0_vec_push(vals, _sv0t21);
              p = pv;
            } else {
              int nm = p;
              int _sv0t22 = sv0_vec_len(pp);
              int pps = _sv0t22;
              sv0_vec_push(pp, p);
              sv0_vec_push(et, 1);
  ...
  int _sv0t28 = sv0_vec_len(sf_names);
  int sf_start = _sv0t28;
  int _sv0t29 = sv0_vec_len(names);
  int fc = _sv0t29;
  int fi = 0;
  while ((fi < fc)) {
    int _sv0t30 = sv0_vec_get(names, fi);
    sv0_vec_push(sf_names, _sv0t30);
    int _sv0t31 = sv0_vec_get(vals, fi);
    sv0_vec_push(sf_names, _sv0t31);
    fi = (fi + 1);
  }
  sv0_vec_push(out_meta, sf_start);
  sv0_vec_push(out_meta, fc);
  return p;
}
...
static int parse_primary_expr(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names, int allow_struct) {
  ...
  if ((t == 5)) {
    int _sv0t8 = sv0_vec_len(pp);
    int pps = _sv0t8;
    int _sv0t9 = parse_path(tags, pos, pp);
    int p1 = _sv0t9;
    if ((p1 < 0)) {
      int _sv0t10 = (0 - 1);
      return _sv0t10;
    ...
    int _sv0t11 = sv0_vec_len(pp);
    int ppc = (_sv0t11 - pps);
    if ((allow_struct == 1)) {
      int _sv0t12 = ps_peek(tags, p1);
      if ((_sv0t12 == 8)) {
        int _sv0t13 = sv0_vec_new();
        int meta = _sv0t13;
        int _sv0t14 = (p1 + 1);
        int _sv0t15 = parse_struct_fields(tags, starts, ends, source, _sv0t14, et, ed1, ed2, ed3, ed4, pp, sf_names, meta);
        int pf = _sv0t15;
        if ((pf < 0)) {
          int _sv0t16 = (0 - 1);
          return _sv0t16;
        ...
        int _sv0t17 = sv0_vec_get(meta, 0);
        int sf_start = _sv0t17;
        int _sv0t18 = sv0_vec_get(meta, 1);
        int fc = _sv0t18;
        sv0_vec_push(et, 24);
        sv0_vec_push(ed1, pps);
        sv0_vec_push(ed2, ppc);
        sv0_vec_push(ed3, fc);
        sv0_vec_push(ed4, sf_start);
        return pf;
      } else {
      }
    } else {
  ...
  if ((t == 6)) {
    int _sv0t19 = (pos + 1);
    int _sv0t20 = ps_peek(tags, _sv0t19);
    int nt = _sv0t20;
    if ((nt == 7)) {
      sv0_vec_push(et, 0);
      sv0_vec_push(ed1, 5);
    ...
    int _sv0t22 = (pos + 1);
    int _sv0t23 = parse_expr_sf(tags, starts, ends, source, _sv0t22, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int p1 = _sv0t23;
    if ((p1 < 0)) {
      int _sv0t24 = (0 - 1);
      return _sv0t24;
    ...
    if ((_sv0t27 == 12)) {
      ...
      while ((td != 1)) {
        ...
        int _sv0t31 = parse_expr_sf(tags, starts, ends, source, p, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
        int pa = _sv0t31;
        if ((pa < 0)) {
          int _sv0t32 = (0 - 1);
          return _sv0t32;
  ...
  if ((t == 10)) {
    int _sv0t38 = (pos + 1);
    int _sv0t39 = ps_peek(tags, _sv0t38);
    if ((_sv0t39 == 11)) {
      sv0_vec_push(et, 26);
      sv0_vec_push(ed1, 0);
      sv0_vec_push(ed2, 0);
    ...
    int _sv0t41 = sv0_vec_len(et);
    int first_idx = _sv0t41;
    int _sv0t42 = (pos + 1);
    ...
    int _sv0t45 = ps_peek(tags, p1);
    if ((_sv0t45 == 13)) {
      int _sv0t46 = (p1 + 1);
      int _sv0t47 = parse_expr_sf(tags, starts, ends, source, _sv0t46, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
      int p2 = _sv0t47;
      if ((p2 < 0)) {
        int _sv0t48 = (0 - 1);
        return _sv0t48;
    ...
    if ((_sv0t54 == 12)) {
      ...
      while ((ad != 1)) {
        ...
        int _sv0t57 = parse_expr_sf(tags, starts, ends, source, p, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
        int pa = _sv0t57;
        if ((pa < 0)) {
          int _sv0t58 = (0 - 1);
          return _sv0t58;
        ...
        count = (count + 1);
        p = pa;
        int _sv0t59 = ps_peek(tags, p);
        if ((_sv0t59 == 12)) {
          p = (p + 1);
        } else {
          int _sv0t60 = ps_peek(tags, p);
          if ((_sv0t60 == 11)) {
            sv0_vec_push(et, 26);
            sv0_vec_push(ed1, first_idx);
            sv0_vec_push(ed2, count);
  ...
  if ((t == 8)) {
    int _sv0t64 = parse_block(tags, starts, ends, source, pos, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t64;
  } else {
  }
  if ((t == 68)) {
    int _sv0t65 = (pos + 1);
    int _sv0t66 = parse_if_expr(tags, starts, ends, source, _sv0t65, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t66;
  } else {
  }
  if ((t == 96)) {
    int _sv0t67 = (pos + 1);
    int _sv0t68 = parse_while_expr(tags, starts, ends, source, _sv0t67, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t68;
  } else {
  }
  if ((t == 66)) {
    int _sv0t69 = (pos + 1);
    int _sv0t70 = parse_for_expr(tags, starts, ends, source, _sv0t69, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t70;
  } else {
  }
  if ((t == 72)) {
    int _sv0t71 = (pos + 1);
    int _sv0t72 = parse_loop_expr(tags, starts, ends, source, _sv0t71, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t72;
  } else {
  }
  if ((t == 85)) {
    int _sv0t73 = (pos + 1);
    int _sv0t74 = parse_return_expr(tags, starts, ends, source, _sv0t73, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t74;
  } else {
  }
  if ((t == 93)) {
    int _sv0t75 = (pos + 1);
    int _sv0t76 = parse_block(tags, starts, ends, source, _sv0t75, et, ed1, ed2, ed3, ed4, pp, sf_names);
    int pb = _sv0t76;
    if ((pb < 0)) {
      int _sv0t77 = (0 - 1);
      return _sv0t77;
    ...
    int _sv0t78 = sv0_vec_len(et);
    int block_idx = (_sv0t78 - 1);
    sv0_vec_push(et, 34);
    sv0_vec_push(ed1, block_idx);
    sv0_vec_push(ed2, 0);
    sv0_vec_push(ed3, 0);
    sv0_vec_push(ed4, 0);
    return pb;
  ...
  if ((t == 55)) {
    int _sv0t79 = (pos + 1);
    int _sv0t80 = parse_expr_sf(tags, starts, ends, source, _sv0t79, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int pa = _sv0t80;
    if ((pa < 0)) {
      int _sv0t81 = (0 - 1);
      return _sv0t81;
  ...
  if ((t == 74)) {
    int _sv0t83 = (pos + 1);
    int _sv0t84 = parse_match_expr(tags, starts, ends, source, _sv0t83, et, ed1, ed2, ed3, ed4, pp, sf_names);
    return _sv0t84;
  } else {
  }
  if ((t == 67)) {
    int _sv0t85 = parse_quant(tags, starts, ends, source, pos, 1, et, ed1, ed2, ed3, ed4, pp);
    return _sv0t85;
  } else {
  }
  if ((t == 63)) {
    int _sv0t86 = parse_quant(tags, starts, ends, source, pos, 0, et, ed1, ed2, ed3, ed4, pp);
    return _sv0t86;
  } else {
  }
  if ((t == 80)) {
    int _sv0t87 = (pos + 1);
    int _sv0t88 = ps_peek(tags, _sv0t87);
    if ((_sv0t88 != 6)) {
      int _sv0t89 = (0 - 1);
      return _sv0t89;
    } else {
    }
    int _sv0t90 = sv0_vec_len(et);
    int first_idx = _sv0t90;
    int _sv0t91 = (pos + 2);
    int _sv0t92 = parse_expr_sf(tags, starts, ends, source, _sv0t91, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int pe = _sv0t92;
    if ((pe < 0)) {
      int _sv0t93 = (0 - 1);
      return _sv0t93;
    ...
    int _sv0t94 = ps_peek(tags, pe);
    if ((_sv0t94 != 7)) {
      int _sv0t95 = (0 - 1);
      return _sv0t95;
    } else {
    }
    int _sv0t96 = sv0_vec_len(pp);
    int pps = _sv0t96;
    sv0_vec_push(pp, pos);
    sv0_vec_push(et, 1);
    sv0_vec_push(ed1, pps);
    ...
    sv0_vec_push(ed3, 0);
    sv0_vec_push(ed4, 0);
    int _sv0t97 = sv0_vec_len(et);
    int callee_idx = (_sv0t97 - 1);
    sv0_vec_push(et, 4);
  ...
  if ((t == 79)) {
    int _sv0t99 = (pos + 1);
    int _sv0t100 = ps_peek(tags, _sv0t99);
    if ((_sv0t100 != 6)) {
      int _sv0t101 = (0 - 1);
      return _sv0t101;
    } else {
    }
    int _sv0t102 = sv0_vec_len(et);
    int first_idx = _sv0t102;
    int _sv0t103 = (pos + 2);
    int _sv0t104 = parse_expr_sf(tags, starts, ends, source, _sv0t103, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int pa = _sv0t104;
    if ((pa < 0)) {
      int _sv0t105 = (0 - 1);
      return _sv0t105;
    ...
    int _sv0t108 = (pa + 1);
    int _sv0t109 = parse_expr_sf(tags, starts, ends, source, _sv0t108, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int pb = _sv0t109;
    if ((pb < 0)) {
      int _sv0t110 = (0 - 1);
      return _sv0t110;
    ...
    int _sv0t111 = ps_peek(tags, pb);
    if ((_sv0t111 != 7)) {
      int _sv0t112 = (0 - 1);
      return _sv0t112;
    } else {
    }
    int _sv0t113 = sv0_vec_len(pp);
    int pps = _sv0t113;
    sv0_vec_push(pp, pos);
    sv0_vec_push(et, 1);
    sv0_vec_push(ed1, pps);
    ...
    sv0_vec_push(ed3, 0);
    sv0_vec_push(ed4, 0);
    int _sv0t114 = sv0_vec_len(et);
    int callee_idx = (_sv0t114 - 1);
    sv0_vec_push(et, 4);
    sv0_vec_push(ed1, callee_idx);
    sv0_vec_push(ed2, first_idx);
    sv0_vec_push(ed3, 2);
    ...
    if ((t == 6)) {
      ...
      if ((t == 16)) {
        ...
        if ((t == 10)) {
          ...
          if ((a1 == 17)) {
            int _sv0t33 = (p + 2);
            int _sv0t34 = ps_peek(tags, _sv0t33);
            if ((_sv0t34 == 11)) {
              sv0_vec_push(et, 21);
              int _sv0t35 = (0 - 1);
              sv0_vec_push(ed1, _sv0t35);
              int _sv0t36 = (0 - 1);
              sv0_vec_push(ed2, _sv0t36);
              sv0_vec_push(ed3, 0);
              sv0_vec_push(ed4, 0);
              int _sv0t37 = sv0_vec_len(et);
              int rng_idx = (_sv0t37 - 1);
              sv0_vec_push(et, 8);
              sv0_vec_push(ed1, cur);
              sv0_vec_push(ed2, rng_idx);
              sv0_vec_push(ed3, 0);
              sv0_vec_push(ed4, 0);
              ...
              int _sv0t39 = (p + 2);
              int _sv0t40 = parse_expr_sf(tags, starts, ends, source, _sv0t39, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
              int hp = _sv0t40;
              if ((hp < 0)) {
                int _sv0t41 = (0 - 1);
                return _sv0t41;
              ...
              int _sv0t42 = sv0_vec_len(et);
              int hi_idx = (_sv0t42 - 1);
              int _sv0t43 = ps_peek(tags, hp);
              if ((_sv0t43 != 11)) {
                int _sv0t44 = (0 - 1);
                return _sv0t44;
              } else {
              ...
              sv0_vec_push(et, 21);
              int _sv0t45 = (0 - 1);
              sv0_vec_push(ed1, _sv0t45);
              sv0_vec_push(ed2, hi_idx);
              sv0_vec_push(ed3, 0);
              sv0_vec_push(ed4, 0);
              int _sv0t46 = sv0_vec_len(et);
              int rng_idx = (_sv0t46 - 1);
              sv0_vec_push(et, 8);
              sv0_vec_push(ed1, cur);
              sv0_vec_push(ed2, rng_idx);
              sv0_vec_push(ed3, 0);
              sv0_vec_push(ed4, 0);
              int _sv0t47 = sv0_vec_len(et);
              cur = (_sv0t47 - 1);
              p = (hp + 1);
            }
          } else {
            ...
            int bd3 = _sv0t51;
            int _sv0t52 = (p + 1);
            int _sv0t53 = parse_or_expr(tags, starts, ends, source, _sv0t52, et, ed1, ed2, ed3, ed4, pp, sf_names, bt, bd1, bd2, bd3, 1);
            int fp = _sv0t53;
            if ((fp < 0)) {
              int _sv0t54 = (0 - 1);
              return _sv0t54;
            ...
            int _sv0t55 = sv0_vec_len(et);
            int first_idx = (_sv0t55 - 1);
            int _sv0t56 = ps_peek(tags, fp);
            int nt = _sv0t56;
            if ((nt == 11)) {
              sv0_vec_push(et, 8);
              sv0_vec_push(ed1, cur);
              ...
              int _sv0t59 = (fp + 1);
              int _sv0t60 = ps_peek(tags, _sv0t59);
              if ((_sv0t60 == 11)) {
                sv0_vec_push(et, 21);
                sv0_vec_push(ed1, first_idx);
                int _sv0t61 = (0 - 1);
                sv0_vec_push(ed2, _sv0t61);
                sv0_vec_push(ed3, 0);
                sv0_vec_push(ed4, 0);
                int _sv0t62 = sv0_vec_len(et);
                int rng_idx2 = (_sv0t62 - 1);
                sv0_vec_push(et, 8);
                sv0_vec_push(ed1, cur);
                sv0_vec_push(ed2, rng_idx2);
                sv0_vec_push(ed3, 0);
                sv0_vec_push(ed4, 0);
                int _sv0t63 = sv0_vec_len(et);
                cur = (_sv0t63 - 1);
                p = (fp + 2);
              } else {
                int _sv0t64 = (fp + 1);
                int _sv0t65 = parse_expr_sf(tags, starts, ends, source, _sv0t64, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
                int hp2 = _sv0t65;
                if ((hp2 < 0)) {
                  int _sv0t66 = (0 - 1);
                  return _sv0t66;
                ...
                int _sv0t67 = sv0_vec_len(et);
                int hi_idx2 = (_sv0t67 - 1);
                int _sv0t68 = ps_peek(tags, hp2);
                if ((_sv0t68 != 11)) {
                  int _sv0t69 = (0 - 1);
                  return _sv0t69;
                } else {
                ...
                sv0_vec_push(et, 21);
                sv0_vec_push(ed1, first_idx);
                sv0_vec_push(ed2, hi_idx2);
                sv0_vec_push(ed3, 0);
                sv0_vec_push(ed4, 0);
                int _sv0t70 = sv0_vec_len(et);
                int rng_idx3 = (_sv0t70 - 1);
                sv0_vec_push(et, 8);
                sv0_vec_push(ed1, cur);
                sv0_vec_push(ed2, rng_idx3);
                sv0_vec_push(ed3, 0);
                sv0_vec_push(ed4, 0);
                int _sv0t71 = sv0_vec_len(et);
                cur = (_sv0t71 - 1);
                p = (hp2 + 1);
              }
            }
...
static int scan_index_assign_eq(int tags, int pos) {
  ...
  if (last_index) {
    int _sv0t9 = ps_peek(tags, k);
    int _sv0t10 = is_assign_tok(_sv0t9);
    if (_sv0t10) {
      return k;
    } else {
    }
  ...
  if ((saw_index != 1)) {
    if ((nfields >= 2)) {
      int _sv0t11 = ps_peek(tags, k);
      int _sv0t12 = is_assign_tok(_sv0t11);
      if (_sv0t12) {
        return k;
      } else {
      }
...
static int try_assign_stmt(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  int _sv0t0 = scan_index_assign_eq(tags, pos);
  if ((_sv0t0 >= 0)) {
    int _sv0t1 = parse_postfix_expr(tags, starts, ends, source, pos, et, ed1, ed2, ed3, ed4, pp, sf_names, 0);
    int lp = _sv0t1;
    if ((lp < 0)) {
      int _sv0t2 = (0 - 1);
      return _sv0t2;
    ...
    int lhs_i = (_sv0t3 - 1);
    int place_ok = 0;
    int _sv0t4 = sv0_vec_get(et, lhs_i);
    if ((_sv0t4 == 8)) {
      int _sv0t5 = sv0_vec_get(ed2, lhs_i);
      int _sv0t6 = sv0_vec_get(et, _sv0t5);
      if ((_sv0t6 != 21)) {
        place_ok = 1;
      } else {
      }
    ...
    int _sv0t7 = sv0_vec_get(et, lhs_i);
    if ((_sv0t7 == 6)) {
      place_ok = 1;
    } else {
    }
    if (place_ok) {
      int _sv0t8 = ps_peek(tags, lp);
      int aop = _sv0t8;
      int _sv0t9 = is_assign_tok(aop);
      if (_sv0t9) {
        int _sv0t10 = (lp + 1);
        int _sv0t11 = parse_expr_sf(tags, starts, ends, source, _sv0t10, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
        int per = _sv0t11;
        if ((per < 0)) {
          int _sv0t12 = (0 - 1);
          return _sv0t12;
        ...
        if ((aop == 35)) {
          sv0_vec_push(et, 18);
          sv0_vec_push(ed1, lhs_i);
          sv0_vec_push(ed2, rhs_i);
          sv0_vec_push(ed3, 0);
          sv0_vec_push(ed4, 0);
        } else {
          sv0_vec_push(et, 19);
          int _sv0t16 = assign_binop(aop);
          sv0_vec_push(ed1, _sv0t16);
          sv0_vec_push(ed2, lhs_i);
          sv0_vec_push(ed3, rhs_i);
          sv0_vec_push(ed4, 0);
        }
        int _sv0t17 = sv0_vec_len(et);
        int aidx = (_sv0t17 - 1);
        sv0_vec_push(et, 28);
        sv0_vec_push(ed1, aidx);
        sv0_vec_push(ed2, 0);
        sv0_vec_push(ed3, 0);
        sv0_vec_push(ed4, 0);
        int _sv0t18 = (per + 1);
  ...
  int tmp = _sv0t20;
  int _sv0t21 = parse_assign_target_op_pos(tags, pos, tmp);
  int op_pos = _sv0t21;
  if ((op_pos < 0)) {
    return op_pos;
  } else {
  }
  int _sv0t22 = sv0_vec_get(tmp, 0);
  int lhs_field_tok = _sv0t22;
  int rhs_pos = (op_pos + 1);
  int _sv0t23 = ps_peek(tags, op_pos);
  int nt = _sv0t23;
  if ((nt == 35)) {
    int _sv0t24 = sv0_vec_len(pp);
    int pps = _sv0t24;
    sv0_vec_push(pp, pos);
    sv0_vec_push(et, 1);
    sv0_vec_push(ed1, pps);
    ...
    int _sv0t27 = parse_expr_sf(tags, starts, ends, source, rhs_pos, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int pe = _sv0t27;
    if ((pe < 0)) {
      int _sv0t28 = (0 - 1);
      return _sv0t28;
    ...
    int _sv0t29 = sv0_vec_len(et);
    int rhs_idx = (_sv0t29 - 1);
    int _sv0t30 = ps_peek(tags, pe);
    if ((_sv0t30 != 13)) {
      int _sv0t31 = (0 - 1);
      return _sv0t31;
    } else {
  ...
  int _sv0t34 = has_assign_binop(nt);
  if ((_sv0t34 == 1)) {
    int _sv0t35 = assign_binop(nt);
    int bop = _sv0t35;
    int _sv0t36 = sv0_vec_len(pp);
    int pps = _sv0t36;
    sv0_vec_push(pp, pos);
    sv0_vec_push(et, 1);
    sv0_vec_push(ed1, pps);
    ...
    int _sv0t39 = parse_expr_sf(tags, starts, ends, source, rhs_pos, et, ed1, ed2, ed3, ed4, pp, sf_names, 1);
    int pe = _sv0t39;
    if ((pe < 0)) {
      int _sv0t40 = (0 - 1);
      return _sv0t40;
    ...
    int _sv0t41 = sv0_vec_len(et);
    int rhs_idx = (_sv0t41 - 1);
    int _sv0t42 = ps_peek(tags, pe);
    if ((_sv0t42 != 13)) {
      int _sv0t43 = (0 - 1);
      return _sv0t43;
    } else {
...
static int parse_param(int tags, int starts, int ends, const char* source, int pos, int pp, int fn_param_name_toks, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int fn_param_ty_root) {
  ...
  int _sv0t5 = (p + 1);
  int _sv0t6 = parse_type(tags, starts, ends, source, _sv0t5, pty_tt, pty_td1, pty_td2, pty_td3, pp);
  int pt = _sv0t6;
  if ((pt < 0)) {
    int _sv0t7 = (0 - 1);
    return _sv0t7;
  ...
  int _sv0t8 = sv0_vec_len(pty_tt);
  int _sv0t9 = (_sv0t8 - 1);
  sv0_vec_push(fn_param_ty_root, _sv0t9);
  return pt;
}
...
static int parse_fn_body(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int id5, int pp, int fn_param_name_toks, int fn_param_ty_root, int fn_ret_ty_root_by_item, int fn_contract_base_by_item, int fn_contract_root, int enum_variant_payload_base_by_item, int enum_variant_payload_count_by_item, int enum_variant_payload_max_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  int p6 = p5;
  int body_root = (0 - 1);
  int _sv0t30 = ps_peek(tags, p5);
  if ((_sv0t30 == 13)) {
    p6 = (p5 + 1);
  } else {
    int _sv0t31 = parse_block(tags, starts, ends, source, p5, body_et, body_ed1, body_ed2, body_ed3, body_ed4, pp, body_sf);
    int pb = _sv0t31;
    if ((pb < 0)) {
      int _sv0t32 = (0 - 1);
      return _sv0t32;
    ...
    p6 = pb;
    int _sv0t33 = sv0_vec_len(body_et);
    body_root = (_sv0t33 - 1);
  }
  sv0_vec_push(it, 0);
  sv0_vec_push(id1, name_pos);
  int _sv0t34 = (contract_count * 2);
  int _sv0t35 = (has_ret + _sv0t34);
  sv0_vec_push(id2, _sv0t35);
  ...
  int _sv0t36 = (0 - 1);
  sv0_vec_push(enum_variant_payload_base_by_item, _sv0t36);
...
static int enum_payload_root_simple_name_tok(int root, int pty_tt, int pty_td1, int pty_td2, int pp) {
  int _sv0t0 = sv0_vec_get(pty_tt, root);
  if ((_sv0t0 != 0)) {
    int _sv0t1 = (0 - 1);
    return _sv0t1;
  } else {
  }
  int _sv0t2 = sv0_vec_get(pty_td2, root);
  if ((_sv0t2 != 1)) {
    int _sv0t3 = (0 - 1);
    return _sv0t3;
  } else {
  }
  int _sv0t4 = sv0_vec_get(pty_td1, root);
...
static int parse_enum_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int id5, int pp, int enum_variant_name_toks, int fn_ret_ty_root_by_item, int fn_contract_base_by_item, int enum_variant_payload_ty_root, int enum_variant_payload_base_by_item, int enum_variant_payload_count_by_item, int enum_variant_payload_max_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int tparam_names_out, int enum_variant_payload_count_by_variant, int enum_variant_payload_ty_name_tok) {
  ...
  int gpi = 0;
  while (1) {
    int _sv0t8 = sv0_vec_len(gp);
    int _sv0t10 = (gpi < _sv0t8);
    if ((!_sv0t10)) {
      break;
    } else {
    }
    int _sv0t9 = sv0_vec_get(gp, gpi);
    sv0_vec_push(tparam_names_out, _sv0t9);
    gpi = (gpi + 1);
  }
  int _sv0t11 = ps_peek(tags, p1);
  if ((_sv0t11 != 8)) {
    int _sv0t12 = (0 - 1);
    return _sv0t12;
  } else {
  ...
  int p = (p1 + 1);
  int variant_count = 0;
  int _sv0t13 = sv0_vec_len(enum_variant_name_toks);
  int ev_base = _sv0t13;
  int _sv0t14 = sv0_vec_len(enum_variant_payload_ty_root);
  int payload_base = _sv0t14;
  int payload_count = 0;
  int payload_max = 0;
  int done = 0;
  while ((done != 1)) {
    int _sv0t15 = ps_peek(tags, p);
    if ((_sv0t15 == 9)) {
      done = 1;
    } else {
      ...
      int pc_before = payload_count;
      int vp = (p + 1);
      int _sv0t18 = ps_peek(tags, vp);
      if ((_sv0t18 == 6)) {
        int tp = (vp + 1);
        int _sv0t19 = ps_peek(tags, tp);
        if ((_sv0t19 == 7)) {
          tp = (tp + 1);
        } else {
          int td = 0;
          while ((td != 1)) {
            int _sv0t20 = parse_type(tags, starts, ends, source, tp, pty_tt, pty_td1, pty_td2, pty_td3, pp);
            int pt = _sv0t20;
            if ((pt < 0)) {
              int _sv0t21 = (0 - 1);
              return _sv0t21;
            ...
            int _sv0t22 = sv0_vec_len(pty_tt);
            int _sv0t23 = (_sv0t22 - 1);
            sv0_vec_push(enum_variant_payload_ty_root, _sv0t23);
            int _sv0t24 = sv0_vec_len(pty_tt);
            int _sv0t25 = (_sv0t24 - 1);
            int _sv0t26 = enum_payload_root_simple_name_tok(_sv0t25, pty_tt, pty_td1, pty_td2, pp);
            sv0_vec_push(enum_variant_payload_ty_name_tok, _sv0t26);
            payload_count = (payload_count + 1);
            int _sv0t27 = ps_peek(tags, pt);
            if ((_sv0t27 == 12)) {
              tp = (pt + 1);
            } else {
              int _sv0t28 = ps_peek(tags, pt);
              if ((_sv0t28 == 7)) {
                tp = (pt + 1);
                td = 1;
              } else {
        ...
        int vpc = (payload_count - pc_before);
        if ((vpc > payload_max)) {
          payload_max = vpc;
        } else {
        }
        sv0_vec_push(enum_variant_payload_count_by_variant, vpc);
        variant_count = (variant_count + 1);
        int _sv0t30 = ps_peek(tags, tp);
        if ((_sv0t30 == 12)) {
          p = (tp + 1);
        } else {
          int _sv0t31 = ps_peek(tags, tp);
          if ((_sv0t31 == 9)) {
            p = tp;
          } else {
            int _sv0t32 = (0 - 1);
        ...
        int _sv0t33 = ps_peek(tags, vp);
        if ((_sv0t33 == 8)) {
          int sp = (vp + 1);
          int sd = 0;
          while ((sd != 1)) {
            int _sv0t34 = ps_peek(tags, sp);
            if ((_sv0t34 == 9)) {
              sp = (sp + 1);
              sd = 1;
            } else {
              int _sv0t35 = ps_peek(tags, sp);
              if ((_sv0t35 != 5)) {
                int _sv0t36 = (0 - 1);
                return _sv0t36;
              } else {
              ...
              int _sv0t37 = (sp + 1);
              int _sv0t38 = ps_peek(tags, _sv0t37);
              if ((_sv0t38 != 14)) {
                int _sv0t39 = (0 - 1);
                return _sv0t39;
              } else {
              ...
              int _sv0t40 = (sp + 2);
              int _sv0t41 = parse_type(tags, starts, ends, source, _sv0t40, pty_tt, pty_td1, pty_td2, pty_td3, pp);
              int pt = _sv0t41;
              if ((pt < 0)) {
                int _sv0t42 = (0 - 1);
                return _sv0t42;
              ...
              int _sv0t43 = sv0_vec_len(pty_tt);
              int _sv0t44 = (_sv0t43 - 1);
              sv0_vec_push(enum_variant_payload_ty_root, _sv0t44);
              int _sv0t45 = sv0_vec_len(pty_tt);
              int _sv0t46 = (_sv0t45 - 1);
              int _sv0t47 = enum_payload_root_simple_name_tok(_sv0t46, pty_tt, pty_td1, pty_td2, pp);
              sv0_vec_push(enum_variant_payload_ty_name_tok, _sv0t47);
              payload_count = (payload_count + 1);
              int _sv0t48 = ps_peek(tags, pt);
              if ((_sv0t48 == 12)) {
                sp = (pt + 1);
              } else {
                int _sv0t49 = ps_peek(tags, pt);
                if ((_sv0t49 == 9)) {
                  sp = pt;
                } else {
                  int _sv0t50 = (0 - 1);
          ...
          sv0_vec_push(enum_variant_payload_count_by_variant, vpc);
          variant_count = (variant_count + 1);
          int _sv0t51 = ps_peek(tags, sp);
          if ((_sv0t51 == 12)) {
            p = (sp + 1);
          } else {
            int _sv0t52 = ps_peek(tags, sp);
            if ((_sv0t52 == 9)) {
              p = sp;
            } else {
              int _sv0t53 = (0 - 1);
          ...
          sv0_vec_push(enum_variant_payload_count_by_variant, vpc);
          variant_count = (variant_count + 1);
          int _sv0t54 = ps_peek(tags, vp);
          if ((_sv0t54 == 12)) {
            p = (vp + 1);
          } else {
            int _sv0t55 = ps_peek(tags, vp);
            if ((_sv0t55 == 9)) {
              p = vp;
            } else {
              int _sv0t56 = (0 - 1);
  ...
  int _sv0t57 = (0 - 1);
  sv0_vec_push(id5, _sv0t57);
  int _sv0t58 = (0 - 1);
  sv0_vec_push(fn_ret_ty_root_by_item, _sv0t58);
  int _sv0t59 = (0 - 1);
  sv0_vec_push(fn_contract_base_by_item, _sv0t59);
  sv0_vec_push(enum_variant_payload_base_by_item, payload_base);
  sv0_vec_push(enum_variant_payload_count_by_item, payload_count);
  sv0_vec_push(enum_variant_payload_max_by_item, payload_max);
  int _sv0t60 = (p + 1);
  return _sv0t60;
}
...
static int parse_trait_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int id5, int pp, int fn_param_name_toks, int fn_param_ty_root, int fn_ret_ty_root_by_item, int fn_contract_base_by_item, int fn_contract_root, int enum_variant_payload_base_by_item, int enum_variant_payload_count_by_item, int enum_variant_payload_max_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t9 == 9)) {
      ...
      int _sv0t10 = parse_fn_body(tags, starts, ends, source, p, it, id1, id2, id3, id4, id5, pp, fn_param_name_toks, fn_param_ty_root, fn_ret_ty_root_by_item, fn_contract_base_by_item, fn_contract_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
      int pm = _sv0t10;
      if ((pm < 0)) {
        int _sv0t11 = (0 - 1);
        return _sv0t11;
...
static int parse_impl_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int id5, int pp, int fn_param_name_toks, int fn_param_ty_root, int fn_ret_ty_root_by_item, int fn_contract_base_by_item, int fn_contract_root, int enum_variant_payload_base_by_item, int enum_variant_payload_count_by_item, int enum_variant_payload_max_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  if ((has_trait == 1)) {
    ...
    int _sv0t24 = (0 - 1);
    sv0_vec_push(id3, _sv0t24);
  }
  int _sv0t25 = (0 - 1);
  sv0_vec_push(id4, _sv0t25);
  int _sv0t26 = (0 - 1);
  sv0_vec_push(id5, _sv0t26);
  int _sv0t27 = (0 - 1);
  sv0_vec_push(fn_ret_ty_root_by_item, _sv0t27);
...
static int parse_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int id5, int pp, int enum_variant_name_toks, int struct_field_name_toks, int fn_param_name_toks, int fn_param_ty_root, int fn_ret_ty_root_by_item, int fn_contract_base_by_item, int fn_contract_root, int enum_variant_payload_ty_root, int enum_variant_payload_base_by_item, int enum_variant_payload_count_by_item, int enum_variant_payload_max_by_item, int pty_tt, int pty_td1, int pty_td2, int pty_td3, int struct_field_ty_root, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf, int tparam_names_out, int enum_variant_payload_count_by_variant, int enum_variant_payload_ty_name_tok) {
  int _sv0t0 = ps_peek_extern_c_attribute(tags, source, starts, ends, pos);
  int extc_pos = _sv0t0;
  if ((extc_pos >= 0)) {
    int _sv0t1 = ps_skip_optional_pub(tags, extc_pos);
    int extc_p0 = _sv0t1;
    int _sv0t2 = ps_peek(tags, extc_p0);
    if ((_sv0t2 != 65)) {
      int _sv0t3 = (0 - 1);
      return _sv0t3;
    } else {
    }
    int _sv0t4 = sv0_vec_len(it);
    int it_len_before = _sv0t4;
    int _sv0t5 = parse_fn_body(tags, starts, ends, source, extc_p0, it, id1, id2, id3, id4, id5, pp, fn_param_name_toks, fn_param_ty_root, fn_ret_ty_root_by_item, fn_contract_base_by_item, fn_contract_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    int pm_extc = _sv0t5;
    if ((pm_extc < 0)) {
      int _sv0t6 = (0 - 1);
      return _sv0t6;
    ...
    int _sv0t7 = sv0_vec_get(id4, it_len_before);
    if ((_sv0t7 >= 0)) {
      int _sv0t8 = (0 - 1);
      return _sv0t8;
    } else {
    }
    sv0_vec_set(it, it_len_before, 8);
    return pm_extc;
  } else {
  }
  int _sv0t9 = ps_skip_attributes(tags, pos);
  int _sv0t10 = ps_skip_optional_pub(tags, _sv0t9);
  int p0 = _sv0t10;
  int _sv0t11 = ps_peek(tags, p0);
  int t = _sv0t11;
  if ((t == 75)) {
    int _sv0t12 = sv0_vec_len(pp);
    int pps = _sv0t12;
    int _sv0t13 = parse_module_decl(tags, p0, pp);
    int pm = _sv0t13;
    if ((pm == p0)) {
      int _sv0t14 = (0 - 1);
      return _sv0t14;
  ...
  if ((t == 94)) {
    int _sv0t21 = sv0_vec_len(pp);
    int pps = _sv0t21;
    int _sv0t22 = parse_use_item(tags, p0, pp);
    int pu = _sv0t22;
    if ((pu < 0)) {
      int _sv0t23 = (0 - 1);
      return _sv0t23;
  ...
  if ((t == 65)) {
    int _sv0t30 = parse_fn_body(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, fn_param_name_toks, fn_param_ty_root, fn_ret_ty_root_by_item, fn_contract_base_by_item, fn_contract_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t30;
  } else {
  }
  if ((t == 93)) {
    int _sv0t31 = parse_fn_body(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, fn_param_name_toks, fn_param_ty_root, fn_ret_ty_root_by_item, fn_contract_base_by_item, fn_contract_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t31;
  } else {
  }
  if ((t == 89)) {
    int _sv0t32 = parse_struct_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, struct_field_name_toks, fn_ret_ty_root_by_item, fn_contract_base_by_item, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, struct_field_ty_root);
    return _sv0t32;
  } else {
  }
  if ((t == 62)) {
    int _sv0t33 = parse_enum_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, enum_variant_name_toks, fn_ret_ty_root_by_item, fn_contract_base_by_item, enum_variant_payload_ty_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, tparam_names_out, enum_variant_payload_count_by_variant, enum_variant_payload_ty_name_tok);
    return _sv0t33;
  } else {
  }
  if ((t == 90)) {
    int _sv0t34 = parse_trait_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, fn_param_name_toks, fn_param_ty_root, fn_ret_ty_root_by_item, fn_contract_base_by_item, fn_contract_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t34;
  } else {
  }
  if ((t == 69)) {
    int _sv0t35 = parse_impl_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, fn_param_name_toks, fn_param_ty_root, fn_ret_ty_root_by_item, fn_contract_base_by_item, fn_contract_root, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t35;
  } else {
  }
  if ((t == 92)) {
    int _sv0t36 = parse_type_alias_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, id5, pp, fn_ret_ty_root_by_item, fn_contract_base_by_item, enum_variant_payload_base_by_item, enum_variant_payload_count_by_item, enum_variant_payload_max_by_item, pty_tt, pty_td1, pty_td2, pty_td3, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t36;
  } else {
  }
  int _sv0t37 = (0 - 1);
...
static int test_parse_expr_cast_ptr_const(void) {
  ...
  int _sv0t8 = sv0_vec_new();
  int pp = _sv0t8;
  int _sv0t9 = parse_expr(tags, starts, ends, "&x as *const i32", 0, et, ed1, ed2, ed3, ed4, pp, 1);
  int p = _sv0t9;
  if ((p != 6)) {
    return 1;
  } else {
...
static int test_parse_expr_cast_ptr_mut(void) {
  ...
  int _sv0t8 = sv0_vec_new();
  int pp = _sv0t8;
  int _sv0t9 = parse_expr(tags, starts, ends, "&mut x as *mut i32", 0, et, ed1, ed2, ed3, ed4, pp, 1);
  int p = _sv0t9;
  if ((p != 7)) {
    return 1;
  } else {
...
static int test_parse_expr_cast_non_ptr_unaffected(void) {
  ...
  int _sv0t10 = sv0_vec_get(et, 1);
  if ((_sv0t10 != 20)) {
    return 2;
  } else {
  }
  int _sv0t11 = sv0_vec_get(ed4, 1);
  if ((_sv0t11 != 0)) {
    return 3;
  } else {
  }
...
static int test_parse_expr_index_range_full(void) {
  ...
  int _sv0t8 = sv0_vec_new();
  int pp = _sv0t8;
  int _sv0t9 = parse_expr(tags, starts, ends, "a[..]", 0, et, ed1, ed2, ed3, ed4, pp, 1);
  int p = _sv0t9;
  if ((p != 4)) {
    return 1;
  } else {
  ...
  int _sv0t14 = sv0_vec_get(ed1, 1);
  int _sv0t15 = (0 - 1);
  if ((_sv0t14 != _sv0t15)) {
    return 6;
  } else {
  }
  int _sv0t16 = sv0_vec_get(ed2, 1);
  int _sv0t17 = (0 - 1);
  if ((_sv0t16 != _sv0t17)) {
    return 7;
  } else {
  }
  int _sv0t18 = sv0_vec_get(ed1, 2);
  if ((_sv0t18 != 0)) {
    return 8;
  } else {
  }
  int _sv0t19 = sv0_vec_get(ed2, 2);
  if ((_sv0t19 != 1)) {
    return 9;
  } else {
  }
...
static int test_parse_expr_index_range_bounded(void) {
  ...
  int _sv0t8 = sv0_vec_new();
  int pp = _sv0t8;
  int _sv0t9 = parse_expr(tags, starts, ends, "a[1..3]", 0, et, ed1, ed2, ed3, ed4, pp, 1);
  int p = _sv0t9;
  if ((p != 6)) {
    return 1;
  } else {
  ...
  int _sv0t12 = sv0_vec_get(et, 3);
  if ((_sv0t12 != 21)) {
    return 4;
  } else {
  }
  int _sv0t13 = sv0_vec_get(et, 4);
  if ((_sv0t13 != 8)) {
    return 5;
  } else {
  }
  int _sv0t14 = sv0_vec_get(ed1, 3);
  if ((_sv0t14 != 1)) {
    return 6;
  } else {
  }
  int _sv0t15 = sv0_vec_get(ed2, 3);
  if ((_sv0t15 != 2)) {
    return 7;
  } else {
  }
  int _sv0t16 = sv0_vec_get(ed1, 4);
  if ((_sv0t16 != 0)) {
    return 8;
  } else {
  }
  int _sv0t17 = sv0_vec_get(ed2, 4);
  if ((_sv0t17 != 3)) {
    return 9;
  } else {
  }
...
static int test_parse_unsafe_block_empty(void) {
  ...
  int _sv0t8 = sv0_vec_new();
  int pp = _sv0t8;
  int _sv0t9 = parse_expr(tags, starts, ends, "unsafe {}", 0, et, ed1, ed2, ed3, ed4, pp, 1);
  int p = _sv0t9;
  if ((p != 3)) {
    return 1;
  } else {
  ...
  int _sv0t14 = expr_ends_with_braced_block(et, 1);
  if ((_sv0t14 != 1)) {
    return 6;
  } else {
  }
...
static int test_parse_assign(void) {
  ...
  sv0_vec_push(s4, 13);
  sv0_vec_push(e4, 13);
  int _sv0t47 = scan_index_assign_eq(t4, 1);
  if ((_sv0t47 != 5)) {
    return 18;
  } else {
  }
  int _sv0t48 = scan_index_assign_eq(t4, 6);
  int _sv0t49 = (0 - 1);
  if ((_sv0t48 != _sv0t49)) {
    return 19;
  } else {
  ...
  int pp4 = _sv0t55;
  int _sv0t56 = parse_expr(t4, s4, e4, "{ a[0] = 9; }", 0, et4, d1d, d2d, d3d, d4d, pp4, 1);
  int p4 = _sv0t56;
  if ((p4 != 9)) {
    return 20;
  } else {
  }
  int _sv0t57 = sv0_vec_len(et4);
  int _sv0t58 = (_sv0t57 - 2);
  int _sv0t59 = sv0_vec_get(d1d, _sv0t58);
  int an4 = _sv0t59;
  int _sv0t60 = sv0_vec_get(et4, an4);
  if ((_sv0t60 != 18)) {
    return 21;
  } else {
  }
  int _sv0t61 = sv0_vec_get(d1d, an4);
  int _sv0t62 = sv0_vec_get(et4, _sv0t61);
  if ((_sv0t62 != 8)) {
    return 22;
  } else {
  }
...
static int test_parse_fn_simple(void) {
  ...
  int _sv0t33 = sv0_vec_new();
  int _sv0t34 = sv0_vec_new();
  int _sv0t35 = parse_item(tags, starts, ends, source, 0, it, id1, id2, id3, id4, id5, pp, ev_ntoks, sf_ntoks, fn_ptoks, _sv0t24, _sv0t25, _sv0t26, _sv0t27, _sv0t28, _sv0t29, _sv0t30, _sv0t31, pty_tt, pty_td1, pty_td2, pty_td3, sf_ty_root, bet, be1, be2, be3, be4, bsf, _sv0t32, _sv0t33, _sv0t34);
  int r = _sv0t35;
  if ((r != 6)) {
    return 1;
  } else {
  }
  int _sv0t36 = sv0_vec_get(it, 0);
  if ((_sv0t36 != 0)) {
    return 2;
  } else {
  }
  int _sv0t37 = sv0_vec_get(id1, 0);
  if ((_sv0t37 != 1)) {
    return 3;
  } else {
  }
  int _sv0t38 = sv0_vec_get(id2, 0);
  if ((_sv0t38 != 0)) {
    return 4;
  } else {
  }
  int _sv0t39 = sv0_vec_get(id3, 0);
  if ((_sv0t39 != 0)) {
    return 5;
  } else {
  }
  int _sv0t40 = sv0_vec_get(id4, 0);
  if ((_sv0t40 < 0)) {
    return 6;
  } else {
  }
  int _sv0t41 = sv0_vec_get(id5, 0);
  if ((_sv0t41 != 0)) {
    return 7;
  } else {
  }
  int _sv0t42 = sv0_vec_len(fn_ptoks);
  if ((_sv0t42 != 0)) {
    return 8;
  } else {
  }
...
static int test_parse_fn_ret(void) {
  ...
  int _sv0t43 = sv0_vec_get(fn_ptoks, 0);
  if ((_sv0t43 != 3)) {
    return 9;
  } else {
  }
...
static int test_parse_struct(void) {
  ...
  int _sv0t41 = sv0_vec_len(sf_ntoks);
  if ((_sv0t41 != 2)) {
    return 7;
  } else {
  }
  int _sv0t42 = sv0_vec_get(sf_ntoks, 0);
  if ((_sv0t42 != 3)) {
    return 8;
  } else {
  }
  int _sv0t43 = sv0_vec_get(sf_ntoks, 1);
  if ((_sv0t43 != 7)) {
    return 9;
  } else {
  }
  int _sv0t44 = sv0_vec_len(sf_ty_root);
  if ((_sv0t44 != 2)) {
    return 10;
  } else {
  }
...
static int test_parse_enum_mixed(void) {
  ...
  int _sv0t41 = sv0_vec_len(ev_ntoks);
  if ((_sv0t41 != 2)) {
    return 7;
  } else {
  }
  int _sv0t42 = sv0_vec_get(ev_ntoks, 0);
  if ((_sv0t42 != 3)) {
    return 8;
  } else {
  }
  int _sv0t43 = sv0_vec_get(ev_ntoks, 1);
  if ((_sv0t43 != 5)) {
    return 9;
  } else {
  }
...
static int test_parse_impl(void) {
  ...
  int _sv0t36 = sv0_vec_len(it);
  if ((_sv0t36 != 2)) {
    return 2;
  } else {
  }
  int _sv0t37 = sv0_vec_get(it, 0);
  if ((_sv0t37 != 0)) {
    return 3;
  } else {
  }
  int _sv0t38 = sv0_vec_get(id1, 0);
  if ((_sv0t38 != 4)) {
    return 4;
  } else {
  }
  int _sv0t39 = sv0_vec_get(it, 1);
  if ((_sv0t39 != 4)) {
    return 5;
  } else {
  }
  int _sv0t40 = sv0_vec_get(id1, 1);
  if ((_sv0t40 != 0)) {
    return 6;
  } else {
  }
  int _sv0t41 = sv0_vec_get(id2, 1);
  if ((_sv0t41 != 1)) {
    return 7;
  } else {
  }
...
static int test_parse_fn_contract(void) {
  ...
  int _sv0t38 = sv0_vec_get(id3, 0);
  if ((_sv0t38 != 0)) {
    return 4;
  } else {
  }
  int _sv0t39 = sv0_vec_get(id4, 0);
  if ((_sv0t39 < 0)) {
    return 5;
  } else {
  }
...
static int test_parse_program(void) {
  ...
  int _sv0t33 = sv0_vec_new();
  int _sv0t34 = sv0_vec_new();
  int _sv0t35 = parse_program(tags, starts, ends, source, 0, it, id1, id2, id3, id4, id5, pp, ev_ntoks, sf_ntoks, fn_ptoks, _sv0t24, _sv0t25, _sv0t26, _sv0t27, _sv0t28, _sv0t29, _sv0t30, _sv0t31, pty_tt, pty_td1, pty_td2, pty_td3, sf_ty_root, bet, be1, be2, be3, be4, bsf, _sv0t32, _sv0t33, _sv0t34);
  int r = _sv0t35;
  if ((r != 12)) {
    return 1;
  } else {
...
static int test_parse_extern_c_fn_decl(void) {
  ...
  int ends = _sv0t2;
  const char* source;
  source = "#[extern_c] fn c_abs(x: i32) -> i32;";
  sv0_vec_push(tags, 21);
  sv0_vec_push(starts, 0);
  sv0_vec_push(ends, 1);
  sv0_vec_push(tags, 10);
  sv0_vec_push(starts, 1);
  ...
  sv0_vec_push(tags, 5);
  sv0_vec_push(starts, 32);
  sv0_vec_push(ends, 35);
  sv0_vec_push(tags, 13);
  sv0_vec_push(starts, 35);
  sv0_vec_push(ends, 36);
  sv0_vec_push(tags, 97);
  sv0_vec_push(starts, 36);
  sv0_vec_push(ends, 36);
  int _sv0t3 = sv0_vec_new();
  int it = _sv0t3;
  int _sv0t4 = sv0_vec_new();
  ...
  int _sv0t33 = sv0_vec_new();
  int _sv0t34 = sv0_vec_new();
  int _sv0t35 = parse_program(tags, starts, ends, source, 0, it, id1, id2, id3, id4, id5, pp, _sv0t22, _sv0t23, fn_ptoks, _sv0t24, _sv0t25, _sv0t26, _sv0t27, _sv0t28, _sv0t29, _sv0t30, _sv0t31, pty_tt, pty_td1, pty_td2, pty_td3, sf_ty_root, bet, be1, be2, be3, be4, bsf, _sv0t32, _sv0t33, _sv0t34);
  int r = _sv0t35;
  if ((r != 14)) {
    return 1;
  } else {
...
static int parser_scan_case(int spec_tags, int expect) {
  int _sv0t0 = scan_index_assign_eq(spec_tags, 0);
  if ((_sv0t0 != expect)) {
    return 1;
  } else {
  }
...
static int test_scan_index_assign_places(void) {
  ...
  sv0_vec_push(t0, 13);
  sv0_vec_push(t0, 97);
  int _sv0t1 = parser_scan_case(t0, 4);
  if ((_sv0t1 != 0)) {
    return 1;
  } else {
  }
  ...
  sv0_vec_push(t1, 13);
  sv0_vec_push(t1, 97);
  int _sv0t3 = parser_scan_case(t1, 6);
  if ((_sv0t3 != 0)) {
    return 2;
  } else {
  }
  ...
  sv0_vec_push(t2, 13);
  sv0_vec_push(t2, 97);
  int _sv0t5 = parser_scan_case(t2, 7);
  if ((_sv0t5 != 0)) {
    return 3;
  } else {
  }
  ...
  sv0_vec_push(t3, 97);
  int _sv0t7 = (0 - 1);
  int _sv0t8 = parser_scan_case(t3, _sv0t7);
  if ((_sv0t8 != 0)) {
    return 4;
  } else {
  }
  ...
  sv0_vec_push(t4, 97);
  int _sv0t10 = (0 - 1);
  int _sv0t11 = parser_scan_case(t4, _sv0t10);
  if ((_sv0t11 != 0)) {
    return 5;
  } else {
  }
  ...
  sv0_vec_push(t5, 97);
  int _sv0t13 = (0 - 1);
  int _sv0t14 = parser_scan_case(t5, _sv0t13);
  if ((_sv0t14 != 0)) {
    return 6;
  } else {
  }
  ...
  sv0_vec_push(t6, 97);
  int _sv0t16 = (0 - 1);
  int _sv0t17 = parser_scan_case(t6, _sv0t16);
  if ((_sv0t17 != 0)) {
    return 7;
  } else {
  }
  ...
  sv0_vec_push(t7, 13);
  sv0_vec_push(t7, 97);
  int _sv0t19 = parser_scan_case(t7, 7);
  if ((_sv0t19 != 0)) {
    return 8;
  } else {
  }
  ...
  sv0_vec_push(t8, 13);
  sv0_vec_push(t8, 97);
  int _sv0t21 = parser_scan_case(t8, 8);
  if ((_sv0t21 != 0)) {
    return 9;
  } else {
  }
...
int main(void) {
  ...
  int _sv0t151 = test_parse_expr_index_range_full();
  int r74 = _sv0t151;
  if ((r74 != 0)) {
    int _sv0t152 = (850 + r74);
    return _sv0t152;
  } else {
  }
  int _sv0t153 = test_parse_expr_index_range_bounded();
  int r75 = _sv0t153;
  if ((r75 != 0)) {
    int _sv0t154 = (860 + r75);
    return _sv0t154;
  } else {
  }
  int _sv0t155 = test_parse_type_ptr_const();
  int r76 = _sv0t155;
  if ((r76 != 0)) {
    int _sv0t156 = (870 + r76);
    return _sv0t156;
  } else {
  }
  int _sv0t157 = test_parse_type_ptr_mut();
  int r77 = _sv0t157;
  if ((r77 != 0)) {
    int _sv0t158 = (880 + r77);
    return _sv0t158;
  } else {
  }
  int _sv0t159 = test_parse_type_ptr_bare_star_rejected();
  int r78 = _sv0t159;
  if ((r78 != 0)) {
    int _sv0t160 = (890 + r78);
    return _sv0t160;
  } else {
  }
  int _sv0t161 = test_parse_expr_cast_ptr_const();
  int r79 = _sv0t161;
  if ((r79 != 0)) {
    int _sv0t162 = (900 + r79);
    return _sv0t162;
  } else {
  }
  int _sv0t163 = test_parse_expr_cast_ptr_mut();
  int r80 = _sv0t163;
  if ((r80 != 0)) {
    int _sv0t164 = (910 + r80);
    return _sv0t164;
  } else {
  }
  int _sv0t165 = test_parse_expr_cast_non_ptr_unaffected();
  int r81 = _sv0t165;
  if ((r81 != 0)) {
    int _sv0t166 = (920 + r81);
    return _sv0t166;
  } else {
  }
  int _sv0t167 = test_parse_unsafe_block_empty();
  int r82 = _sv0t167;
  if ((r82 != 0)) {
    int _sv0t168 = (930 + r82);
    return _sv0t168;
  } else {
  }
  int _sv0t169 = test_parse_extern_c_fn_decl();
  int r83 = _sv0t169;
  if ((r83 != 0)) {
    int _sv0t170 = (940 + r83);
    return _sv0t170;
  } else {
  }
  int _sv0t171 = test_parse_extern_c_fn_with_body_rejected();
  int r84 = _sv0t171;
  if ((r84 != 0)) {
    int _sv0t172 = (950 + r84);
    return _sv0t172;
  } else {
  }
  int _sv0t173 = test_scan_index_assign_places();
  int rpl = _sv0t173;
  if ((rpl != 0)) {
    int _sv0t174 = (1400 + rpl);
    return _sv0t174;
  } else {
  }
  return 0;
