...
static int parse_match_expr(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  ...
  while ((arms_done != 1)) {
    ...
    if ((_sv0t10 == 9)) {
      ...
      if ((_sv0t36 || _sv0t37)) {
        sv0_vec_push(et, 30);
        int _sv0t38 = sv0_vec_get(pd1v, pr);
        sv0_vec_push(ed1, _sv0t38);
        int _sv0t39 = sv0_vec_get(pd2v, pr);
        sv0_vec_push(ed2, _sv0t39);
        int _sv0t40 = sv0_vec_get(pd3v, pr);
        sv0_vec_push(ed3, _sv0t40);
      ...
      if ((arms_first < 0)) {
        ...
        arms_first = (_sv0t42 - 1);
      } else {
      }
      arm_count = (arm_count + 1);
      int _sv0t43 = ps_peek(tags, body_pos);
      if ((_sv0t43 == 12)) {
        p = (body_pos + 1);
      } else {
        p = body_pos;
