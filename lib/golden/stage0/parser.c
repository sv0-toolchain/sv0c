...
static int parse_param(int tags, int starts, int ends, const char* source, int pos, int pp);
static int parse_param_list(int tags, int starts, int ends, const char* source, int pos, int pp, int count_out);
static int parse_contract(int tags, int starts, int ends, const char* source, int pos, int pp);
static int parse_contracts(int tags, int starts, int ends, const char* source, int pos, int pp, int count_out);
static int parse_fn_body(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf);
static int parse_struct_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp);
static int parse_enum_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp);
static int parse_type_alias_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp);
static int parse_trait_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf);
static int parse_impl_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf);
static int parse_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf);
static int parse_program(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf);
...
static int try_assign_stmt(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  ...
  if ((nt == 35)) {
    ...
    int _sv0t6 = (pos + 2);
    int _sv0t7 = parse_expr(tags, starts, ends, source, _sv0t6, et, ed1, ed2, ed3, ed4, pp, 1);
    int pe = _sv0t7;
    if ((pe < 0)) {
      int _sv0t8 = (0 - 1);
      return _sv0t8;
...
static int parse_block(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  ...
  while ((blk_done != 1)) {
    ...
    if ((_sv0t2 == 9)) {
      ...
      int _sv0t4 = (0 - 1);
      sv0_vec_push(ed3, _sv0t4);
      sv0_vec_push(ed4, 0);
      int _sv0t5 = (p + 1);
      return _sv0t5;
    } else {
    }
    int _sv0t6 = try_stmt(tags, starts, ends, source, p, et, ed1, ed2, ed3, ed4, pp, sf_names);
    int s = _sv0t6;
    if ((s >= 0)) {
      if ((stmts_first < 0)) {
        int _sv0t7 = sv0_vec_len(et);
        stmts_first = (_sv0t7 - 1);
      } else {
      }
      stmt_count = (stmt_count + 1);
      p = s;
    } else {
      int _sv0t8 = parse_expr(tags, starts, ends, source, p, et, ed1, ed2, ed3, ed4, pp, 1);
      int pe = _sv0t8;
      if ((pe < 0)) {
        int _sv0t9 = (0 - 1);
        return _sv0t9;
      ...
      if ((_sv0t13 == 13)) {
        ...
        int _sv0t16 = sv0_vec_len(et);
        int _sv0t17 = (_sv0t16 - 1);
        int _sv0t18 = expr_ends_with_braced_block(et, _sv0t17);
        if ((_sv0t18 == 1)) {
...
static int parse_match_expr(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  ...
  while ((arms_done != 1)) {
    ...
    if ((_sv0t10 == 9)) {
      ...
      int arm_ed2 = pat_d1;
      int _sv0t34 = (pat_tag == 2);
      int _sv0t35 = (pat_tag == 4);
      int _sv0t36 = (_sv0t34 || _sv0t35);
      int _sv0t37 = (pat_tag == 5);
      if ((_sv0t36 || _sv0t37)) {
        if ((pat_tag == 4)) {
          int _sv0t38 = sv0_vec_get(pd3v, pr);
          int fc = _sv0t38;
          int _sv0t39 = sv0_vec_len(et);
          int first_embed = _sv0t39;
          int fj = 0;
          while ((fj < fc)) {
            int _sv0t40 = (pr - fc);
            int row = (_sv0t40 + fj);
            sv0_vec_push(et, 31);
            int _sv0t41 = sv0_vec_get(pd1v, row);
            sv0_vec_push(ed1, _sv0t41);
            int _sv0t42 = sv0_vec_get(pd2v, row);
            sv0_vec_push(ed2, _sv0t42);
            int _sv0t43 = sv0_vec_get(pd3v, row);
            sv0_vec_push(ed3, _sv0t43);
            int _sv0t44 = sv0_vec_get(pt, row);
            sv0_vec_push(ed4, _sv0t44);
            fj = (fj + 1);
          }
          sv0_vec_push(et, 32);
          sv0_vec_push(ed1, fc);
        ...
        if ((pat_tag == 5)) {
          int _sv0t46 = sv0_vec_get(pd3v, pr);
          int ac = _sv0t46;
          if ((ac > 0)) {
            int _sv0t47 = sv0_vec_len(et);
            int first_emb_e = _sv0t47;
            int aj = 0;
            while ((aj < ac)) {
              int _sv0t48 = (pr - ac);
              int row_e = (_sv0t48 + aj);
              sv0_vec_push(et, 31);
              int _sv0t49 = sv0_vec_get(pd1v, row_e);
              sv0_vec_push(ed1, _sv0t49);
              sv0_vec_push(ed2, aj);
              int _sv0t50 = sv0_vec_get(pd3v, row_e);
              sv0_vec_push(ed3, _sv0t50);
              int _sv0t51 = sv0_vec_get(pt, row_e);
              sv0_vec_push(ed4, _sv0t51);
              aj = (aj + 1);
            }
            sv0_vec_push(et, 33);
            sv0_vec_push(ed1, ac);
        ...
        sv0_vec_push(et, 30);
        int _sv0t52 = sv0_vec_get(pd1v, pr);
        sv0_vec_push(ed1, _sv0t52);
        int _sv0t53 = sv0_vec_get(pd2v, pr);
        sv0_vec_push(ed2, _sv0t53);
        int _sv0t54 = sv0_vec_get(pd3v, pr);
        sv0_vec_push(ed3, _sv0t54);
        sv0_vec_push(ed4, pat_tag);
        int _sv0t55 = sv0_vec_len(et);
        arm_ed2 = (_sv0t55 - 1);
      } else {
      }
      sv0_vec_push(et, 29);
      sv0_vec_push(ed1, pat_tag);
      sv0_vec_push(ed2, arm_ed2);
      sv0_vec_push(ed3, guard_idx);
      sv0_vec_push(ed4, body_idx);
      if ((arms_first < 0)) {
        int _sv0t56 = sv0_vec_len(et);
        arms_first = (_sv0t56 - 1);
      } else {
      }
      arm_count = (arm_count + 1);
      int _sv0t57 = ps_peek(tags, body_pos);
      if ((_sv0t57 == 12)) {
        p = (body_pos + 1);
      } else {
        p = body_pos;
...
static int parse_param(int tags, int starts, int ends, const char* source, int pos, int pp) {
  ...
  int td3 = _sv0t8;
  int _sv0t9 = (p + 1);
  int _sv0t10 = parse_type(tags, starts, ends, source, _sv0t9, tt, td1, td2, td3, pp);
  int pt = _sv0t10;
  if ((pt < 0)) {
    int _sv0t11 = (0 - 1);
    return _sv0t11;
...
static int parse_param_list(int tags, int starts, int ends, const char* source, int pos, int pp, int count_out) {
  ...
  int _sv0t1 = parse_param(tags, starts, ends, source, pos, pp);
  int p1 = _sv0t1;
  if ((p1 < 0)) {
    int _sv0t2 = (0 - 1);
    return _sv0t2;
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t3 == 12)) {
      ...
      if ((_sv0t5 == 7)) {
        ...
        int _sv0t6 = (p + 1);
        int _sv0t7 = parse_param(tags, starts, ends, source, _sv0t6, pp);
        int pn = _sv0t7;
        if ((pn < 0)) {
          int _sv0t8 = (0 - 1);
          return _sv0t8;
...
static int parse_contract(int tags, int starts, int ends, const char* source, int pos, int pp) {
  ...
  int ed4 = _sv0t9;
  int _sv0t10 = (pos + 2);
  int _sv0t11 = parse_expr(tags, starts, ends, source, _sv0t10, et, ed1, ed2, ed3, ed4, pp, 1);
  int pe = _sv0t11;
  if ((pe < 0)) {
    int _sv0t12 = (0 - 1);
    return _sv0t12;
...
static int parse_contracts(int tags, int starts, int ends, const char* source, int pos, int pp, int count_out) {
  ...
  int done = 0;
  while ((done != 1)) {
    int _sv0t0 = parse_contract(tags, starts, ends, source, p, pp);
    int pc = _sv0t0;
    int _sv0t1 = (0 - 2);
    if ((pc == _sv0t1)) {
      done = 1;
...
static int parse_fn_body(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  int pc = _sv0t11;
  int _sv0t12 = (p1 + 1);
  int _sv0t13 = parse_param_list(tags, starts, ends, source, _sv0t12, pp, pc);
  int p2 = _sv0t13;
  if ((p2 < 0)) {
    int _sv0t14 = (0 - 1);
    return _sv0t14;
  ...
  int _sv0t15 = ps_peek(tags, p2);
  if ((_sv0t15 != 7)) {
    int _sv0t16 = (0 - 1);
    return _sv0t16;
  } else {
  }
  int _sv0t17 = sv0_vec_get(pc, 0);
  int param_count = _sv0t17;
  int has_ret = 0;
  int p3 = (p2 + 1);
  int _sv0t18 = ps_peek(tags, p3);
  if ((_sv0t18 == 19)) {
    ...
    int td3 = _sv0t22;
    int _sv0t23 = (p3 + 1);
    int _sv0t24 = parse_type(tags, starts, ends, source, _sv0t23, tt, td1, td2, td3, pp);
    int pt = _sv0t24;
    if ((pt < 0)) {
      int _sv0t25 = (0 - 1);
      return _sv0t25;
  ...
  int _sv0t26 = ps_skip_where_clause(tags, p3);
  int p4 = _sv0t26;
  int _sv0t27 = sv0_vec_new();
  int cc = _sv0t27;
  int _sv0t28 = parse_contracts(tags, starts, ends, source, p4, pp, cc);
  int p5 = _sv0t28;
  if ((p5 < 0)) {
    int _sv0t29 = (0 - 1);
    return _sv0t29;
  ...
  int _sv0t30 = sv0_vec_get(cc, 0);
  int contract_count = _sv0t30;
...
static int parse_struct_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp) {
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t10 == 9)) {
      ...
      int _sv0t11 = ps_skip_optional_pub(tags, p);
      int fp = _sv0t11;
      int _sv0t12 = ps_peek(tags, fp);
      if ((_sv0t12 != 5)) {
        int _sv0t13 = (0 - 1);
        return _sv0t13;
      } else {
      ...
      int td3v = _sv0t20;
      int _sv0t21 = (fp + 2);
      int _sv0t22 = parse_type(tags, starts, ends, source, _sv0t21, tt, td1v, td2v, td3v, pp);
      int pt = _sv0t22;
      if ((pt < 0)) {
        int _sv0t23 = (0 - 1);
        return _sv0t23;
...
static int parse_enum_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp) {
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t10 == 9)) {
      ...
      int vp = (p + 1);
      int _sv0t13 = ps_peek(tags, vp);
      if ((_sv0t13 == 6)) {
        int tp = (vp + 1);
        int _sv0t14 = ps_peek(tags, tp);
        if ((_sv0t14 == 7)) {
          tp = (tp + 1);
        } else {
          int td = 0;
          while ((td != 1)) {
            ...
            int _sv0t18 = sv0_vec_new();
            int td3v = _sv0t18;
            int _sv0t19 = parse_type(tags, starts, ends, source, tp, tt, td1v, td2v, td3v, pp);
            int pt = _sv0t19;
            if ((pt < 0)) {
              int _sv0t20 = (0 - 1);
              return _sv0t20;
        ...
        if ((_sv0t27 == 8)) {
          ...
          while ((sd != 1)) {
            ...
            if ((_sv0t28 == 9)) {
              ...
              int td3v = _sv0t37;
              int _sv0t38 = (sp + 2);
              int _sv0t39 = parse_type(tags, starts, ends, source, _sv0t38, tt, td1v, td2v, td3v, pp);
              int pt = _sv0t39;
              if ((pt < 0)) {
                int _sv0t40 = (0 - 1);
                return _sv0t40;
              ...
              int _sv0t41 = ps_peek(tags, pt);
              if ((_sv0t41 == 12)) {
                sp = (pt + 1);
              } else {
                int _sv0t42 = ps_peek(tags, pt);
                if ((_sv0t42 == 9)) {
                  sp = pt;
                } else {
                  int _sv0t43 = (0 - 1);
          ...
          variant_count = (variant_count + 1);
          int _sv0t44 = ps_peek(tags, sp);
          if ((_sv0t44 == 12)) {
            p = (sp + 1);
          } else {
            int _sv0t45 = ps_peek(tags, sp);
            if ((_sv0t45 == 9)) {
              p = sp;
            } else {
              int _sv0t46 = (0 - 1);
          ...
          variant_count = (variant_count + 1);
          int _sv0t47 = ps_peek(tags, vp);
          if ((_sv0t47 == 12)) {
            p = (vp + 1);
          } else {
            int _sv0t48 = ps_peek(tags, vp);
            if ((_sv0t48 == 9)) {
              p = vp;
            } else {
              int _sv0t49 = (0 - 1);
...
static int parse_type_alias_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp) {
  ...
  int td3 = _sv0t12;
  int _sv0t13 = (p1 + 1);
  int _sv0t14 = parse_type(tags, starts, ends, source, _sv0t13, tt, td1, td2, td3, pp);
  int pt = _sv0t14;
  if ((pt < 0)) {
    int _sv0t15 = (0 - 1);
    return _sv0t15;
...
static int parse_trait_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t9 == 9)) {
      ...
      int _sv0t10 = parse_fn_body(tags, starts, ends, source, p, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
      int pm = _sv0t10;
      if ((pm < 0)) {
        int _sv0t11 = (0 - 1);
        return _sv0t11;
...
static int parse_impl_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t21 == 9)) {
      ...
      int _sv0t22 = parse_fn_body(tags, starts, ends, source, p, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
      int pm = _sv0t22;
      if ((pm < 0)) {
        int _sv0t23 = (0 - 1);
        return _sv0t23;
...
static int parse_item(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  if ((t == 94)) {
    ...
    int pps = _sv0t8;
    int _sv0t9 = parse_use_item(tags, p0, pp);
    int pu = _sv0t9;
    if ((pu < 0)) {
      int _sv0t10 = (0 - 1);
      return _sv0t10;
  ...
  if ((t == 65)) {
    int _sv0t13 = parse_fn_body(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t13;
  } else {
  }
  if ((t == 93)) {
    int _sv0t14 = parse_fn_body(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t14;
  } else {
  }
  if ((t == 89)) {
    int _sv0t15 = parse_struct_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp);
    return _sv0t15;
  } else {
  }
  if ((t == 62)) {
    int _sv0t16 = parse_enum_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp);
    return _sv0t16;
  } else {
  }
  if ((t == 90)) {
    int _sv0t17 = parse_trait_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t17;
  } else {
  }
  if ((t == 69)) {
    int _sv0t18 = parse_impl_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
    return _sv0t18;
  } else {
  }
  if ((t == 92)) {
    int _sv0t19 = parse_type_alias_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp);
    return _sv0t19;
  } else {
  }
  int _sv0t20 = (0 - 1);
...
static int parse_program(int tags, int starts, int ends, const char* source, int pos, int it, int id1, int id2, int id3, int id4, int pp, int body_et, int body_ed1, int body_ed2, int body_ed3, int body_ed4, int body_sf) {
  ...
  while ((done != 1)) {
    ...
    if ((_sv0t1 == 97)) {
      ...
      int _sv0t2 = parse_item(tags, starts, ends, source, p0, it, id1, id2, id3, id4, pp, body_et, body_ed1, body_ed2, body_ed3, body_ed4, body_sf);
      int pi = _sv0t2;
      if ((pi < 0)) {
        int _sv0t3 = (0 - 1);
        return _sv0t3;
...
static int test_parse_fn_simple(void) {
  ...
  int _sv0t14 = sv0_vec_new();
  int bsf = _sv0t14;
  int _sv0t15 = parse_item(tags, starts, ends, source, 0, it, id1, id2, id3, id4, pp, bet, be1, be2, be3, be4, bsf);
  int r = _sv0t15;
  if ((r != 6)) {
    return 1;
  } else {
  }
  int _sv0t16 = sv0_vec_get(it, 0);
  if ((_sv0t16 != 0)) {
    return 2;
  } else {
  }
  int _sv0t17 = sv0_vec_get(id1, 0);
  if ((_sv0t17 != 1)) {
    return 3;
  } else {
  }
  int _sv0t18 = sv0_vec_get(id2, 0);
  if ((_sv0t18 != 0)) {
    return 4;
  } else {
  }
  int _sv0t19 = sv0_vec_get(id3, 0);
  if ((_sv0t19 != 0)) {
    return 5;
  } else {
  }
  int _sv0t20 = sv0_vec_get(id4, 0);
  if ((_sv0t20 < 0)) {
    return 6;
  } else {
  }
...
static int test_parse_impl(void) {
  ...
  int _sv0t16 = sv0_vec_len(it);
  if ((_sv0t16 != 2)) {
    return 2;
  } else {
  }
  int _sv0t17 = sv0_vec_get(it, 0);
  if ((_sv0t17 != 0)) {
    return 3;
  } else {
  }
  int _sv0t18 = sv0_vec_get(id1, 0);
  if ((_sv0t18 != 4)) {
    return 4;
  } else {
  }
  int _sv0t19 = sv0_vec_get(it, 1);
  if ((_sv0t19 != 4)) {
    return 5;
  } else {
  }
  int _sv0t20 = sv0_vec_get(id1, 1);
  if ((_sv0t20 != 0)) {
    return 6;
  } else {
  }
  int _sv0t21 = sv0_vec_get(id2, 1);
  if ((_sv0t21 != 1)) {
    return 7;
  } else {
  }
...
static int test_parse_fn_contract(void) {
  ...
  int _sv0t18 = sv0_vec_get(id3, 0);
  if ((_sv0t18 != 0)) {
    return 4;
  } else {
  }
  int _sv0t19 = sv0_vec_get(id4, 0);
  if ((_sv0t19 < 0)) {
    return 5;
  } else {
  }
...
static int test_parse_program(void) {
  ...
  int _sv0t14 = sv0_vec_new();
  int bsf = _sv0t14;
  int _sv0t15 = parse_program(tags, starts, ends, source, 0, it, id1, id2, id3, id4, pp, bet, be1, be2, be3, be4, bsf);
  int r = _sv0t15;
  if ((r != 12)) {
    return 1;
  } else {
...
int main(void) {
  ...
  int _sv0t97 = test_parse_block_empty();
  int r50 = _sv0t97;
  if ((r50 != 0)) {
    int _sv0t98 = (610 + r50);
    return _sv0t98;
  ...
  int _sv0t99 = test_parse_block_tail();
  int r51 = _sv0t99;
  if ((r51 != 0)) {
    int _sv0t100 = (620 + r51);
    return _sv0t100;
  } else {
  }
  int _sv0t101 = test_parse_block_semi();
  int r52 = _sv0t101;
  if ((r52 != 0)) {
    int _sv0t102 = (630 + r52);
    return _sv0t102;
  } else {
  }
  int _sv0t103 = test_parse_block_let();
  int r53 = _sv0t103;
  if ((r53 != 0)) {
    int _sv0t104 = (640 + r53);
    return _sv0t104;
  } else {
  }
  int _sv0t105 = test_parse_if_simple();
  int r54 = _sv0t105;
  if ((r54 != 0)) {
    int _sv0t106 = (650 + r54);
    return _sv0t106;
  } else {
  }
  int _sv0t107 = test_parse_if_else();
  int r55 = _sv0t107;
  if ((r55 != 0)) {
    int _sv0t108 = (660 + r55);
    return _sv0t108;
  } else {
  }
  int _sv0t109 = test_parse_while();
  int r56 = _sv0t109;
  if ((r56 != 0)) {
    int _sv0t110 = (670 + r56);
    return _sv0t110;
  } else {
  }
  int _sv0t111 = test_parse_loop();
  int r57 = _sv0t111;
  if ((r57 != 0)) {
  ...
  int _sv0t113 = test_parse_return();
  int r58 = _sv0t113;
  if ((r58 != 0)) {
    int _sv0t114 = (690 + r58);
    return _sv0t114;
  } else {
  }
  int _sv0t115 = test_parse_assign();
  int r59 = _sv0t115;
  if ((r59 != 0)) {
    int _sv0t116 = (700 + r59);
    return _sv0t116;
  } else {
  }
  int _sv0t117 = test_parse_match_simple();
  int r60 = _sv0t117;
  if ((r60 != 0)) {
    int _sv0t118 = (710 + r60);
    return _sv0t118;
  } else {
  }
  int _sv0t119 = test_parse_match_multi();
  int r61 = _sv0t119;
  if ((r61 != 0)) {
    int _sv0t120 = (720 + r61);
    return _sv0t120;
  } else {
  }
  int _sv0t121 = test_parse_match_guard();
  int r62 = _sv0t121;
  if ((r62 != 0)) {
    int _sv0t122 = (730 + r62);
    return _sv0t122;
  } else {
  }
  int _sv0t123 = test_parse_match_enum_tuple_arm();
  int r62b = _sv0t123;
  if ((r62b != 0)) {
    int _sv0t124 = (735 + r62b);
    return _sv0t124;
  } else {
  }
  int _sv0t125 = test_parse_quant();
  int r63 = _sv0t125;
  if ((r63 != 0)) {
    int _sv0t126 = (740 + r63);
    return _sv0t126;
  } else {
  }
  int _sv0t127 = test_parse_old();
  int r64 = _sv0t127;
  if ((r64 != 0)) {
    int _sv0t128 = (750 + r64);
    return _sv0t128;
  } else {
  }
  int _sv0t129 = test_parse_no_alias();
  int r65 = _sv0t129;
  if ((r65 != 0)) {
    int _sv0t130 = (760 + r65);
    return _sv0t130;
  } else {
  }
  int _sv0t131 = test_parse_while_inv();
  int r66 = _sv0t131;
  if ((r66 != 0)) {
    int _sv0t132 = (770 + r66);
    return _sv0t132;
  } else {
  }
  int _sv0t133 = test_parse_fn_simple();
  int r67 = _sv0t133;
  if ((r67 != 0)) {
    int _sv0t134 = (780 + r67);
    return _sv0t134;
  } else {
  }
  int _sv0t135 = test_parse_fn_ret();
  int r68 = _sv0t135;
  if ((r68 != 0)) {
    int _sv0t136 = (790 + r68);
    return _sv0t136;
  } else {
  }
  int _sv0t137 = test_parse_struct();
  int r69 = _sv0t137;
  if ((r69 != 0)) {
    int _sv0t138 = (800 + r69);
    return _sv0t138;
  } else {
  }
  int _sv0t139 = test_parse_enum_mixed();
  int r70 = _sv0t139;
  if ((r70 != 0)) {
    int _sv0t140 = (810 + r70);
    return _sv0t140;
  } else {
  }
  int _sv0t141 = test_parse_impl();
  int r71 = _sv0t141;
  if ((r71 != 0)) {
    int _sv0t142 = (820 + r71);
    return _sv0t142;
  } else {
  }
  int _sv0t143 = test_parse_fn_contract();
  int r72 = _sv0t143;
  if ((r72 != 0)) {
    int _sv0t144 = (830 + r72);
    return _sv0t144;
  } else {
  }
  int _sv0t145 = test_parse_program();
  int r73 = _sv0t145;
  if ((r73 != 0)) {
    int _sv0t146 = (840 + r73);
    return _sv0t146;
  } else {
  }
  return 0;
