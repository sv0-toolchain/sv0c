...
static int parse_match_expr(int tags, int starts, int ends, const char* source, int pos, int et, int ed1, int ed2, int ed3, int ed4, int pp, int sf_names) {
  ...
  while ((arms_done != 1)) {
    ...
    if ((_sv0t10 == 9)) {
      ...
      int _sv0t18 = sv0_vec_get(pt, 0);
      int pat_tag = _sv0t18;
      int _sv0t19 = sv0_vec_get(pd1v, 0);
      int pat_d1 = _sv0t19;
      int guard_idx = (0 - 1);
      int p2 = pa;
      int _sv0t20 = ps_peek(tags, p2);
      if ((_sv0t20 == 68)) {
        int _sv0t21 = (p2 + 1);
        int _sv0t22 = parse_expr(tags, starts, ends, source, _sv0t21, et, ed1, ed2, ed3, ed4, pp, 1);
        int pg = _sv0t22;
        if ((pg < 0)) {
          int _sv0t23 = (0 - 1);
          return _sv0t23;
      ...
      if ((_sv0t27 == 8)) {
        int _sv0t28 = parse_block(tags, starts, ends, source, p3, et, ed1, ed2, ed3, ed4, pp, sf_names);
        body_pos = _sv0t28;
      } else {
        int _sv0t29 = parse_expr(tags, starts, ends, source, p3, et, ed1, ed2, ed3, ed4, pp, 1);
        body_pos = _sv0t29;
      }
      if ((body_pos < 0)) {
        int _sv0t30 = (0 - 1);
      ...
      int _sv0t31 = sv0_vec_len(et);
      int body_idx = (_sv0t31 - 1);
      int arm_ed2 = pat_d1;
      int _sv0t32 = (pat_tag == 2);
      int _sv0t33 = (pat_tag == 4);
      int _sv0t34 = (_sv0t32 || _sv0t33);
      int _sv0t35 = (pat_tag == 5);
      if ((_sv0t34 || _sv0t35)) {
        sv0_vec_push(et, 30);
        int _sv0t36 = sv0_vec_get(pd1v, 0);
        sv0_vec_push(ed1, _sv0t36);
        int _sv0t37 = sv0_vec_get(pd2v, 0);
        sv0_vec_push(ed2, _sv0t37);
        int _sv0t38 = sv0_vec_get(pd3v, 0);
        sv0_vec_push(ed3, _sv0t38);
      ...
      if ((arms_first < 0)) {
        ...
        arms_first = (_sv0t40 - 1);
      } else {
      }
      arm_count = (arm_count + 1);
      int _sv0t41 = ps_peek(tags, body_pos);
      if ((_sv0t41 == 12)) {
        p = (body_pos + 1);
      } else {
        p = body_pos;
...
int main(void) {
  ...
  int _sv0t123 = test_parse_quant();
  int r63 = _sv0t123;
  if ((r63 != 0)) {
    int _sv0t124 = (740 + r63);
    return _sv0t124;
  } else {
  }
  int _sv0t125 = test_parse_old();
  int r64 = _sv0t125;
  if ((r64 != 0)) {
    int _sv0t126 = (750 + r64);
    return _sv0t126;
  } else {
  }
  int _sv0t127 = test_parse_no_alias();
  int r65 = _sv0t127;
  if ((r65 != 0)) {
    int _sv0t128 = (760 + r65);
    return _sv0t128;
  } else {
  }
  int _sv0t129 = test_parse_while_inv();
  int r66 = _sv0t129;
  if ((r66 != 0)) {
    int _sv0t130 = (770 + r66);
    return _sv0t130;
  } else {
  }
  int _sv0t131 = test_parse_fn_simple();
  int r67 = _sv0t131;
  if ((r67 != 0)) {
    int _sv0t132 = (780 + r67);
    return _sv0t132;
  } else {
  }
  int _sv0t133 = test_parse_fn_ret();
  int r68 = _sv0t133;
  if ((r68 != 0)) {
    int _sv0t134 = (790 + r68);
    return _sv0t134;
  } else {
  }
  int _sv0t135 = test_parse_struct();
  int r69 = _sv0t135;
  if ((r69 != 0)) {
    int _sv0t136 = (800 + r69);
    return _sv0t136;
  } else {
  }
  int _sv0t137 = test_parse_enum_mixed();
  int r70 = _sv0t137;
  if ((r70 != 0)) {
    int _sv0t138 = (810 + r70);
    return _sv0t138;
  } else {
  }
  int _sv0t139 = test_parse_impl();
  int r71 = _sv0t139;
  if ((r71 != 0)) {
    int _sv0t140 = (820 + r71);
    return _sv0t140;
  } else {
  }
  int _sv0t141 = test_parse_fn_contract();
  int r72 = _sv0t141;
  if ((r72 != 0)) {
    int _sv0t142 = (830 + r72);
    return _sv0t142;
  } else {
  }
  int _sv0t143 = test_parse_program();
  int r73 = _sv0t143;
  if ((r73 != 0)) {
    int _sv0t144 = (840 + r73);
    return _sv0t144;
  } else {
  }
  return 0;
