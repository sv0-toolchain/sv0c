...
static int try_assign_id_op_pratt_rhs_stub7(int op, int t0, int t1, int t2, int t3, int t4, int t5, int t6);
...
static int try_assign_deref_op_pratt_rhs_stub(int t_star, int t_id, int op, int t0, int t1, int t2, int t3, int t4, int t5);
static int try_assign_deref_op_pratt_rhs_stub7(int t_star, int t_id, int op, int t0, int t1, int t2, int t3, int t4, int t5, int t6);
static int try_assign_field_op_pratt_rhs_stub(int t_base, int t_dot, int t_field, int op, int t0, int t1, int t2, int t3, int t4, int t5);
static int try_assign_field_op_pratt_rhs_stub7(int t_base, int t_dot, int t_field, int op, int t0, int t1, int t2, int t3, int t4, int t5, int t6);
static int try_assign_index_op_pratt_rhs_stub(int t_id, int t_lbr, int t_idx, int t_rbr, int op, int t0, int t1, int t2, int t3, int t4, int t5);
static int try_assign_index_op_pratt_rhs_stub7(int t_id, int t_lbr, int t_idx, int t_rbr, int op, int t0, int t1, int t2, int t3, int t4, int t5, int t6);
...
static int try_assign_id_op_pratt_rhs_stub7(int op, int t0, int t1, int t2, int t3, int t4, int t5, int t6) {
  ...
  int _sv0t1;
  if ((_sv0t2 == 1)) {
    int _sv0t3 = pratt_rhs_ok_with_semi7(t0, t1, t2, t3, t4, t5, t6);
    return _sv0t3;
    _sv0t1 = 0;
  } else {
    return 0;
...
static int try_assign_deref_op_pratt_rhs_stub(int t_star, int t_id, int op, int t0, int t1, int t2, int t3, int t4, int t5) {
  ...
  if ((t_star == 22)) {
    ...
    if ((t_id == 73)) {
      ...
      int _sv0t3;
      if ((_sv0t4 == 1)) {
        int _sv0t5 = pratt_rhs_ok_with_semi(t0, t1, t2, t3, t4, t5);
        return _sv0t5;
        _sv0t3 = 0;
      } else {
        return 0;
...
static int try_assign_deref_op_pratt_rhs_stub7(int t_star, int t_id, int op, int t0, int t1, int t2, int t3, int t4, int t5, int t6) {
  ...
  if ((t_star == 22)) {
    ...
    if ((t_id == 73)) {
      ...
      int _sv0t3;
      if ((_sv0t4 == 1)) {
        int _sv0t5 = pratt_rhs_ok_with_semi7(t0, t1, t2, t3, t4, t5, t6);
        return _sv0t5;
        _sv0t3 = 0;
      } else {
        return 0;
  ...
  if ((t_base == 73)) {
    ...
    if ((t_dot == 18)) {
      ...
      if ((t_field == 73)) {
        ...
        int _sv0t4;
        if ((_sv0t5 == 1)) {
          int _sv0t6 = pratt_rhs_ok_with_semi(t0, t1, t2, t3, t4, t5);
          return _sv0t6;
          _sv0t4 = 0;
        } else {
          return 0;
  ...
  if ((t_base == 73)) {
    ...
    if ((t_dot == 18)) {
      ...
      if ((t_field == 73)) {
        ...
        int _sv0t4;
        if ((_sv0t5 == 1)) {
          int _sv0t6 = pratt_rhs_ok_with_semi7(t0, t1, t2, t3, t4, t5, t6);
          return _sv0t6;
          _sv0t4 = 0;
        } else {
          return 0;
    ...
    if ((t_lbr == 16)) {
      ...
      if ((t_idx == 40)) {
        ...
        if ((t_rbr == 17)) {
          ...
          int _sv0t5;
          if ((_sv0t6 == 1)) {
            int _sv0t7 = pratt_rhs_ok_with_semi(t0, t1, t2, t3, t4, t5);
            return _sv0t7;
            _sv0t5 = 0;
          } else {
            return 0;
    ...
    if ((t_lbr == 16)) {
      ...
      if ((t_idx == 40)) {
        ...
        if ((t_rbr == 17)) {
          ...
          int _sv0t5;
          if ((_sv0t6 == 1)) {
            int _sv0t7 = pratt_rhs_ok_with_semi7(t0, t1, t2, t3, t4, t5, t6);
            return _sv0t7;
            _sv0t5 = 0;
          } else {
            return 0;
...
int main(void) {
  ...
  int e29 = _sv0t189;
  int _sv0t190 = tok_star();
  int _sv0t191 = tok_ident();
  int _sv0t192 = tok_assign_eq();
  int _sv0t193 = tok_rhs_atom();
  int _sv0t194 = tok_binop_plus();
  int _sv0t195 = tok_rhs_atom();
  int _sv0t196 = tok_binop_star();
  int _sv0t197 = tok_rhs_atom();
  int _sv0t198 = tok_semi();
  int _sv0t199 = try_assign_deref_op_pratt_rhs_stub(_sv0t190, _sv0t191, _sv0t192, _sv0t193, _sv0t194, _sv0t195, _sv0t196, _sv0t197, _sv0t198);
  int e30 = (_sv0t199 - 1);
  int _sv0t200 = tok_ident();
  int _sv0t201 = tok_lhs_dot();
  int _sv0t202 = tok_ident();
  int _sv0t203 = tok_pluseq();
  int _sv0t204 = tok_rhs_atom();
  int _sv0t205 = tok_binop_star();
  int _sv0t206 = tok_rhs_atom();
  int _sv0t207 = tok_binop_plus();
  int _sv0t208 = tok_rhs_atom();
  int _sv0t209 = tok_semi();
  int _sv0t210 = try_assign_field_op_pratt_rhs_stub(_sv0t200, _sv0t201, _sv0t202, _sv0t203, _sv0t204, _sv0t205, _sv0t206, _sv0t207, _sv0t208, _sv0t209);
  int e31 = (_sv0t210 - 1);
  int _sv0t211 = tok_ident();
  int _sv0t212 = tok_lbracket();
  int _sv0t213 = tok_rhs_atom();
  int _sv0t214 = tok_rbracket();
  int _sv0t215 = tok_assign_eq();
  int _sv0t216 = tok_rhs_atom();
  int _sv0t217 = tok_binop_star();
  int _sv0t218 = tok_rhs_atom();
  int _sv0t219 = tok_binop_star();
  int _sv0t220 = tok_rhs_atom();
  ...
  int e36 = (_sv0t251 - 1);
  int _sv0t252 = tok_assign_eq();
  int _sv0t253 = tok_unary_minus();
  int _sv0t254 = tok_rhs_atom();
  int _sv0t255 = tok_binop_plus();
  int _sv0t256 = tok_rhs_atom();
  int _sv0t257 = tok_binop_star();
  int _sv0t258 = tok_rhs_atom();
  int _sv0t259 = tok_semi();
  int _sv0t260 = try_assign_id_op_pratt_rhs_stub7(_sv0t252, _sv0t253, _sv0t254, _sv0t255, _sv0t256, _sv0t257, _sv0t258, _sv0t259);
  int e37 = (_sv0t260 - 1);
  int _sv0t261 = tok_star();
  int _sv0t262 = tok_ident();
  int _sv0t263 = tok_assign_eq();
  int _sv0t264 = tok_unary_minus();
  int _sv0t265 = tok_rhs_atom();
  int _sv0t266 = tok_binop_plus();
  int _sv0t267 = tok_rhs_atom();
  int _sv0t268 = tok_binop_star();
  int _sv0t269 = tok_rhs_atom();
  int _sv0t270 = tok_semi();
  int _sv0t271 = try_assign_deref_op_pratt_rhs_stub7(_sv0t261, _sv0t262, _sv0t263, _sv0t264, _sv0t265, _sv0t266, _sv0t267, _sv0t268, _sv0t269, _sv0t270);
  int e38 = (_sv0t271 - 1);
  int _sv0t272 = tok_ident();
  int _sv0t273 = tok_lhs_dot();
  int _sv0t274 = tok_ident();
  int _sv0t275 = tok_assign_eq();
  int _sv0t276 = tok_unary_minus();
  int _sv0t277 = tok_rhs_atom();
  int _sv0t278 = tok_binop_plus();
  int _sv0t279 = tok_rhs_atom();
  int _sv0t280 = tok_binop_star();
  int _sv0t281 = tok_rhs_atom();
  int _sv0t282 = tok_semi();
  int _sv0t283 = try_assign_field_op_pratt_rhs_stub7(_sv0t272, _sv0t273, _sv0t274, _sv0t275, _sv0t276, _sv0t277, _sv0t278, _sv0t279, _sv0t280, _sv0t281, _sv0t282);
  int e39 = (_sv0t283 - 1);
  int _sv0t284 = tok_ident();
  int _sv0t285 = tok_lbracket();
  int _sv0t286 = tok_rhs_atom();
  int _sv0t287 = tok_rbracket();
  int _sv0t288 = tok_assign_eq();
  int _sv0t289 = tok_unary_minus();
  int _sv0t290 = tok_rhs_atom();
  int _sv0t291 = tok_binop_plus();
  int _sv0t292 = tok_rhs_atom();
  int _sv0t293 = tok_binop_star();
  int _sv0t294 = tok_rhs_atom();
  int _sv0t295 = tok_semi();
  int _sv0t296 = try_assign_index_op_pratt_rhs_stub7(_sv0t284, _sv0t285, _sv0t286, _sv0t287, _sv0t288, _sv0t289, _sv0t290, _sv0t291, _sv0t292, _sv0t293, _sv0t294, _sv0t295);
  int e40 = (_sv0t296 - 1);
  int _sv0t297 = tok_assign_eq();
  int _sv0t298 = tok_rhs_atom();
  int _sv0t299 = tok_unary_minus();
  int _sv0t300 = tok_rhs_atom();
  int _sv0t301 = tok_semi();
  int _sv0t302 = try_assign_id_op_pratt_rhs_stub(_sv0t297, _sv0t298, _sv0t299, _sv0t300, _sv0t301, 0, 0);
  int e41 = (_sv0t302 - 1);
  int _sv0t303 = tok_assign_eq();
  int _sv0t304 = tok_rhs_atom();
  int _sv0t305 = tok_binop_star();
  int _sv0t306 = tok_rhs_atom();
  int _sv0t307 = tok_unary_minus();
  int _sv0t308 = tok_rhs_atom();
  int _sv0t309 = tok_semi();
  int _sv0t310 = try_assign_id_op_pratt_rhs_stub(_sv0t303, _sv0t304, _sv0t305, _sv0t306, _sv0t307, _sv0t308, _sv0t309);
  int e42 = (_sv0t310 - 1);
  int _sv0t311 = tok_assign_eq();
  int _sv0t312 = tok_unary_minus();
  int _sv0t313 = tok_rhs_atom();
  int _sv0t314 = tok_unary_minus();
  int _sv0t315 = tok_rhs_atom();
  int _sv0t316 = tok_binop_star();
  int _sv0t317 = tok_rhs_atom();
  int _sv0t318 = tok_semi();
  int _sv0t319 = try_assign_id_op_pratt_rhs_stub7(_sv0t311, _sv0t312, _sv0t313, _sv0t314, _sv0t315, _sv0t316, _sv0t317, _sv0t318);
  int e43 = (_sv0t319 - 1);
  int _sv0t320 = (e0 + e1);
  int _sv0t321 = (_sv0t320 + e2);
  int _sv0t322 = (_sv0t321 + e3);
  int _sv0t323 = (_sv0t322 + e4);
  int _sv0t324 = (_sv0t323 + e5);
  int _sv0t325 = (_sv0t324 + e6);
  int _sv0t326 = (_sv0t325 + e7);
  int _sv0t327 = (_sv0t326 + e8);
  int _sv0t328 = (_sv0t327 + e9);
  int _sv0t329 = (_sv0t328 + e10);
  int _sv0t330 = (_sv0t329 + e11);
  int _sv0t331 = (_sv0t330 + e12);
  int _sv0t332 = (_sv0t331 + e13);
  int _sv0t333 = (_sv0t332 + e14);
  int _sv0t334 = (_sv0t333 + e15);
  int _sv0t335 = (_sv0t334 + e16);
  int _sv0t336 = (_sv0t335 + e17);
  int _sv0t337 = (_sv0t336 + e18);
  int _sv0t338 = (_sv0t337 + e19);
  int _sv0t339 = (_sv0t338 + e20);
  int _sv0t340 = (_sv0t339 + e21);
  int _sv0t341 = (_sv0t340 + e22);
  int _sv0t342 = (_sv0t341 + e23);
  int _sv0t343 = (_sv0t342 + e24);
  int _sv0t344 = (_sv0t343 + e25);
  int _sv0t345 = (_sv0t344 + e26);
  int _sv0t346 = (_sv0t345 + e27);
  int _sv0t347 = (_sv0t346 + e28);
  int _sv0t348 = (_sv0t347 + e29);
  int _sv0t349 = (_sv0t348 + e30);
  int _sv0t350 = (_sv0t349 + e31);
  int _sv0t351 = (_sv0t350 + e32);
  int _sv0t352 = (_sv0t351 + e33);
  int _sv0t353 = (_sv0t352 + e34);
  int _sv0t354 = (_sv0t353 + e35);
  int _sv0t355 = (_sv0t354 + e36);
  int _sv0t356 = (_sv0t355 + e37);
  int _sv0t357 = (_sv0t356 + e38);
  int _sv0t358 = (_sv0t357 + e39);
  int _sv0t359 = (_sv0t358 + e40);
  int _sv0t360 = (_sv0t359 + e41);
  int _sv0t361 = (_sv0t360 + e42);
  int _sv0t362 = (_sv0t361 + e43);
  return _sv0t362;
}
