...
|--------|--------|-------------------------|
| Bootstrap-listed programs | `lib/bootstrap-sources.list` (non-comment, non-empty lines) | 267 |
| Self-host pilots | `lib/self-host-sv0-loop.list` | 267 |
| Stage0 C golden files | `lib/golden/stage0/*.c` | 191 |
