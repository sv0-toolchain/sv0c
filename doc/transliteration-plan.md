...
| IR | `sml/ir/` | `lib/lower_unop_core`, `lib/lower_lit_core`, `lib/lower_binop_core`, `lib/lower_assign_lhs_core`, `lib/lower_ast_ty_cstring_core`, `lib/lower_value_to_expr_core` (`valueToExpr`) | `lowering.sml` transliteration |
