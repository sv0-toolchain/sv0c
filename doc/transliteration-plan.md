...
|--------|--------|-------------------------|
| Bootstrap-listed programs | `lib/bootstrap-sources.list` (non-comment, non-empty lines) | ~137 |
| Self-host pilots | `lib/self-host-sv0-loop.list` | 54 |
| Stage0 C goldens | `lib/golden/stage0/*.c` | 64 |
