...
|--------|--------|-------------------------|
| Bootstrap-listed programs | `lib/bootstrap-sources.list` (non-comment, non-empty lines) | 208 |
| Self-host pilots | `lib/self-host-sv0-loop.list` | 208 |
| Stage0 C golden files | `lib/golden/stage0/*.c` | 132 |
| VM parity allowlist | `test/vm-parity/manifest.txt` | 158 |
