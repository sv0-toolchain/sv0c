...
|--------|--------|-------------------------|
| Bootstrap-listed programs | `lib/bootstrap-sources.list` (non-comment, non-empty lines) | ~133 |
| Self-host pilots | `lib/self-host-sv0-loop.list` | 50 |
| Stage0 C goldens | `lib/golden/stage0/*.c` | 60 |
