...
|--------|--------|-------------------------|
| Bootstrap-listed programs | `lib/bootstrap-sources.list` (non-comment, non-empty lines) | 269 |
| Self-host pilots | `lib/self-host-sv0-loop.list` | 269 |
| Stage0 C golden files | `lib/golden/stage0/*.c` | 193 |
| VM parity allowlist | `test/vm-parity/manifest.txt` | 182 |
