...
| E0448  | Assignment to a binding that was not introduced with **`let mut`** (immutable **`let`**). |
| E0449  | Assignment **left-hand side** is not a single identifier in this slice (e.g. literal or compound expression). |
